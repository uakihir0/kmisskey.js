(function (factory) {
  ...
  function Companion() {
    ...
    while (_iterator__ex2g4s.u()) {
      ...
      var tmp$ret$0 = element.j3a_1;
      destination.v2(tmp$ret$0, element);
    }
    tmp.k3a_1 = destination;
    this.l3a_1 = Codes_INTERNAL_ERROR_getInstance();
  }
  protoOf(Companion).m3a = function (code) {
    return this.k3a_1.s2(code);
  };
  ...
  protoOf(CloseReason).p3a = function () {
    return Companion_getInstance().m3a(this.n3a_1);
  };
  protoOf(CloseReason).toString = function () {
    var tmp0_elvis_lhs = this.p3a();
    return 'CloseReason(reason=' + toString(tmp0_elvis_lhs == null ? this.n3a_1 : tmp0_elvis_lhs) + ', message=' + this.o3a_1 + ')';
  };
  protoOf(CloseReason).hashCode = function () {
    var result = this.n3a_1;
    result = imul(result, 31) + getStringHashCode(this.o3a_1) | 0;
    return result;
  };
  protoOf(CloseReason).equals = function (other) {
    ...
    if (!(other instanceof CloseReason))
      return false;
    if (!(this.n3a_1 === other.n3a_1))
      return false;
    if (!(this.o3a_1 === other.o3a_1))
      return false;
    return true;
  };
  ...
  function Companion_0() {
    ...
    tmp.u3a_1 = ensureNotNull(tmp$ret$0).t3a_1;
    var tmp_0 = this;
    var tmp_1 = 0;
    var tmp_2 = this.u3a_1 + 1 | 0;
  ...
  function Close_init_$Init$(reason, $this) {
    ...
    builder.t1b(reason.n3a_1);
    writeText(builder, reason.o3a_1);
  ...
  function Close_init_$Init$_1($this) {
    Close.call($this, Companion_getInstance_1().w3a_1);
    return $this;
  }
  ...
  function Frame(fin, frameType, data, disposableHandle, rsv1, rsv2, rsv3) {
    ...
    rsv3 = rsv3 === VOID ? false : rsv3;
    this.x3a_1 = fin;
    this.y3a_1 = frameType;
    this.z3a_1 = data;
    this.a3b_1 = disposableHandle;
    this.b3b_1 = rsv1;
    this.c3b_1 = rsv2;
    this.d3b_1 = rsv3;
  }
  protoOf(Frame).toString = function () {
    return 'Frame ' + this.y3a_1.toString() + ' (fin=' + this.x3a_1 + ', buffer len = ' + this.z3a_1.length + ')';
  };
  //region block: init
