(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    root['work.socialhub.kmisskey:all'] = factory(typeof this['work.socialhub.kmisskey:all'] === 'undefined' ? {} : this['work.socialhub.kmisskey:all'], this['kmisskey-core'], this['kotlin-kotlin-stdlib']);
  }
}(globalThis, function (_, kotlin_work_socialhub_kmisskey_core, kotlin_kotlin) {
  'use strict';
