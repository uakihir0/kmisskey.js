(function (factory) {
  ...
  function Bit32Digest_init_$Init$(bitStrength, h, $this) {
    ...
    $this.v39_1 = h;
    $this.w39_1 = new Int32Array(64);
    var tmp = $this;
    // Inline function 'kotlin.collections.copyOf' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.x39_1 = h.slice();
    $this.y39_1 = Bit32_init_$Create$(64);
    return $this;
  }
  function Companion() {
  ...
  protoOf(Bit32Digest).s38 = function (input, offset) {
    ...
    var k = Companion_getInstance().a3a_1;
    var state = this.x39_1;
    var a = state[0];
    var b = state[1];
    var c = state[2];
    var d = state[3];
  ...
  protoOf(Bit32Digest).q38 = function (buf, bufPos) {
    var digest = new Int8Array(this.m38());
    this.b3a(digest, 0, buf, bufPos);
    return digest;
  };
  protoOf(Bit32Digest).b3a = function (dest, destOffset, buf, bufPos) {
    var tmp0_container = this.y39_1.e39(bufPos).b39();
    var bitsLo = tmp0_container.vf();
    var bitsHi = tmp0_container.wf();
    buf[bufPos] = -128;
    if ((bufPos + 1 | 0) > 56) {
      this.s38(buf, 0);
      fill(buf, 0, 0, 56);
    ...
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().o39(bitsHi, buf, 56);
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().o39(bitsLo, buf, 60);
    this.s38(buf, 0);
    Big_getInstance();
    var tmp2 = this.x39_1;
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    var sourceIndexEnd = this.m38() / 4 | 0;
    Big_getInstance().p39(tmp2, dest, destOffset, 0, sourceIndexEnd);
  };
  protoOf(Bit32Digest).r38 = function () {
    fill_0(this.w39_1, 0);
    var tmp0 = this.v39_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destination = this.x39_1;
  ...
  function SHA256_init_$Init$($this) {
    Bit32Digest_init_$Init$(256, Companion_getInstance_0().c3a_1, $this);
    SHA256.call($this);
    return $this;
  }
  ...
  function Companion_0() {
    ...
    var tmp = this;
    // Inline function 'kotlin.intArrayOf' call
    tmp.c3a_1 = new Int32Array([1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225]);
  }
