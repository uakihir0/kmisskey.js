(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof this['core-library-digest'] === 'undefined') {
    ...
    root['hash-library-sha2'] = factory(typeof this['hash-library-sha2'] === 'undefined' ? {} : this['hash-library-sha2'], this['core-library-digest'], this['kotlin-kotlin-stdlib']);
  }
}(this, function (_, kotlin_org_kotlincrypto_core_digest, kotlin_kotlin) {
  'use strict';
  ...
  setMetadataFor(Bit32Digest, 'Bit32Digest', classMeta, Digest);
  setMetadataFor(SHA256, 'SHA256', classMeta, Bit32Digest, VOID, SHA256_init_$Create$);
  //endregion
