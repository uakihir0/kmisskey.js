(function (factory) {
  ...
  function Bit32Digest_init_$Init$(bitStrength, h, $this) {
    ...
    $this.i3g_1 = h;
    $this.j3g_1 = new Int32Array(64);
    var tmp = $this;
    // Inline function 'kotlin.collections.copyOf' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.k3g_1 = h.slice();
    $this.l3g_1 = Bit32_init_$Create$(64);
    return $this;
  }
  function Companion() {
  ...
  protoOf(Bit32Digest).f3f = function (input, offset) {
    ...
    var k = Companion_getInstance().n3g_1;
    var state = this.k3g_1;
    var a = state[0];
    var b = state[1];
    var c = state[2];
    var d = state[3];
  ...
  protoOf(Bit32Digest).d3f = function (buf, bufPos) {
    var digest = new Int8Array(this.z3e());
    this.o3g(digest, 0, buf, bufPos);
    return digest;
  };
  protoOf(Bit32Digest).o3g = function (dest, destOffset, buf, bufPos) {
    var tmp0_container = this.l3g_1.r3f(bufPos).o3f();
    ...
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().b3g(bitsHi, buf, 56);
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().b3g(bitsLo, buf, 60);
    this.f3f(buf, 0);
    Big_getInstance();
    var tmp2 = this.k3g_1;
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    var sourceIndexEnd = this.z3e() / 4 | 0;
    Big_getInstance().c3g(tmp2, dest, destOffset, 0, sourceIndexEnd);
  };
  protoOf(Bit32Digest).e3f = function () {
    fill_0(this.j3g_1, 0);
    var tmp0 = this.i3g_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destination = this.k3g_1;
  ...
  function SHA256_init_$Init$($this) {
    Bit32Digest_init_$Init$(256, Companion_getInstance_0().p3g_1, $this);
    SHA256.call($this);
    return $this;
  }
  ...
  function Companion_0() {
    ...
    var tmp = this;
    // Inline function 'kotlin.intArrayOf' call
    tmp.p3g_1 = new Int32Array([1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225]);
  }
