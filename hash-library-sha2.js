(function (factory) {
  ...
  function Bit32Digest_init_$Init$(bitStrength, h, $this) {
    ...
    $this.v38_1 = h;
    $this.w38_1 = new Int32Array(64);
    var tmp = $this;
    // Inline function 'kotlin.collections.copyOf' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.x38_1 = h.slice();
    $this.y38_1 = Bit32_init_$Create$(64);
    return $this;
  }
  function Companion() {
  ...
  protoOf(Bit32Digest).s37 = function (input, offset) {
    ...
    var k = Companion_getInstance().a39_1;
    var state = this.x38_1;
    var a = state[0];
    var b = state[1];
    var c = state[2];
    var d = state[3];
  ...
  protoOf(Bit32Digest).q37 = function (buf, bufPos) {
    var digest = new Int8Array(this.m37());
    this.b39(digest, 0, buf, bufPos);
    return digest;
  };
  protoOf(Bit32Digest).b39 = function (dest, destOffset, buf, bufPos) {
    var tmp0_container = this.y38_1.e38(bufPos).b38();
    var bitsLo = tmp0_container.mf();
    var bitsHi = tmp0_container.nf();
    buf[bufPos] = -128;
    if ((bufPos + 1 | 0) > 56) {
      this.s37(buf, 0);
      fill(buf, 0, 0, 56);
    ...
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().o38(bitsHi, buf, 56);
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().o38(bitsLo, buf, 60);
    this.s37(buf, 0);
    Big_getInstance();
    var tmp2 = this.x38_1;
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    var sourceIndexEnd = this.m37() / 4 | 0;
    Big_getInstance().p38(tmp2, dest, destOffset, 0, sourceIndexEnd);
  };
  protoOf(Bit32Digest).r37 = function () {
    fill_0(this.w38_1, 0);
    var tmp0 = this.v38_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destination = this.x38_1;
  ...
  function SHA256_init_$Init$($this) {
    Bit32Digest_init_$Init$(256, Companion_getInstance_0().c39_1, $this);
    SHA256.call($this);
    return $this;
  }
  ...
  function Companion_0() {
    ...
    var tmp = this;
    // Inline function 'kotlin.intArrayOf' call
    tmp.c39_1 = new Int32Array([1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225]);
  }
