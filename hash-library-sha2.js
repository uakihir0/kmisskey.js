(function (factory) {
  ...
  function Bit32Digest_init_$Init$(bitStrength, h, $this) {
    ...
    $this.l3e_1 = h;
    $this.m3e_1 = new Int32Array(64);
    var tmp = $this;
    // Inline function 'kotlin.collections.copyOf' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.n3e_1 = h.slice();
    $this.o3e_1 = Bit32_init_$Create$(64);
    return $this;
  }
  function Companion() {
  ...
  protoOf(Bit32Digest).i3d = function (input, offset) {
    ...
    var k = Companion_getInstance().q3e_1;
    var state = this.n3e_1;
    var a = state[0];
    var b = state[1];
    var c = state[2];
    var d = state[3];
  ...
  protoOf(Bit32Digest).g3d = function (buf, bufPos) {
    var digest = new Int8Array(this.c3d());
    this.r3e(digest, 0, buf, bufPos);
    return digest;
  };
  protoOf(Bit32Digest).r3e = function (dest, destOffset, buf, bufPos) {
    var tmp0_container = this.o3e_1.u3d(bufPos).r3d();
    var bitsLo = tmp0_container.uf();
    var bitsHi = tmp0_container.vf();
    buf[bufPos] = -128;
    if ((bufPos + 1 | 0) > 56) {
      this.i3d(buf, 0);
      fill(buf, 0, 0, 56);
    ...
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().e3e(bitsHi, buf, 56);
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().e3e(bitsLo, buf, 60);
    this.i3d(buf, 0);
    Big_getInstance();
    var tmp2 = this.n3e_1;
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    var sourceIndexEnd = this.c3d() / 4 | 0;
    Big_getInstance().f3e(tmp2, dest, destOffset, 0, sourceIndexEnd);
  };
  protoOf(Bit32Digest).h3d = function () {
    fill_0(this.m3e_1, 0);
    var tmp0 = this.l3e_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destination = this.n3e_1;
  ...
  function SHA256_init_$Init$($this) {
    Bit32Digest_init_$Init$(256, Companion_getInstance_0().s3e_1, $this);
    SHA256.call($this);
    return $this;
  }
  ...
  function Companion_0() {
    ...
    var tmp = this;
    // Inline function 'kotlin.intArrayOf' call
    tmp.s3e_1 = new Int32Array([1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225]);
  }
