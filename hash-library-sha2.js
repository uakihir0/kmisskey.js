(function (factory) {
  ...
  function Bit32Digest_init_$Init$(bitStrength, h, $this) {
    ...
    $this.b3g_1 = h;
    $this.c3g_1 = new Int32Array(64);
    var tmp = $this;
    // Inline function 'kotlin.collections.copyOf' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.d3g_1 = h.slice();
    $this.e3g_1 = Bit32_init_$Create$(64);
    return $this;
  }
  function Companion() {
  ...
  protoOf(Bit32Digest).y3e = function (input, offset) {
    ...
    var k = Companion_getInstance().g3g_1;
    var state = this.d3g_1;
    var a = state[0];
    var b = state[1];
    var c = state[2];
    var d = state[3];
  ...
  protoOf(Bit32Digest).w3e = function (buf, bufPos) {
    var digest = new Int8Array(this.s3e());
    this.h3g(digest, 0, buf, bufPos);
    return digest;
  };
  protoOf(Bit32Digest).h3g = function (dest, destOffset, buf, bufPos) {
    var tmp0_container = this.e3g_1.k3f(bufPos).h3f();
    ...
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().u3f(bitsHi, buf, 56);
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    Big_getInstance();
    Big_getInstance().u3f(bitsLo, buf, 60);
    this.y3e(buf, 0);
    Big_getInstance();
    var tmp2 = this.d3g_1;
    // Inline function 'org.kotlincrypto.bitops.endian.Big.bePackIntoUnsafe' call
    var sourceIndexEnd = this.s3e() / 4 | 0;
    Big_getInstance().v3f(tmp2, dest, destOffset, 0, sourceIndexEnd);
  };
  protoOf(Bit32Digest).x3e = function () {
    fill_0(this.c3g_1, 0);
    var tmp0 = this.b3g_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destination = this.d3g_1;
  ...
  function SHA256_init_$Init$($this) {
    Bit32Digest_init_$Init$(256, Companion_getInstance_0().i3g_1, $this);
    SHA256.call($this);
    return $this;
  }
  ...
  function Companion_0() {
    ...
    var tmp = this;
    // Inline function 'kotlin.intArrayOf' call
    tmp.i3g_1 = new Int32Array([1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225]);
  }
