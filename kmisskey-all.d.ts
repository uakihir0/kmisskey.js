...
export declare namespace work.socialhub.kmisskey {
    interface Misskey {
        ...
        drive(): work.socialhub.kmisskey.api.DriveResource;
...
export declare namespace work.socialhub.kmisskey.api {
    interface DriveResource {
        files(request: work.socialhub.kmisskey.api.request.drive.DriveFilesRequest): Promise<work.socialhub.kmisskey.entity.share.Response<Array<work.socialhub.kmisskey.entity.File>>>;
        folders(request: work.socialhub.kmisskey.api.request.drive.DriveFoldersRequest): Promise<work.socialhub.kmisskey.entity.share.Response<Array<work.socialhub.kmisskey.entity.Folder>>>;
        showFile(request: work.socialhub.kmisskey.api.request.drive.DriveFilesShowRequest): Promise<work.socialhub.kmisskey.entity.share.Response<work.socialhub.kmisskey.entity.File>>;
        readonly __doNotUseOrImplementIt: {
            readonly "work.socialhub.kmisskey.api.DriveResource": unique symbol;
        };
    }
}
export declare namespace work.socialhub.kmisskey.api {
...
export declare namespace work.socialhub.kmisskey.api.request.drive {
    class DriveFilesRequest /* extends work.socialhub.kmisskey.api.request.protocol.PagingTokenRequest */ {
        constructor();
    ...
    namespace DriveFilesRequest {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
            const constructor: abstract new () => DriveFilesRequest;
        }
    }
}
export declare namespace work.socialhub.kmisskey.api.request.drive {
    class DriveFilesShowRequest /* extends work.socialhub.kmisskey.api.model.TokenRequest */ {
        constructor();
    ...
    namespace DriveFilesShowRequest {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
            const constructor: abstract new () => DriveFilesShowRequest;
        }
    }
}
export declare namespace work.socialhub.kmisskey.api.request.drive {
    class DriveFoldersRequest /* extends work.socialhub.kmisskey.api.request.protocol.PagingTokenRequest */ {
        constructor();
        get folderId(): Nullable<string>;
        set folderId(value: Nullable<string>);
    }
    namespace DriveFoldersRequest {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
            const constructor: abstract new () => DriveFoldersRequest;
        }
    }
}
...
export declare namespace work.socialhub.kmisskey.entity {
    class Policies {
        ...
        get maxFileSizeMb(): Nullable<number>;
        set maxFileSizeMb(value: Nullable<number>);
    }
    namespace Policies {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
...
export declare namespace work.socialhub.kmisskey.entity.user {
    abstract class User {
        ...
        get avatarColor(): Nullable<string>;
        set avatarColor(value: Nullable<string>);
        get avatarColorObject(): Nullable<work.socialhub.kmisskey.entity.Color>;
    }
    namespace User {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
...
export declare namespace work.socialhub.kmisskey.entity.user {
    class UserDetailedNotMe extends work.socialhub.kmisskey.entity.user.UserLite.$metadata$.constructor {
        ...
        get withReplies(): boolean;
        set withReplies(value: boolean);
        get bannerColor(): Nullable<string>;
        set bannerColor(value: Nullable<string>);
        get bannerColorObject(): Nullable<work.socialhub.kmisskey.entity.Color>;
    }
