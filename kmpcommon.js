(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    root.kmpcommon = factory(typeof kmpcommon === 'undefined' ? {} : kmpcommon, this['kotlin-kotlin-stdlib'], this['kotlinx-serialization-kotlinx-serialization-json'], this['kotlinx-serialization-kotlinx-serialization-core'], this['kotlinx-coroutines-core']);
  }
}(this, function (_, kotlin_kotlin, kotlin_org_jetbrains_kotlinx_kotlinx_serialization_json, kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core, kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core) {
  'use strict';
  ...
  var println = kotlin_kotlin.$_$.d9;
  ...
  var promise = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.j1;
  ...
  setMetadataFor(AnySerializer, 'AnySerializer', objectMeta, VOID, [KSerializer]);
  setMetadataFor(runBlocking$slambda, 'runBlocking$slambda', classMeta, CoroutineImpl, [CoroutineImpl], VOID, VOID, VOID, [1]);
  //endregion
  function toAny(_this__u8e3s4, $this) {
    if (_this__u8e3s4 instanceof JsonPrimitive) {
      ...
      if (_this__u8e3s4.get_isString_zep7bw_k$()) {
        ...
        throw IllegalStateException_init_$Create$("Can't deserialize unknown type: " + _this__u8e3s4);
      }
      return tmp;
    } else {
                ...
                if (typeof value === 'boolean') {
                  ...
                  if (value instanceof Enum) {
                    ...
                    if (!this.additionalSerializer_1(encoder, value)) {
                      println("Can't serialize unknown type: " + getKClassFromExpression(value));
                    }
                  }
                }
              }
