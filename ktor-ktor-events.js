(function (factory) {
  ...
  function Events() {
    this.j3g_1 = new CopyOnWriteHashMap();
  }
  protoOf(Events).k3g = function (definition, value) {
    var exception = null;
    var tmp0_safe_receiver = this.j3g_1.e2g(definition);
