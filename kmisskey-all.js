(function (factory) {
  ...
  function $jsExportAll$(_) {
    ...
    var kmisskey = socialhub.kmisskey || (socialhub.kmisskey = {});
    defineProp(kmisskey, 'KmisskeyFactory', KmisskeyFactory_getInstance, VOID, true);
  }
  $jsExportAll$(_);
