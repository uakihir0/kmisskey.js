(function (root, factory) {
...
}(globalThis, function (_, kotlin_kotlin, kotlin_io_ktor_ktor_io, kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core, kotlin_org_jetbrains_kotlinx_atomicfu) {
  'use strict';
  ...
  var toString = kotlin_kotlin.$_$.gh;
  ...
  var asJsSetView = kotlin_kotlin.$_$.d6;
  ...
  initMetadataForClass(_no_name_provided__qut3iv_2, VOID, VOID, CondAddOp);
  ...
  function _no_name_provided__qut3iv_2($node, $condition) {
    this.$condition_1 = $condition;
    CondAddOp.call(this, $node);
  }
  protoOf(_no_name_provided__qut3iv_2).prepare_oiipx8_k$ = function (affected) {
    return this.$condition_1() ? null : get_CONDITION_FALSE();
  };
  protoOf(_no_name_provided__qut3iv_2).prepare_226la0_k$ = function (affected) {
    return this.prepare_oiipx8_k$(affected instanceof LockFreeLinkedListNode ? affected : THROW_CCE());
  };
  ...
  protoOf(LockFreeLinkedListNode).makeCondAddOp_asyvr3_k$ = function (node, condition) {
    return new _no_name_provided__qut3iv_0(node, condition);
  };
  ...
  protoOf(LockFreeLinkedListNode).addLastIfPrevAndIf_pg0ch0_k$ = function (node, predicate, condition) {
    // Inline function 'io.ktor.util.internal.LockFreeLinkedListNode.makeCondAddOp' call
    var condAdd = new _no_name_provided__qut3iv_2(node, condition);
    while (true) {
      var tmp = this.get_prev_wosl18_k$();
      var prev = tmp instanceof LockFreeLinkedListNode ? tmp : THROW_CCE();
      if (!predicate(prev))
