(function (root, factory) {
  ...
  var CoroutineExceptionHandler = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.t;
  ...
  var get_lastIndex = kotlin_kotlin.$_$.qc;
  ...
  var isNaN_0 = kotlin_kotlin.$_$.nf;
  ...
  setMetadataFor(StringValuesBuilderImpl, 'StringValuesBuilderImpl', classMeta, VOID, [StringValuesBuilder], StringValuesBuilderImpl);
  ...
  protoOf(GMTDate).toString = function () {
    return 'GMTDate(seconds=' + this.seconds_1 + ', minutes=' + this.minutes_1 + ', hours=' + this.hours_1 + ', dayOfWeek=' + this.dayOfWeek_1 + ', dayOfMonth=' + this.dayOfMonth_1 + ', dayOfYear=' + this.dayOfYear_1 + ', month=' + this.month_1 + ', year=' + this.year_1 + ', timestamp=' + this.timestamp_1.toString() + ')';
  };
  ...
  function KtorSimpleLogger$1() {
    var tmp = this;
    var tmp_0;
    switch (PlatformUtils_getInstance().get_IS_NODE_myvmya_k$()) {
      case true:
