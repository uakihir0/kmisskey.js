(function (factory) {
  ...
  function pipelineStartCoroutineUninterceptedOrReturn$slambda($interceptor, $context, $subject, resultContinuation) {
    this.a2k_1 = $interceptor;
    this.b2k_1 = $context;
    this.c2k_1 = $subject;
    CoroutineImpl.call(this, resultContinuation);
  }
  protoOf(pipelineStartCoroutineUninterceptedOrReturn$slambda).c2a = function ($completion) {
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 2;
            this.n8_1 = 1;
            suspendResult = this.a2k_1(this.b2k_1, this.c2k_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(pipelineStartCoroutineUninterceptedOrReturn$slambda).d2k = function (completion) {
    return new pipelineStartCoroutineUninterceptedOrReturn$slambda(this.a2k_1, this.b2k_1, this.c2k_1, completion);
  };
