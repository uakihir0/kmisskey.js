(function (factory) {
  ...
  protoOf(Big).e3e = function (source, dest, destOffset) {
  ...
  protoOf(Big).f3e = function (source, dest, destOffset, sourceIndexStart, sourceIndexEnd) {
  ...
  protoOf(Big).g3e = function (source, dest, destOffset, sourceIndexStart, sourceIndexEnd) {
    // Inline function 'org.kotlincrypto.bitops.endian.internal.packArray' call
    var destPos = destOffset;
    var sourcePos = sourceIndexStart;
    while (sourcePos < sourceIndexEnd) {
