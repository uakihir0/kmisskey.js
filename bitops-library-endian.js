(function (factory) {
  ...
  protoOf(Big).b3g = function (source, dest, destOffset) {
  ...
  protoOf(Big).c3g = function (source, dest, destOffset, sourceIndexStart, sourceIndexEnd) {
  ...
  protoOf(Big).d3g = function (source, dest, destOffset, sourceIndexStart, sourceIndexEnd) {
    // Inline function 'org.kotlincrypto.bitops.endian.internal.packArray' call
    var destPos = destOffset;
    var sourcePos = sourceIndexStart;
    while (sourcePos < sourceIndexEnd) {
