(function (factory) {
  ...
  protoOf(Big).o39 = function (source, dest, destOffset) {
  ...
  protoOf(Big).p39 = function (source, dest, destOffset, sourceIndexStart, sourceIndexEnd) {
  ...
  protoOf(Big).q39 = function (source, dest, destOffset, sourceIndexStart, sourceIndexEnd) {
    // Inline function 'org.kotlincrypto.bitops.endian.internal.packArray' call
    var destPos = destOffset;
    var sourcePos = sourceIndexStart;
    while (sourcePos < sourceIndexEnd) {
