(function (factory) {
  ...
  protoOf(Big).u3f = function (source, dest, destOffset) {
  ...
  protoOf(Big).v3f = function (source, dest, destOffset, sourceIndexStart, sourceIndexEnd) {
  ...
  protoOf(Big).w3f = function (source, dest, destOffset, sourceIndexStart, sourceIndexEnd) {
    // Inline function 'org.kotlincrypto.bitops.endian.internal.packArray' call
    var destPos = destOffset;
    var sourcePos = sourceIndexStart;
    while (sourcePos < sourceIndexEnd) {
