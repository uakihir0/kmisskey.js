(function (factory) {
  ...
  protoOf(Big).o38 = function (source, dest, destOffset) {
  ...
  protoOf(Big).p38 = function (source, dest, destOffset, sourceIndexStart, sourceIndexEnd) {
  ...
  protoOf(Big).q38 = function (source, dest, destOffset, sourceIndexStart, sourceIndexEnd) {
    // Inline function 'org.kotlincrypto.bitops.endian.internal.packArray' call
    var destPos = destOffset;
    var sourcePos = sourceIndexStart;
    while (sourcePos < sourceIndexEnd) {
