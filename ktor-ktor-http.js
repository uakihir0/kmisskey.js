(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './kotlin-kotlin-stdlib.js', './ktor-ktor-io.js', './ktor-ktor-utils.js', './kotlinx-coroutines-core.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('./kotlin-kotlin-stdlib.js'), require('./ktor-ktor-io.js'), require('./ktor-ktor-utils.js'), require('./kotlinx-coroutines-core.js'));
  else {
    ...
    root['ktor-ktor-http'] = factory(typeof this['ktor-ktor-http'] === 'undefined' ? {} : this['ktor-ktor-http'], this['kotlin-kotlin-stdlib'], this['ktor-ktor-io'], this['ktor-ktor-utils'], this['kotlinx-coroutines-core']);
  }
  ...
  var imul = Math.imul;
  var THROW_IAE = kotlin_kotlin.$_$.te;
  ...
  var concatToString = kotlin_kotlin.$_$.xb;
  var Char = kotlin_kotlin.$_$.de;
  var isSurrogate = kotlin_kotlin.$_$.nc;
  ...
  var toByte = kotlin_kotlin.$_$.va;
  var String_0 = kotlin_io_ktor_ktor_io.$_$.z;
  var Char__plus_impl_qi7pgj = kotlin_kotlin.$_$.n2;
  ...
  var startsWith = kotlin_kotlin.$_$.bd;
  ...
  var contains_1 = kotlin_io_ktor_ktor_utils.$_$.o;
  ...
  var toLong_0 = kotlin_kotlin.$_$.wa;
  ...
  var Companion_getInstance_0 = kotlin_io_ktor_ktor_io.$_$.l;
  ...
  var checkIndexOverflow = kotlin_kotlin.$_$.x5;
  ...
  setMetadataFor(ParametersBuilderImpl, 'ParametersBuilderImpl', classMeta, StringValuesBuilderImpl, [StringValuesBuilderImpl, ParametersBuilder], ParametersBuilderImpl);
  setMetadataFor(ParametersImpl, 'ParametersImpl', classMeta, StringValuesImpl, [Parameters_0, StringValuesImpl], ParametersImpl);
  ...
  setMetadataFor(OutgoingContent$ReadChannelContent$readFrom$slambda, 'OutgoingContent$ReadChannelContent$readFrom$slambda', classMeta, CoroutineImpl, [CoroutineImpl], VOID, VOID, VOID, [1]);
  ...
  function encodeURLPath(_this__u8e3s4, encodeSlash) {
    ...
    $l$loop_0: while (index < _this__u8e3s4.length) {
      ...
      if (((!encodeSlash ? current === _Char___init__impl__6a9atx(47) : false) ? true : get_URL_ALPHABET_CHARS().contains_aljjnj_k$(new Char(current))) ? true : get_VALID_PATH_PART().contains_aljjnj_k$(new Char(current))) {
        this_0.append_am5a4z_k$(current);
        index = index + 1 | 0;
        continue $l$loop_0;
      }
      if (((current === _Char___init__impl__6a9atx(37) ? (index + 2 | 0) < _this__u8e3s4.length : false) ? get_HEX_ALPHABET().contains_aljjnj_k$(new Char(charSequenceGet(_this__u8e3s4, index + 1 | 0))) : false) ? get_HEX_ALPHABET().contains_aljjnj_k$(new Char(charSequenceGet(_this__u8e3s4, index + 2 | 0))) : false) {
        this_0.append_am5a4z_k$(current);
  ...
  function percentEncode_0(_this__u8e3s4, allowedSet) {
    ...
    $l$block: {
      ...
      if (charset.equals(Charsets_getInstance().get_UTF_8_ihn39z_k$())) {
        tmp$ret$2 = encodeToByteArray(_this__u8e3s4);
        break $l$block;
      }
      tmp$ret$2 = encodeToByteArray_0(charset.newEncoder_gqwcdg_k$(), _this__u8e3s4, 0, _this__u8e3s4.length);
    }
    var content = tmp$ret$2;
    ...
    while (inductionVariable_0 < last) {
      ...
      if (allowedSet.contains_aljjnj_k$(new Char(char))) {
        ...
        var tmp1 = writeIndex;
        writeIndex = tmp1 + 1 | 0;
        result[tmp1] = _Char___init__impl__6a9atx(37);
        var tmp2 = writeIndex;
        writeIndex = tmp2 + 1 | 0;
        result[tmp2] = hexDigitToChar(code >> 4);
        var tmp3 = writeIndex;
        writeIndex = tmp3 + 1 | 0;
        result[tmp3] = hexDigitToChar(code & 15);
      }
    }
  ...
  function encodeURLQueryComponent$lambda($spaceToPlus, $$this$buildString, $encodeFull) {
    return function (it) {
      ...
      if (it === 32) {
        ...
        tmp = tmp_0;
      } else if (get_URL_ALPHABET().contains_aljjnj_k$(it) ? true : !$encodeFull ? get_URL_PROTOCOL_PART().contains_aljjnj_k$(it) : false) {
        $$this$buildString.append_am5a4z_k$(numberToChar(it));
        tmp = Unit_getInstance();
      } else {
        $$this$buildString.append_22ad7x_k$(percentEncode(it));
  ...
  protoOf(Companion).parse_pc1q8p_k$ = function (value) {
    ...
    var v = headerValue.get_value_j01efc_k$();
      ...
      default:
        ...
        $l$block_0: {
          ...
          while (tmp0_iterator.hasNext_bitz1p_k$()) {
            ...
            // Inline function 'io.ktor.http.ContentType.hasParameter.<anonymous>' call
            if (equals_0(element.get_name_woqyms_k$(), name, true) ? equals_0(element.get_value_j01efc_k$(), value, true) : false) {
              tmp$ret$2 = true;
              break $l$block_0;
            }
          }
  ...
  protoOf(ContentType).match_m4pled_k$ = function (pattern) {
    return this.match_syvve3_k$(Companion_getInstance_3().parse_pc1q8p_k$(pattern));
  };
  ...
  function toContentType(_this__u8e3s4) {
    ...
    var tmp;
    try {
      tmp = Companion_getInstance_3().parse_pc1q8p_k$(_this__u8e3s4);
    } catch ($p) {
      var tmp_0;
  ...
  function contentType(_this__u8e3s4) {
    var tmp0_safe_receiver = _this__u8e3s4.get_headers_ef25jx_k$().get_6bo4tg_k$(HttpHeaders_getInstance().get_ContentType_z1j0sq_k$());
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
      ...
      tmp = Companion_getInstance_3().parse_pc1q8p_k$(tmp0_safe_receiver);
    }
    return tmp;
  }
  function contentLength(_this__u8e3s4) {
    var tmp0_safe_receiver = _this__u8e3s4.get_headers_ef25jx_k$().get_6bo4tg_k$(HttpHeaders_getInstance().get_ContentLength_3209rq_k$());
  ...
  function contentType_1(_this__u8e3s4, type) {
    return _this__u8e3s4.get_headers_ef25jx_k$().set_j87cuq_k$(HttpHeaders_getInstance().get_ContentType_z1j0sq_k$(), type.toString());
  }
  ...
  protoOf(Companion_3).parse_pc1q8p_k$ = function (method) {
    return method === this.Get_1.value_1 ? this.Get_1 : method === this.Post_1.value_1 ? this.Post_1 : method === this.Put_1.value_1 ? this.Put_1 : method === this.Patch_1.value_1 ? this.Patch_1 : method === this.Delete_1.value_1 ? this.Delete_1 : method === this.Head_1.value_1 ? this.Head_1 : method === this.Options_1.value_1 ? this.Options_1 : new HttpMethod(method);
  };
  ...
  protoOf(Companion_4).fromValue_pbj5rn_k$ = function (name, major, minor) {
    return ((name === 'HTTP' ? major === 1 : false) ? minor === 0 : false) ? this.HTTP_1_0__1 : ((name === 'HTTP' ? major === 1 : false) ? minor === 1 : false) ? this.HTTP_1_1__1 : ((name === 'HTTP' ? major === 2 : false) ? minor === 0 : false) ? this.HTTP_2_0__1 : new HttpProtocolVersion(name, major, minor);
  };
  ...
  function set(_this__u8e3s4, scheme, host, port, path, block) {
    ...
    block = tmp;
    if (!(scheme == null))
      _this__u8e3s4.protocol_1 = Companion_getInstance_11().createOrDefault_lkipzc_k$(scheme);
    if (!(host == null))
  ...
  function takeFromUnsafe(_this__u8e3s4, urlString) {
    ...
    if (schemeLength > 0) {
      ...
      _this__u8e3s4.set_protocol_fzc1gx_k$(Companion_getInstance_11().createOrDefault_lkipzc_k$(scheme));
    ...
    if (startIndex >= endIndex) {
      _this__u8e3s4.set_encodedPathSegments_jw2fx8_k$(charSequenceGet(urlString, endIndex - 1 | 0) === _Char___init__impl__6a9atx(47) ? get_ROOT_PATH() : emptyList());
      return _this__u8e3s4;
    }
    var tmp_0;
    if (slashCount === 0) {
  ...
  protoOf(Companion_8).createOrDefault_lkipzc_k$ = function (name) {
    ...
    var tmp0_elvis_lhs = Companion_getInstance_11().byName_1.get_wei43m_k$(it);
  ...
  function get_fullPath(_this__u8e3s4) {
    ...
    var this_0 = StringBuilder_init_$Create$();
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'io.ktor.http.<get-fullPath>.<anonymous>' call
    appendUrlFullPath_0(this_0, _this__u8e3s4.get_encodedPath_p9zwnq_k$(), _this__u8e3s4.get_encodedQuery_28s95p_k$(), _this__u8e3s4.get_trailingQuery_m2fl7h_k$());
    return this_0.toString();
  }
  ...
  function appendUrlFullPath_0(_this__u8e3s4, encodedPath, encodedQuery, trailingQuery) {
    ...
    _this__u8e3s4.append_jgojdo_k$(encodedQuery);
  }
  ...
  function FileItem(provider, dispose, partHeaders) {
    ...
    tmp.originalFileName_1 = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.parameter_w3eqbz_k$(Parameters_getInstance().get_FileName_s4mscw_k$());
  }
  ...
  function PartData$contentDisposition$delegate$lambda(this$0) {
    return function () {
      var tmp0_safe_receiver = this$0.headers_1.get_6bo4tg_k$(HttpHeaders_getInstance().get_ContentDisposition_335qnb_k$());
      var tmp;
      if (tmp0_safe_receiver == null) {
        tmp = null;
      } else {
  ...
  function PartData$contentType$delegate$lambda(this$0) {
    return function () {
      var tmp0_safe_receiver = this$0.headers_1.get_6bo4tg_k$(HttpHeaders_getInstance().get_ContentType_z1j0sq_k$());
      var tmp;
      if (tmp0_safe_receiver == null) {
        tmp = null;
      } else {
  ...
  protoOf(PartData).get_contentDisposition_rd8xyx_k$ = function () {
    // Inline function 'kotlin.getValue' call
    var this_0 = this.contentDisposition$delegate_1;
    contentDisposition$factory();
    return this_0.get_value_j01efc_k$();
  };
  protoOf(PartData).get_contentType_7git4a_k$ = function () {
    // Inline function 'kotlin.getValue' call
    var this_0 = this.contentType$delegate_1;
    contentType$factory();
    return this_0.get_value_j01efc_k$();
  };
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            var tmp_0 = this;
            tmp_0.limit1__1 = this.$range_1.get_endInclusive_r07xpi_k$().minus_mfbszm_k$(this.$range_1.get_start_iypx6h_k$()).plus_r93sks_k$(toLong_0(1));
  ...
  _.$_$.l1 = contentType;
  _.$_$.m1 = contentType_1;
  _.$_$.n1 = decodeURLPart;
  _.$_$.o1 = encodeURLParameter;
