(function (factory) {
  if (typeof define === 'function' && define.amd)
    ...
    globalThis['ktor-ktor-http'] = factory(typeof globalThis['ktor-ktor-http'] === 'undefined' ? {} : globalThis['ktor-ktor-http'], globalThis['kotlin-kotlin-stdlib'], globalThis['ktor-ktor-io'], globalThis['ktor-ktor-utils'], globalThis['kotlinx-coroutines-core']);
  }
}(function (_, kotlin_kotlin, kotlin_io_ktor_ktor_io, kotlin_io_ktor_ktor_utils, kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core) {
  'use strict';
  ...
  var caseInsensitiveMap = kotlin_io_ktor_ktor_utils.$_$.z;
  var asSequence = kotlin_kotlin.$_$.m6;
  var map = kotlin_kotlin.$_$.xc;
  var to = kotlin_kotlin.$_$.kh;
  var KProperty0 = kotlin_kotlin.$_$.sc;
  ...
  var contains_0 = kotlin_io_ktor_ktor_utils.$_$.r;
  var contains_1 = kotlin_io_ktor_ktor_utils.$_$.q;
  ...
  function encodeURLPath(_this__u8e3s4, encodeSlash) {
    ...
    $l$loop_0: while (index < _this__u8e3s4.length) {
      ...
      if (current === _Char___init__impl__6a9atx(37) && (index + 2 | 0) < _this__u8e3s4.length && get_HEX_ALPHABET().contains_aljjnj_k$(new Char(charSequenceGet(_this__u8e3s4, index + 1 | 0))) && get_HEX_ALPHABET().contains_aljjnj_k$(new Char(charSequenceGet(_this__u8e3s4, index + 2 | 0)))) {
        this_0.append_am5a4z_k$(current);
  ...
  function encodeURLQueryComponent$lambda($spaceToPlus, $$this$buildString, $encodeFull) {
    return function (it) {
      ...
      if (it === 32) {
        ...
        tmp = tmp_0;
      } else if (get_URL_ALPHABET().contains_aljjnj_k$(it) || (!$encodeFull && get_URL_PROTOCOL_PART().contains_aljjnj_k$(it))) {
        $$this$buildString.append_am5a4z_k$(numberToChar(it));
        tmp = Unit_getInstance();
      } else {
        $$this$buildString.append_22ad7x_k$(percentEncode(it));
  ...
  protoOf(Companion_4).fromValue_pbj5rn_k$ = function (name, major, minor) {
    return name === 'HTTP' && major === 1 && minor === 0 ? this.HTTP_1_0__1 : name === 'HTTP' && major === 1 && minor === 1 ? this.HTTP_1_1__1 : name === 'HTTP' && major === 2 && minor === 0 ? this.HTTP_2_0__1 : new HttpProtocolVersion(name, major, minor);
  };
  ...
  function get_authority(_this__u8e3s4) {
    ...
    if (!(_this__u8e3s4.port_1 === 0) && !(_this__u8e3s4.port_1 === _this__u8e3s4.protocol_1.get_defaultPort_6nzc3d_k$())) {
      this_0.append_22ad7x_k$(':');
  ...
  function fillHost(_this__u8e3s4, urlString, startIndex, endIndex) {
    ...
    if ((colonIndex + 1 | 0) < endIndex) {
      ...
      _this__u8e3s4.set_port_gcpocq_k$(0);
    }
  }
  ...
  function get_authority_0(_this__u8e3s4) {
    ...
    if (_this__u8e3s4.specifiedPort_1 === 0 || _this__u8e3s4.specifiedPort_1 === _this__u8e3s4.protocol_1.get_defaultPort_6nzc3d_k$()) {
      this_0.append_22ad7x_k$(_this__u8e3s4.host_1);
    } else {
