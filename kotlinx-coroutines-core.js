(function (factory) {
  ...
  var RuntimeException_init_$Create$ = kotlin_kotlin.$_$.b3;
  ...
  var NoSuchElementException = kotlin_kotlin.$_$.wf;
  ...
  var coerceIn = kotlin_kotlin.$_$.lc;
  //endregion
  ...
  function close$default(cause, $super) {
    cause = cause === VOID ? null : cause;
    return $super === VOID ? this.r1v(cause) : $super.r1v.call(this, cause);
  }
  ...
  protoOf(DispatchedCoroutine).t1e = function (state) {
    if (tryResume(this))
      return Unit_instance;
    resumeCancellableWithInternal(intercepted(this.z1g_1), recoverResult(state, this.z1g_1));
  };
  ...
  protoOf(CompletedContinuation).equals = function (other) {
    ...
    if (!equals(this.y1i_1, other.y1i_1))
      return false;
    if (!equals(this.z1i_1, other.z1i_1))
      return false;
  ...
  function createCauseException($this, cause) {
    ...
    if (cause == null ? true : cause instanceof Error) {
      ...
      tmp = (isInterface(cause, ParentJob) ? cause : THROW_CCE()).z1f();
    }
    return tmp;
  }
  ...
  protoOf(TimeoutCoroutine).d1k = function () {
    var delay = get_delay(this.i1e_1);
    var tmp0_safe_receiver = this.i1e_1.a9(Key_instance_2);
    var name = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.t1l_1;
    this.x1f(TimeoutCancellationException_0(this.g1q_1, delay, this, name));
  };
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            this.j1u_1 = access$_get_sendSegment__111kgq(this.k1u_1).kotlinx$atomicfu$value;
            this.n8_1 = 2;
            continue $sm;
          case 2:
            if (!true) {
            ...
            var sendersAndCloseStatusCur = access$_get_sendersAndCloseStatus__tvw29s(this.k1u_1).atomicfu$getAndIncrement$long();
            var tmp_0 = this;
            tmp_0.m1u_1 = bitwiseAnd(sendersAndCloseStatusCur, new Long(-1, 268435455));
            this.o1u_1 = access$_get_isClosedForSend0__sm8f7a(this.k1u_1, sendersAndCloseStatusCur);
            var tmp0 = this.m1u_1;
            var other = get_SEGMENT_SIZE();
            var id = divide(tmp0, fromInt(other));
            var tmp_1 = this;
            ...
            if (!equalsLong(this.j1u_1.u1i_1, id)) {
              var tmp0_elvis_lhs = access$findSegmentSend(this.k1u_1, id, this.j1u_1);
              if (tmp0_elvis_lhs == null) {
                if (this.o1u_1) {
                  this.n8_1 = 10;
          ...
          case 3:
            ...
            continue $sm;
          case 4:
            var tmp1_subject = access$updateCellSend(this.k1u_1, this.j1u_1, this.i1u_1, this.n1u_1, this.m1u_1, this.l1u_1, this.o1u_1);
            if (tmp1_subject === 0) {
              this.j1u_1.y1r();
              this.n8_1 = 13;
              continue $sm;
          ...
          case 8:
            ...
            if (tmp2_safe_receiver == null)
              ...
              access$prepareSenderForSuspension(this.k1u_1, tmp2_safe_receiver, this.j1u_1, this.i1u_1);
            }
  ...
  protoOf(BufferedChannel).p1v = function ($completion) {
  ...
  protoOf(BufferedChannel).q1v = function () {
  };
  protoOf(BufferedChannel).r1v = function (cause) {
    return this.s1v(cause, false);
  };
  protoOf(BufferedChannel).s1f = function (cause) {
    this.u1v(cause);
  };
  protoOf(BufferedChannel).u1v = function (cause) {
    return this.s1v(cause == null ? CancellationException_init_$Create$('Channel was cancelled') : cause, true);
  };
  protoOf(BufferedChannel).s1v = function (cause, cancel) {
    if (cancel) {
  ...
  protoOf(BufferedChannel).toString = function () {
    ...
    append_elements: while (true) {
      ...
      var tmp4_elvis_lhs = segment.u1r();
      var tmp_0;
  ...
  function Factory() {
    ...
    this.w1v_1 = 2147483647;
    this.x1v_1 = 0;
    this.y1v_1 = -1;
    this.z1v_1 = -2;
    this.a1w_1 = -3;
    this.b1w_1 = 'kotlinx.coroutines.channels.defaultBuffer';
    this.c1w_1 = systemProp('kotlinx.coroutines.channels.defaultBuffer', 64, 1, 2147483646);
  }
  ...
  function ChannelResult__exceptionOrNull_impl_16ei30($this) {
    ...
    return tmp0_safe_receiver == null ? null : tmp0_safe_receiver.d1w_1;
  }
  function Failed() {
  }
  ...
  protoOf(Closed).equals = function (other) {
    ...
    if (other instanceof Closed) {
      tmp = equals(this.d1w_1, other.d1w_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  protoOf(Closed).toString = function () {
    return 'Closed(' + toString_0(this.d1w_1) + ')';
  };
  function Companion() {
  ...
  function ChannelResult__equals_impl_f471ri($this, other) {
    if (!(other instanceof ChannelResult))
      return false;
    var tmp0_other_with_cast = other.x1t_1;
  ...
  function Channel(capacity, onBufferOverflow, onUndeliveredElement) {
    ...
    switch (capacity) {
      ...
      case 2147483647:
        ...
        break;
      case -2:
        tmp = onBufferOverflow.equals(BufferOverflow_SUSPEND_getInstance()) ? new BufferedChannel(Factory_getInstance().c1w_1, onUndeliveredElement) : new ConflatedBufferedChannel(1, onBufferOverflow, onUndeliveredElement);
        break;
      default:
  ...
  protoOf(ChannelCoroutine).v1v = function (cause, $super) {
  ...
  protoOf(ChannelCoroutine).u1f = function (cause) {
    ...
    this.h1w_1.s1f(exception);
    this.x1f(exception);
  };
  protoOf(ChannelCoroutine).r1t = function () {
    return this.h1w_1.r1t();
  };
  protoOf(ChannelCoroutine).m1v = function (element, $completion) {
    return this.h1w_1.m1v(element, $completion);
  };
  protoOf(ChannelCoroutine).n1v = function (element) {
    return this.h1w_1.n1v(element);
  };
  protoOf(ChannelCoroutine).r1v = function (cause) {
    return this.h1w_1.r1v(cause);
  };
  protoOf(ChannelCoroutine).p1v = function ($completion) {
    return this.h1w_1.p1v($completion);
  };
  ...
  function trySendImpl($this, element, isSendOp) {
    return $this.v1w_1 === BufferOverflow_DROP_LATEST_getInstance() ? trySendDropLatest($this, element, isSendOp) : trySendDropOldest($this, element);
  }
  ...
  function ConflatedBufferedChannel(capacity, onBufferOverflow, onUndeliveredElement) {
    ...
    this.u1w_1 = capacity;
    this.v1w_1 = onBufferOverflow;
    // Inline function 'kotlin.require' call
    if (!!(this.v1w_1 === BufferOverflow_SUSPEND_getInstance())) {
      var message = 'This implementation does not support suspension for senders, use ' + getKClass(BufferedChannel).o() + ' instead';
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
    // Inline function 'kotlin.require' call
    if (!(this.u1w_1 >= 1)) {
      var message_0 = 'Buffered channel capacity must be at least 1, but ' + this.u1w_1 + ' was specified';
      throw IllegalArgumentException_init_$Create$(toString(message_0));
    }
  }
  protoOf(ConflatedBufferedChannel).t1t = function () {
    return this.v1w_1.equals(BufferOverflow_DROP_OLDEST_getInstance());
  };
  ...
  protoOf(ProducerCoroutine).a1x = function (value) {
    this.h1w_1.t1v();
  };
  protoOf(ProducerCoroutine).l1e = function (value) {
    return this.a1x(value instanceof Unit ? value : THROW_CCE());
  };
  protoOf(ProducerCoroutine).m1e = function (cause, handled) {
    var processed = this.h1w_1.r1v(cause);
    if (!processed && !handled) {
      handleCoroutineException(this.i1e_1, cause);
    }
  };
  protoOf(ProducerCoroutine).v1v = function (cause, $super) {
  ...
  function SegmentOrClosed__equals_impl_6erq1g($this, other) {
    if (!(other instanceof SegmentOrClosed))
      return false;
    var tmp0_other_with_cast = other.w1t_1;
    if (!equals($this, tmp0_other_with_cast))
      return false;
    return true;
  }
  ...
  protoOf(DispatchedContinuation).b1x = function () {
    // Inline function 'kotlinx.atomicfu.loop' call
  ...
  protoOf(ContextScope).toString = function () {
    return 'CoroutineScope(coroutineContext=' + toString(this.c1x_1) + ')';
  };
  ...
  function trySelectInternal($this, clauseObject, internalResult) {
    $l$loop: while (true) {
      ...
      if (isInterface(curState, CancellableContinuation)) {
        ...
        var clause = tmp;
        var onCancellation = clause.h1x($this, internalResult);
  ...
  protoOf(ClauseData).h1x = function (select, internalResult) {
    var tmp0_safe_receiver = this.g1x_1;
    return tmp0_safe_receiver == null ? null : tmp0_safe_receiver(select, this.f1x_1, internalResult);
  };
  ...
  protoOf(NodeDispatcher).k1x = function () {
    process.nextTick(this.r1x_1.p1x_1);
  };
  ...
  function ScheduledMessageQueue(dispatcher) {
    ...
    this.o1x_1 = dispatcher;
    var tmp = this;
    tmp.p1x_1 = ScheduledMessageQueue$processQueue$lambda(this);
  }
  protoOf(ScheduledMessageQueue).w1x = function () {
    this.o1x_1.k1x();
  };
  protoOf(ScheduledMessageQueue).x1x = function () {
    setTimeout(this.p1x_1, 0);
  };
  protoOf(ScheduledMessageQueue).y1x = function (timeout) {
    setTimeout(this.p1x_1, timeout);
  };
  ...
  function WindowMessageQueue$lambda(this$0) {
    return function (event) {
      var tmp;
      if (event.source == this$0.l1y_1 && event.data == this$0.m1y_1) {
  ...
  function WindowMessageQueue(window_0) {
    MessageQueue.call(this);
    this.l1y_1 = window_0;
    this.m1y_1 = 'dispatchCoroutine';
    this.l1y_1.addEventListener('message', WindowMessageQueue$lambda(this), true);
  }
  protoOf(WindowMessageQueue).w1x = function () {
    var tmp = Promise.resolve(Unit_instance);
    tmp.then(WindowMessageQueue$schedule$lambda(this));
  };
  protoOf(WindowMessageQueue).x1x = function () {
    this.l1y_1.postMessage(this.m1y_1, '*');
  };
  ...
  function JsMainDispatcher(delegate, invokeImmediately) {
    ...
    this.s1y_1 = delegate;
    this.t1y_1 = invokeImmediately;
    this.u1y_1 = this.t1y_1 ? this : new JsMainDispatcher(this.s1y_1, true);
  }
  ...
  protoOf(JsMainDispatcher).o1l = function (context, block) {
    return this.s1y_1.o1l(context, block);
  };
  protoOf(JsMainDispatcher).toString = function () {
    var tmp0_elvis_lhs = this.h1p();
    return tmp0_elvis_lhs == null ? this.s1y_1.toString() : tmp0_elvis_lhs;
  };
  ...
  protoOf(JobCancellationException).toString = function () {
    return protoOf(CancellationException).toString.call(this) + '; job=' + toString(this.v1y_1);
  };
  protoOf(JobCancellationException).equals = function (other) {
    ...
    if (other === this) {
      ...
      if (tmp_2) {
        tmp_1 = equals(other.v1y_1, this.v1y_1);
      } else {
        tmp_1 = false;
      }
      if (tmp_1) {
  ...
  protoOf(JobCancellationException).hashCode = function () {
    var tmp = imul(imul(getStringHashCode(ensureNotNull(this.message)), 31) + hashCode(this.v1y_1) | 0, 31);
  ...
  protoOf(LockFreeLinkedListNode).v1k = function (node, permissionsBitmask) {
    ...
    if (prev instanceof ListClosed) {
      tmp = ((prev.z1y_1 & permissionsBitmask) === 0 && prev.v1k(node, permissionsBitmask));
    } else {
      node.s1k_1 = this;
      node.t1k_1 = prev;
      prev.s1k_1 = node;
  ...
  function ListClosed(forbiddenElementsBitmask) {
    LockFreeLinkedListNode.call(this);
    this.z1y_1 = forbiddenElementsBitmask;
  }
  ...
  protoOf(SetTimeoutDispatcher).k1x = function () {
    this.r1x_1.y1x(0);
  };
  ...
  function SetTimeoutBasedDispatcher() {
    CoroutineDispatcher.call(this);
    this.r1x_1 = new ScheduledMessageQueue(this);
  }
  protoOf(SetTimeoutBasedDispatcher).o1l = function (context, block) {
    this.r1x_1.z1x(block);
  };
  ...
  function MessageQueue() {
    this.s1x_1 = ArrayDeque_init_$Create$();
    this.t1x_1 = 16;
    this.u1x_1 = false;
  }
  protoOf(MessageQueue).z1x = function (element) {
    this.a1y(element);
    if (!this.u1x_1) {
      this.u1x_1 = true;
      this.w1x();
  ...
  protoOf(MessageQueue).v1x = function () {
    try {
      // Inline function 'kotlin.repeat' call
      var times = this.t1x_1;
      var inductionVariable = 0;
      if (inductionVariable < times)
        do {
          var index = inductionVariable;
  ...
  protoOf(MessageQueue).a1y = function (element) {
    return this.s1x_1.b1(element);
  };
  protoOf(MessageQueue).b1 = function (element) {
    return this.a1y((!(element == null) ? isInterface(element, Runnable) : false) ? element : THROW_CCE());
  };
  protoOf(MessageQueue).b1y = function (index, element) {
    this.s1x_1.a3(index, element);
  };
  protoOf(MessageQueue).a3 = function (index, element) {
    return this.b1y(index, (!(element == null) ? isInterface(element, Runnable) : false) ? element : THROW_CCE());
  };
  protoOf(MessageQueue).c1y = function (elements) {
    return this.s1x_1.i1(elements);
  };
  protoOf(MessageQueue).i1 = function (elements) {
    return this.c1y(elements);
  };
  protoOf(MessageQueue).y2 = function () {
    this.s1x_1.y2();
  };
  protoOf(MessageQueue).d1y = function (index, element) {
    return this.s1x_1.z2(index, element);
  };
  protoOf(MessageQueue).z2 = function (index, element) {
    return this.d1y(index, (!(element == null) ? isInterface(element, Runnable) : false) ? element : THROW_CCE());
  };
  protoOf(MessageQueue).b3 = function (index) {
    return this.s1x_1.b3(index);
  };
  protoOf(MessageQueue).n2 = function () {
    return this.s1x_1.n2();
  };
  protoOf(MessageQueue).j1 = function (index) {
    return this.s1x_1.j1(index);
  };
  protoOf(MessageQueue).o2 = function (fromIndex, toIndex) {
    return this.s1x_1.o2(fromIndex, toIndex);
  };
  protoOf(MessageQueue).r = function () {
    return this.s1x_1.r();
  };
  protoOf(MessageQueue).e1y = function (element) {
    return this.s1x_1.j2(element);
  };
  ...
  protoOf(MessageQueue).f1y = function (elements) {
    return this.s1x_1.k2(elements);
  };
  protoOf(MessageQueue).k2 = function (elements) {
    return this.f1y(elements);
  };
  protoOf(MessageQueue).d1 = function (index) {
    return this.s1x_1.d1(index);
  };
  protoOf(MessageQueue).g1y = function (element) {
    return this.s1x_1.l2(element);
  };
  protoOf(MessageQueue).l2 = function (element) {
    if (!(!(element == null) ? isInterface(element, Runnable) : false))
      return -1;
    return this.g1y((!(element == null) ? isInterface(element, Runnable) : false) ? element : THROW_CCE());
  };
  protoOf(MessageQueue).h1y = function (element) {
    return this.s1x_1.m2(element);
  };
  ...
  protoOf(MessageQueue).asJsReadonlyArrayView = function () {
    return this.s1x_1.asJsReadonlyArrayView();
  };
  protoOf(MessageQueue).e1 = function () {
    return this.s1x_1.ue_1;
  };
  ...
  protoOf(WindowClearTimeout).f1i = function () {
    w3cClearTimeout(this.h1z_1.j1z_1, this.l1z_1);
  };
  ...
  function WindowDispatcher(window_0) {
    CoroutineDispatcher.call(this);
    this.j1z_1 = window_0;
    this.k1z_1 = new WindowMessageQueue(this.j1z_1);
  }
  protoOf(WindowDispatcher).o1l = function (context, block) {
    return this.k1z_1.z1x(block);
  };
  protoOf(WindowDispatcher).v1l = function (timeMillis, continuation) {
    var handle = w3cSetTimeout_0(this.j1z_1, WindowDispatcher$scheduleResumeAfterDelay$lambda(continuation, this), delayToInt(timeMillis));
  ...
  protoOf(WindowDispatcher).w1l = function (timeMillis, block, context) {
    var handle = w3cSetTimeout_0(this.j1z_1, Runnable$run$ref(block), delayToInt(timeMillis));
  ...
  protoOf(ClearTimeout).f1i = function () {
    w3cClearTimeout_0(this.l1z_1);
  };
  protoOf(ClearTimeout).e1i = function (cause) {
    this.f1i();
  };
  protoOf(ClearTimeout).toString = function () {
    return 'ClearTimeout[' + this.l1z_1 + ']';
  };
  ...
  protoOf(BufferedChannel).t1v = close$default;
  protoOf(BufferedChannel).v1v = cancel$default_0;
  protoOf(ChannelCoroutine).t1v = close$default;
