(function (factory) {
  ...
  protoOf(HttpParameter).b4p = function () {
  ...
  protoOf(HttpParameter).c4p = function () {
    switch (this.b4p()) {
      case 'txt':
        return Text_getInstance().k2i_1;
      case 'html':
        return Text_getInstance().n2i_1;
      case 'css':
        return Text_getInstance().l2i_1;
      case 'csv':
        return Text_getInstance().m2i_1;
      case 'jpg':
      case 'jpeg':
        return Image_getInstance().r2h_1;
      case 'png':
        return Image_getInstance().t2h_1;
      case 'gif':
        return Image_getInstance().o2h_1;
      case 'svg':
        return Image_getInstance().u2h_1;
      case 'mpeg':
        return Video_getInstance().u2i_1;
      case 'mp4':
        return Video_getInstance().v2i_1;
      case 'mov':
        return Video_getInstance().x2i_1;
      case 'webm':
        return ContentType_init_$Create$('video', 'webm');
      case 'json':
        return Application_getInstance().p2g_1;
      case 'xml':
  ...
  function canSendOnly($this, param) {
    if (param.w4o_1.equals(Type_JSON_getInstance()))
      return true;
    var tmp0_subject = param.c4p();
    return tmp0_subject.equals(Application_getInstance().p2g_1) ? true : tmp0_subject.equals(Image_getInstance().r2h_1) ? true : tmp0_subject.equals(Image_getInstance().t2h_1) ? true : tmp0_subject.equals(Image_getInstance().o2h_1) ? true : tmp0_subject.equals(Video_getInstance().u2i_1) ? true : tmp0_subject.equals(Video_getInstance().v2i_1) ? true : tmp0_subject.equals(Video_getInstance().x2i_1) ? true : tmp0_subject.equals(ContentType_init_$Create$('video', 'webm')) ? true : false;
  }
  function HttpRequest$proceed$lambda($req) {
    return function ($this$HttpClient) {
      ...
      $this$HttpClient.y3j_1 = $req.z4p_1;
      return Unit_instance;
    };
  }
  function HttpRequest$proceed$lambda_0($req) {
    return function ($this$headers) {
      ...
      var _iterator__ex2g4s = $req.w4p_1.k1().t();
  ...
  function HttpRequest$proceed$lambda_1($req) {
    return function ($this$timeout) {
      $this$timeout.c49($req.b4q_1);
      $this$timeout.d49($req.c4q_1);
      $this$timeout.e49($req.d4q_1);
      return Unit_instance;
    };
  }
  function HttpRequest$proceed$lambda_2($params, $files) {
    return function ($this$formData) {
      ...
      while (_iterator__ex2g4s.u()) {
        var element = _iterator__ex2g4s.v();
        $this$formData.b4g(element.x4o_1, ensureNotNull(element.y4o_1));
      }
      // Inline function 'kotlin.collections.forEach' call
      var _iterator__ex2g4s_0 = $files.t();
      while (_iterator__ex2g4s_0.u()) {
        var element_0 = _iterator__ex2g4s_0.v();
        var tmp = ensureNotNull(element_0.a4p_1);
        // Inline function 'io.ktor.http.Companion.build' call
        Companion_getInstance();
        // Inline function 'kotlin.apply' call
        var this_0 = new HeadersBuilder();
        append(this_0, HttpHeaders_getInstance().a2k_1, element_0.c4p());
        this_0.v2b(HttpHeaders_getInstance().u2j_1, 'filename=' + element_0.z4o_1);
        var tmp$ret$4 = this_0.h2j();
        $this$formData.c4g(element_0.x4o_1, tmp, tmp$ret$4);
      }
      return Unit_instance;
    };
  }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            var tmp0_safe_receiver = this.l4p_1.t4p_1;
            if (tmp0_safe_receiver == null)
              null;
            else {
              this.l4p_1.w4p_1.v2('Accept', tmp0_safe_receiver);
            }

            var tmp1_safe_receiver = this.l4p_1.u4p_1;
            if (tmp1_safe_receiver == null)
              null;
            else {
              var tmp0 = this.l4p_1.w4p_1;
              var key = 'User-Agent';
              tmp0.v2(key, tmp1_safe_receiver);
            }

            this.n4p_1 = Companion_getInstance_3();
            var this_0 = new HttpRequestBuilder();
            this_0.i3j_1 = this.m4p_1;
            if (!(req.s4p_1 == null)) {
              var tmp0_0 = req.s4p_1;
              ...
              l$ret$1: do {
               ...
               while (false);
              var tmp_0 = tmp$ret$0;
              takeFrom(this_0.h3j_1, URLBuilder(tmp_0));
            } else {
              url(this_0, req.o4p_1, req.p4p_1, req.r4p_1, req.q4p_1);
            }

            headers(this_0, HttpRequest$proceed$lambda_0(req));
            timeout(this_0, HttpRequest$proceed$lambda_1(req));
            if (!this.l4p_1.x4p_1 && !this.l4p_1.y4p_1 && req.v4p_1.e1() === 1 && canSendOnly(this.l4p_1, first(req.v4p_1))) {
              var param = first(req.v4p_1);
              var body = new ByteArrayContent(ensureNotNull(param.a4p_1), param.c4p());
              if (body == null) {
                ...
                this_0.c3p(new TypeInfo(tmp_1, tmp_2));
              } else {
                if (body instanceof OutgoingContent) {
                  ...
                  this_0.c3p(new TypeInfo(tmp_4, tmp_5));
                }
              }
            } else {
              if (this.m4p_1.equals(Companion_getInstance_1().m2n_1)) {
                var _iterator__ex2g4s = req.v4p_1.t();
                while (_iterator__ex2g4s.u()) {
                  var element = _iterator__ex2g4s.v();
                  if (element.w4o_1.a1_1 === 0) {
                    this_0.h3j_1.w2q_1.v2b(element.x4o_1, ensureNotNull(element.y4o_1));
                  } else {
                    throw IllegalStateException_init_$Create$('Request Body is not supported in the GET method.');
                  }
                }
              } else {
                var tmp0_1 = req.v4p_1;
                var destination = ArrayList_init_$Create$();
                var _iterator__ex2g4s_0 = tmp0_1.t();
                while (_iterator__ex2g4s_0.u()) {
                  var element_0 = _iterator__ex2g4s_0.v();
                  if (element_0.w4o_1.equals(Type_QUERY_getInstance())) {
                    destination.b1(element_0);
                  }
                }
                var queries = destination;
                var tmp0_2 = req.v4p_1;
                var destination_0 = ArrayList_init_$Create$();
                var _iterator__ex2g4s_1 = tmp0_2.t();
                while (_iterator__ex2g4s_1.u()) {
                  var element_1 = _iterator__ex2g4s_1.v();
                  if (element_1.w4o_1.equals(Type_PARAM_getInstance())) {
                    destination_0.b1(element_1);
                  }
                }
                var params = destination_0;
                var tmp0_3 = req.v4p_1;
                var destination_1 = ArrayList_init_$Create$();
                var _iterator__ex2g4s_2 = tmp0_3.t();
                while (_iterator__ex2g4s_2.u()) {
                  var element_2 = _iterator__ex2g4s_2.v();
                  if (element_2.w4o_1.equals(Type_FILE_getInstance())) {
                ...
                if (!queries.r()) {
                  ...
                  while (_iterator__ex2g4s_3.u()) {
                    ...
                    this_0.h3j_1.w2q_1.v2b(element_3.x4o_1, ensureNotNull(element_3.y4o_1));
                  }
                }
                var tmp_7;
                if (!params.r()) {
                ...
                if (tmp_7) {
                  if (this.l4p_1.y4p_1) {
                    ...
                    contentType(this_0, Application_getInstance().a2h_1);
                    Companion_getInstance_0();
                    var this_1 = ParametersBuilder();
                    var _iterator__ex2g4s_4 = params.t();
                    while (_iterator__ex2g4s_4.u()) {
                      var element_4 = _iterator__ex2g4s_4.v();
                      this_1.v2b(element_4.x4o_1, ensureNotNull(element_4.y4o_1));
                    }
                    var body_0 = new FormDataContent(this_1.h2j());
                    if (body_0 == null) {
                      this_0.k3j_1 = NullBody_instance;
                      ...
                      this_0.c3p(new TypeInfo(tmp_8, tmp_9));
                    } else {
                      if (body_0 instanceof OutgoingContent) {
                        ...
                        this_0.c3p(new TypeInfo(tmp_11, tmp_12));
                      }
                    }
                  } else {
                    contentType(this_0, MultiPart_getInstance().d2i_1);
                    ...
                    if (body_1 == null) {
                      ...
                      this_0.c3p(new TypeInfo(tmp_14, tmp_15));
                    } else {
                      if (body_1 instanceof OutgoingContent) {
                        ...
                        this_0.c3p(new TypeInfo(tmp_17, tmp_18));
                      }
                    }
                  }
                }
            ...
            this.n8_1 = 1;
            suspendResult = (new HttpStatement(this_0, client)).u4i(this);
          ...
          case 1:
            ...
            this.n8_1 = 2;
            suspendResult = this.n4p_1.f4q(ARGUMENT, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  function HttpRequest() {
    ...
    this.s4p_1 = null;
    this.t4p_1 = null;
    this.u4p_1 = 'kHttpClient/1.0';
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.v4p_1 = ArrayList_init_$Create$();
    var tmp_0 = this;
    // Inline function 'kotlin.collections.mutableMapOf' call
    tmp_0.w4p_1 = LinkedHashMap_init_$Create$();
    this.x4p_1 = false;
    this.y4p_1 = false;
    this.z4p_1 = true;
    this.a4q_1 = false;
  ...
  protoOf(HttpRequest).g4q = function (url) {
    // Inline function 'kotlin.also' call
    this.s4p_1 = url;
    return this;
  };
  protoOf(HttpRequest).h4q = function (accept) {
    // Inline function 'kotlin.also' call
    this.t4p_1 = accept;
    return this;
  };
  protoOf(HttpRequest).i4q = function (key, value) {
    // Inline function 'kotlin.also' call
    this.v4p_1.b1(Companion_instance.t4o(key, toString(value)));
    return this;
  };
  protoOf(HttpRequest).u4o = function (key, fileName, fileBody) {
    // Inline function 'kotlin.also' call
    this.v4p_1.b1(Companion_instance.u4o(key, fileName, fileBody));
    return this;
  };
  protoOf(HttpRequest).v4o = function (json) {
    // Inline function 'kotlin.also' call
    this.v4p_1.b1(Companion_instance.v4o(json));
    return this;
  };
  protoOf(HttpRequest).j4q = function ($completion) {
    return proceed(this, Companion_getInstance_1().n2n_1, $completion);
  };
  function HttpResponse$Companion$mapper$lambda($this$Json) {
    $this$Json.h2v_1 = true;
    return Unit_instance;
  }
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 2;
            this.v4q_1 = this.t4q_1.g3l().h2q_1;
            this.u4q_1 = toMap(this.t4q_1.l2n());
          ...
          case 1:
            ...
            return new HttpResponse(this.v4q_1, this.u4q_1, ARGUMENT);
          case 2:
            throw this.q8_1;
        }
      } catch ($p) {
  ...
  function Companion_0() {
    ...
    var tmp = this;
    tmp.e4q_1 = Json(VOID, HttpResponse$Companion$mapper$lambda);
  }
  protoOf(Companion_0).f4q = function (response, $completion) {
  ...
  function HttpResponse$stringBody$delegate$lambda(this$0) {
    return function () {
      return decodeToString(this$0.y4q_1);
    };
  }
  ...
  function HttpResponse(status, headers, body) {
    ...
    this.y4q_1 = body;
    var tmp = this;
    tmp.z4q_1 = lazy(HttpResponse$stringBody$delegate$lambda(this));
  }
  protoOf(HttpResponse).a4r = function () {
    var tmp0 = this.z4q_1;
    var tmp = KProperty1;
  ...
  function applySystemProxy(_this__u8e3s4) {
    ...
    if (!(proxyUrl == null || isBlank(proxyUrl))) {
      _this__u8e3s4.o3k(applySystemProxy$lambda(proxyUrl));
    }
  }
  function applySystemProxy$lambda($proxyUrl) {
    return function ($this$engine) {
      $this$engine.t3p_1 = ProxyBuilder_instance.p4o(Url($proxyUrl));
      return Unit_instance;
    };
  }
