(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    root.khttpclient = factory(typeof khttpclient === 'undefined' ? {} : khttpclient, this['kotlin-kotlin-stdlib'], this['ktor-ktor-io'], this['ktor-ktor-http'], this['ktor-ktor-client-core'], this['ktor-ktor-utils'], this['kotlinx-serialization-kotlinx-serialization-json']);
  }
}(this, function (_, kotlin_kotlin, kotlin_io_ktor_ktor_io, kotlin_io_ktor_ktor_http, kotlin_io_ktor_ktor_client_core, kotlin_io_ktor_ktor_utils, kotlin_org_jetbrains_kotlinx_kotlinx_serialization_json) {
  'use strict';
  ...
  var Image_getInstance = kotlin_io_ktor_ktor_http.$_$.c;
  var Video_getInstance = kotlin_io_ktor_ktor_http.$_$.f;
  ...
  var takeFrom = kotlin_io_ktor_ktor_http.$_$.u1;
  ...
  var formData = kotlin_io_ktor_ktor_client_core.$_$.b;
  var MultiPartFormDataContent = kotlin_io_ktor_ktor_client_core.$_$.a;
  ...
  setMetadataFor(HttpParameter, 'HttpParameter', classMeta);
  setMetadataFor($proceedCOROUTINE$0, '$proceedCOROUTINE$0', classMeta, CoroutineImpl);
  setMetadataFor(HttpRequest, 'HttpRequest', classMeta, VOID, VOID, HttpRequest, VOID, VOID, [0, 1]);
  setMetadataFor($fromCOROUTINE$1, '$fromCOROUTINE$1', classMeta, CoroutineImpl);
  setMetadataFor(Companion_0, 'Companion', objectMeta, VOID, VOID, VOID, VOID, VOID, [1]);
  ...
  function canSendOnly($this, param) {
    ...
    return tmp0_subject.equals(Application_getInstance().get_Json_wo4ci9_k$()) ? true : tmp0_subject.equals(Image_getInstance().get_JPEG_wo3lip_k$()) ? true : tmp0_subject.equals(Image_getInstance().get_PNG_18jmu8_k$()) ? true : tmp0_subject.equals(Image_getInstance().get_GIF_18jtmt_k$()) ? true : false;
  }
  ...
  function HttpRequest$proceed$lambda_0($params, $files) {
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            this.ARGUMENT2__1 = Companion_getInstance_2();
            var tmp_0 = this;
            tmp_0.this3__1 = this.client1__1;
            var tmp_1 = this;
            tmp_1.this4__1 = this.this3__1;
            var tmp_2 = this;
            ...
            if (!(this.req0__1.url_1 == null)) {
              ...
              l$ret$1: do {
               ...
               while (false);
              var tmp_3 = tmp$ret$0;
              takeFrom(this_1.get_url_18iuii_k$(), URLBuilder(tmp_3));
            } else {
              url(this_1, this.req0__1.schema_1, this.req0__1.host_1, this.req0__1.port_1, this.req0__1.path_1);
            }

            headers(this_1, HttpRequest$proceed$lambda(this.req0__1));
            if (this.req0__1.params_1.get_size_woubt6_k$() === 1 ? canSendOnly(this._this__u8e3s4__1, first(this.req0__1.params_1)) : false) {
              ...
              if (body == null) {
                ...
                this_1.set_bodyType_8pgqkl_k$(typeInfoImpl(tmp_4, tmp_5, tmp_6));
              } else {
                if (body instanceof OutgoingContent) {
                  ...
                  var tmp_9 = getKClass(ByteArrayContent);
                  var tmp_10;
                  try {
                    tmp_10 = createKType(getKClass(ByteArrayContent), arrayOf([]), false);
                  } catch ($p) {
                    var tmp_11;
                    if ($p instanceof Error) {
                      var cause_0 = $p;
                  ...
                  this_1.set_bodyType_8pgqkl_k$(typeInfoImpl(tmp_8, tmp_9, tmp_10));
                }
              }
            } else {
              if (this.method_1.equals(Companion_getInstance_0().get_Get_18jsxf_k$())) {
                ...
                if (!params.isEmpty_y1axqb_k$()) {
                  ...
                  tmp_12 = !files.isEmpty_y1axqb_k$();
                }
                if (tmp_12) {
                  contentType(this_1, MultiPart_getInstance().get_FormData_mwpwuh_k$());
                  var body_0 = new MultiPartFormDataContent(formData(HttpRequest$proceed$lambda_0(params, files)));
                  if (body_0 == null) {
                    this_1.set_body_slfhxt_k$(NullBody_getInstance());
                    ...
                    this_1.set_bodyType_8pgqkl_k$(typeInfoImpl(tmp_13, tmp_14, tmp_15));
                  } else {
                    if (body_0 instanceof OutgoingContent) {
                      ...
                      this_1.set_bodyType_8pgqkl_k$(typeInfoImpl(tmp_17, tmp_18, tmp_19));
                    }
                  }
                }
              }
  ...
  protoOf(HttpRequest).query_u1ndh0_k$ = function (key, value) {
    ...
    this.params_1.add_utx5q5_k$(Companion_getInstance_1().query_r463rc_k$(key, toString(value)));
    return this;
  };
  ...
  protoOf(HttpRequest).param_sgc4j3_k$ = function (key, value) {
    ...
    this.params_1.add_utx5q5_k$(Companion_getInstance_1().param_rhfqfh_k$(key, toString(value)));
    return this;
  };
  ...
  protoOf(HttpRequest).file_65915o_k$ = function (key, fileName, fileBody) {
    ...
    this.params_1.add_utx5q5_k$(Companion_getInstance_1().file_65915o_k$(key, fileName, fileBody));
    return this;
  };
  protoOf(HttpRequest).json_tyne5q_k$ = function (json) {
    ...
    this.params_1.add_utx5q5_k$(Companion_getInstance_1().json_tyne5q_k$(json));
    return this;
  };
  ...
  protoOf(HttpRequest).get_r3bkvm_k$ = function ($completion) {
    return proceed(this, Companion_getInstance_0().get_Get_18jsxf_k$(), $completion);
  };
  protoOf(HttpRequest).post_etl1qc_k$ = function ($completion) {
    return proceed(this, Companion_getInstance_0().get_Post_wo83k9_k$(), $completion);
  };
  protoOf(HttpRequest).put_v4p3gr_k$ = function ($completion) {
    return proceed(this, Companion_getInstance_0().get_Put_18jlve_k$(), $completion);
  };
  protoOf(HttpRequest).delete_6n5gk9_k$ = function ($completion) {
    return proceed(this, Companion_getInstance_0().get_Delete_2tr9d8_k$(), $completion);
  };
  protoOf(HttpRequest).patch_hyutss_k$ = function ($completion) {
    return proceed(this, Companion_getInstance_0().get_Patch_if5ddr_k$(), $completion);
  };
