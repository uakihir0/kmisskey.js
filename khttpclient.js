(function (root, factory) {
...
}(globalThis, function (_, kotlin_kotlin, kotlin_io_ktor_ktor_io, kotlin_io_ktor_ktor_http, kotlin_io_ktor_ktor_client_core, kotlin_io_ktor_ktor_utils, kotlin_org_jetbrains_kotlinx_kotlinx_serialization_json) {
  'use strict';
  ...
  function canSendOnly($this, param) {
    if (param.get_type_wovaf7_k$().equals(Type_JSON_getInstance()))
      return true;
    var tmp9_subject = param.fileContentType_sakr3r_k$();
    return tmp9_subject.equals(Application_getInstance().get_Json_wo4ci9_k$()) ? true : tmp9_subject.equals(Image_getInstance().get_JPEG_wo3lip_k$()) ? true : tmp9_subject.equals(Image_getInstance().get_PNG_18jmu8_k$()) ? true : tmp9_subject.equals(Image_getInstance().get_GIF_18jtmt_k$()) ? true : false;
  }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            var tmp5_safe_receiver = this._this__u8e3s4__1.accept_1;
            if (tmp5_safe_receiver == null)
              null;
            else {
              this._this__u8e3s4__1.header_1.put_4fpzoq_k$('Accept', tmp5_safe_receiver);
            }

            var tmp6_safe_receiver = this._this__u8e3s4__1.userAgent_1;
            if (tmp6_safe_receiver == null)
              null;
            else {
              var this_0 = this._this__u8e3s4__1.header_1;
              var key = 'User-Agent';
              this_0.put_4fpzoq_k$(key, tmp6_safe_receiver);
            }
            ...
            if (!this._this__u8e3s4__1.forceMultipart_1 && this.req0__1.params_1.get_size_woubt6_k$() === 1 && canSendOnly(this._this__u8e3s4__1, first(this.req0__1.params_1))) {
              ...
              if (this.method_1.equals(Companion_getInstance_0().get_Get_18jsxf_k$())) {
                ...
                if (tmp_13) {
                  ...
                  var body_0 = new MultiPartFormDataContent(formData(HttpRequest$proceed$lambda_1(params, files)));
                  if (body_0 == null) {
                    this_1.set_body_slfhxt_k$(NullBody_getInstance());
  ...
  protoOf(HttpRequest).set_forceMultipart_6p2wbb_k$ = function (_set____db54di) {
    this.forceMultipart_1 = _set____db54di;
  };
  protoOf(HttpRequest).get_forceMultipart_w1mive_k$ = function () {
    return this.forceMultipart_1;
  };
  ...
  protoOf(HttpRequest).forceMultipart_5yucl8_k$ = function (forceMultipart) {
    ...
    this.forceMultipart_1 = forceMultipart;
    return this;
  };
  ...
  protoOf(HttpRequest).pathValue_hbfy18_k$ = function (key, value) {
    ...
    var tmp = this;
    var tmp3_safe_receiver = this.path_1;
    var tmp_0;
    if (tmp3_safe_receiver == null) {
      ...
      var this_0 = '{' + key + '}';
      tmp_0 = Regex_init_$Create$(this_0).replace_1ix0wf_k$(tmp3_safe_receiver, value);
    }
    tmp.path_1 = tmp_0;
    var tmp_1 = this;
    var tmp4_safe_receiver = this.url_1;
    var tmp_2;
    if (tmp4_safe_receiver == null) {
      ...
      // Inline function 'kotlin.text.toRegex' call
      var this_1 = '{' + key + '}';
      tmp_2 = Regex_init_$Create$(this_1).replace_1ix0wf_k$(tmp4_safe_receiver, value);
    }
    tmp_1.url_1 = tmp_2;
    return this;
  };
