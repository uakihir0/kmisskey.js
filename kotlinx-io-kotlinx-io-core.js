(function (factory) {
  ...
  var toShort = kotlin_kotlin.$_$.dc;
  ...
  protoOf(Buffer).d1b = function (byteCount) {
  ...
  protoOf(Buffer).f1b = function () {
    ...
    var v = segment.o1b();
    this.a1b_1 = subtract(this.a1b_1, new Long(1, 0));
    if (segmentSize === 1) {
      this.n1b();
    }
    return v;
  ...
  protoOf(Buffer).p1b = function () {
    ...
    var segmentSize = segment.e1();
    if (segmentSize < 2) {
      this.d1b(new Long(2, 0));
      if (segmentSize === 0) {
        this.n1b();
        return this.p1b();
      }
      // Inline function 'kotlinx.io.and' call
      var tmp_0 = (this.f1b() & 255) << 8;
      // Inline function 'kotlinx.io.and' call
      var tmp$ret$1 = this.f1b() & 255;
      return toShort(tmp_0 | tmp$ret$1);
    }
    var v = segment.q1b();
    this.a1b_1 = subtract(this.a1b_1, new Long(2, 0));
    if (segmentSize === 2) {
      this.n1b();
    }
    return v;
  ...
  protoOf(Buffer).s1b = function (out, startIndex, endIndex) {
    ...
    out.a1b_1 = add(out.a1b_1, remainingByteCount);
    var s = this.y1a_1;
    while (compare(currentOffset, fromInt(ensureNotNull(s).i1b_1 - s.h1b_1 | 0)) >= 0) {
      currentOffset = subtract(currentOffset, fromInt(s.i1b_1 - s.h1b_1 | 0));
      s = s.l1b_1;
    }
    while (compare(remainingByteCount, new Long(0, 0)) > 0) {
      var copy = ensureNotNull(s).t1b();
      copy.h1b_1 = copy.h1b_1 + convertToInt(currentOffset) | 0;
      var tmp = copy;
      var tmp0 = copy.h1b_1 + convertToInt(remainingByteCount) | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b = copy.i1b_1;
      tmp.i1b_1 = Math.min(tmp0, b);
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (out.y1a_1 == null) {
        out.y1a_1 = copy;
        out.z1a_1 = copy;
      } else if (false) {
        out.z1a_1 = ensureNotNull(out.z1a_1).u1b(copy).v1b();
        if (ensureNotNull(out.z1a_1).m1b_1 == null) {
          out.y1a_1 = out.z1a_1;
        }
      } else {
        out.z1a_1 = ensureNotNull(out.z1a_1).u1b(copy);
      }
      remainingByteCount = subtract(remainingByteCount, fromInt(copy.i1b_1 - copy.h1b_1 | 0));
  ...
  protoOf(Buffer).w1b = function () {
    ...
    if (equalsLong(result, new Long(0, 0)))
      return new Long(0, 0);
    var tail = ensureNotNull(this.z1a_1);
    if (tail.i1b_1 < 8192 && tail.k1b_1) {
      result = subtract(result, fromInt(tail.i1b_1 - tail.h1b_1 | 0));
    }
    return result;
  };
  protoOf(Buffer).x1b = function (position) {
    ...
    if (equalsLong(position, new Long(0, 0))) {
      return ensureNotNull(this.y1a_1).y1b(0);
    }
    $l$block_1: {
      // Inline function 'kotlinx.io.seek' call
      if (this.y1a_1 == null) {
        var offset = new Long(-1, -1);
        return ensureNotNull(null).y1b(convertToInt(subtract(position, offset)));
      }
      if (compare(subtract(this.e1(), position), position) < 0) {
        var s = this.z1a_1;
        var offset_0 = this.e1();
        $l$loop: while (!(s == null) && compare(offset_0, position) > 0) {
          offset_0 = subtract(offset_0, fromInt(s.i1b_1 - s.h1b_1 | 0));
        ...
        return ensureNotNull(tmp0).y1b(convertToInt(subtract(position, offset_1)));
      } else {
        var s_0 = this.y1a_1;
        ...
        $l$loop_0: while (!(s_0 == null)) {
          ...
          var other = s_0.i1b_1 - s_0.h1b_1 | 0;
        ...
        return ensureNotNull(tmp0_1).y1b(convertToInt(subtract(position, offset_3)));
      }
    }
  };
  protoOf(Buffer).y2 = function () {
    return this.z1b(this.e1());
  };
  ...
  protoOf(Buffer).a1c = function (sink, startIndex, endIndex) {
    ...
    this.a1b_1 = subtract(this.a1b_1, fromInt(toCopy));
    if (isEmpty(s)) {
      this.n1b();
    }
    return toCopy;
  ...
  protoOf(Buffer).h1c = function (minimumCapacity) {
    ...
    var t = ensureNotNull(this.z1a_1);
    if ((t.i1b_1 + minimumCapacity | 0) > 8192 || !t.k1b_1) {
      var newTail = t.u1b(SegmentPool_instance.k1c());
      this.z1a_1 = newTail;
      return newTail;
    }
    return t;
  ...
  protoOf(Buffer).l1c = function (source, startIndex, endIndex) {
    ...
    tmp.a1b_1 = add(tmp0_0, fromInt(other));
  };
  protoOf(Buffer).p1c = function (source, byteCount) {
    // Inline function 'kotlinx.io.checkByteCount' call
    // Inline function 'kotlin.require' call
    if (!(compare(byteCount, new Long(0, 0)) >= 0)) {
      var message = 'byteCount (' + byteCount.toString() + ') < 0';
    ...
    var remainingByteCount = byteCount;
    while (compare(remainingByteCount, new Long(0, 0)) > 0) {
      var read = source.c1c(this, remainingByteCount);
  ...
  protoOf(Buffer).d1c = function (source, byteCount) {
    ...
    checkOffsetAndCount(source.a1b_1, new Long(0, 0), byteCount);
    var remainingByteCount = byteCount;
    while (compare(remainingByteCount, new Long(0, 0)) > 0) {
      if (compare(remainingByteCount, fromInt(ensureNotNull(source.y1a_1).e1())) < 0) {
        var tail = this.z1a_1;
        var tmp;
        if (!(tail == null) && tail.k1b_1) {
          var tmp0 = remainingByteCount;
          // Inline function 'kotlin.Long.plus' call
          var other = tail.i1b_1;
          var tmp0_0 = add(tmp0, fromInt(other));
          // Inline function 'kotlin.Long.minus' call
          var other_0 = tail.q1c() ? 0 : tail.h1b_1;
        ...
        if (tmp) {
          ensureNotNull(source.y1a_1).s1c(tail, convertToInt(remainingByteCount));
          source.a1b_1 = subtract(source.a1b_1, remainingByteCount);
          this.a1b_1 = add(this.a1b_1, remainingByteCount);
          return Unit_instance;
        } else {
          source.y1a_1 = ensureNotNull(source.y1a_1).r1c(convertToInt(remainingByteCount));
        }
      }
      var segmentToMove = ensureNotNull(source.y1a_1);
      var movedByteCount = fromInt(segmentToMove.e1());
      source.y1a_1 = segmentToMove.t1c();
      if (source.y1a_1 == null) {
        source.z1a_1 = null;
      }
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (this.y1a_1 == null) {
        this.y1a_1 = segmentToMove;
        this.z1a_1 = segmentToMove;
      } else if (true) {
        this.z1a_1 = ensureNotNull(this.z1a_1).u1b(segmentToMove).v1b();
        if (ensureNotNull(this.z1a_1).m1b_1 == null) {
          this.y1a_1 = this.z1a_1;
        }
      } else {
        this.z1a_1 = ensureNotNull(this.z1a_1).u1b(segmentToMove);
      }
      source.a1b_1 = subtract(source.a1b_1, movedByteCount);
      this.a1b_1 = add(this.a1b_1, movedByteCount);
      remainingByteCount = subtract(remainingByteCount, movedByteCount);
    }
  };
  protoOf(Buffer).u1c = function (source) {
  ...
  protoOf(Buffer).v1c = function (byte) {
    this.h1c(1).w1c(byte);
    this.a1b_1 = add(this.a1b_1, new Long(1, 0));
  };
  protoOf(Buffer).x1c = function (short) {
    this.h1c(2).y1c(short);
    this.a1b_1 = add(this.a1b_1, new Long(2, 0));
  };
  ...
  protoOf(Buffer).toString = function () {
    ...
    while (!(curr == null)) {
      ...
      while (bytesWritten < len && idx < segment.e1()) {
        ...
        var b_0 = tmp0.z1c(segment, _unary__edvuaz);
  ...
  protoOf(Buffer).n1b = function () {
    var oldHead = ensureNotNull(this.y1a_1);
    var nextHead = oldHead.l1b_1;
    this.y1a_1 = nextHead;
    if (nextHead == null) {
      this.z1a_1 = null;
    } else {
  ...
  protoOf(Buffer).b1d = function () {
    var oldTail = ensureNotNull(this.z1a_1);
    var newTail = oldTail.m1b_1;
    this.z1a_1 = newTail;
    if (newTail == null) {
      this.y1a_1 = null;
    } else {
    ...
    $l$block_1: {
      ...
      if (compare(subtract(_this__u8e3s4.e1(), startIndex), startIndex) < 0) {
        ...
        do {
          ...
          segment_0 = segment_0.l1b_1;
        }
         while (!(segment_0 == null) && compare(offset_1, endOffset) < 0);
        return new Long(-1, -1);
      } else {
        var s_0 = _this__u8e3s4.y1a_1;
        var offset_2 = new Long(0, 0);
        $l$loop_0: while (!(s_0 == null)) {
          var tmp0_4 = offset_2;
          // Inline function 'kotlin.Long.plus' call
          var other_1 = s_0.i1b_1 - s_0.h1b_1 | 0;
  ...
  function readByteString(_this__u8e3s4, byteCount) {
    return UnsafeByteStringOperations_instance.x1a(readByteArray_0(_this__u8e3s4, byteCount));
  }
  ...
  function PeekSource(upstream) {
    this.c1d_1 = upstream;
    this.d1d_1 = this.c1d_1.b1b();
    this.e1d_1 = this.d1d_1.y1a_1;
    var tmp = this;
    var tmp0_safe_receiver = this.d1d_1.y1a_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.h1b_1;
    tmp.f1d_1 = tmp1_elvis_lhs == null ? -1 : tmp1_elvis_lhs;
    this.g1d_1 = false;
  ...
  protoOf(PeekSource).c1c = function (sink, byteCount) {
    ...
    // Inline function 'kotlin.check' call
    if (!(this.e1d_1 == null || (this.e1d_1 === this.d1d_1.y1a_1 && this.f1d_1 === ensureNotNull(this.d1d_1.y1a_1).h1b_1))) {
    ...
    if (!this.c1d_1.e1b(tmp$ret$7))
      return new Long(-1, -1);
    if (this.e1d_1 == null && !(this.d1d_1.y1a_1 == null)) {
      this.e1d_1 = this.d1d_1.y1a_1;
      this.f1d_1 = ensureNotNull(this.d1d_1.y1a_1).h1b_1;
    }
    // Inline function 'kotlin.comparisons.minOf' call
    var b = subtract(this.d1d_1.e1(), this.h1d_1);
    var toCopy = compare(byteCount, b) <= 0 ? byteCount : b;
    this.d1d_1.s1b(sink, this.h1d_1, add(this.h1d_1, toCopy));
    this.h1d_1 = add(this.h1d_1, toCopy);
    return toCopy;
  };
  ...
  protoOf(RealSource).c1c = function (sink, byteCount) {
    ...
    if (equalsLong(this.k1d_1.e1(), new Long(0, 0))) {
  ...
  protoOf(RealSource).c1b = function () {
    ...
    return this.k1d_1.c1b() && equalsLong(this.i1d_1.c1c(this.k1d_1, new Long(8192, 0)), new Long(-1, -1));
  };
  protoOf(RealSource).d1b = function (byteCount) {
    if (!this.e1b(byteCount))
  ...
  protoOf(RealSource).e1b = function (byteCount) {
    ...
    while (compare(this.k1d_1.e1(), byteCount) < 0) {
      if (equalsLong(this.i1d_1.c1c(this.k1d_1, new Long(8192, 0)), new Long(-1, -1)))
        return false;
    }
    return true;
  };
  protoOf(RealSource).f1b = function () {
    this.d1b(new Long(1, 0));
    return this.k1d_1.f1b();
  };
  ...
  protoOf(RealSource).e1c = function (sink, byteCount) {
    try {
      ...
      if ($p instanceof EOFException) {
        var e = $p;
        sink.d1c(this.k1d_1, this.k1d_1.e1());
        throw e;
      } else {
        throw $p;
      }
  ...
  protoOf(RealSource).f1c = function (sink) {
    ...
    while (!equalsLong(this.i1d_1.c1c(this.k1d_1, new Long(8192, 0)), new Long(-1, -1))) {
      var emitByteCount = this.k1d_1.w1b();
    ...
    if (compare(this.k1d_1.e1(), new Long(0, 0)) > 0) {
      totalBytesWritten = add(totalBytesWritten, this.k1d_1.e1());
      sink.d1c(this.k1d_1, this.k1d_1.e1());
    }
    return totalBytesWritten;
  };
  protoOf(RealSource).p1b = function () {
    this.d1b(new Long(2, 0));
    return this.k1d_1.p1b();
  };
  ...
  protoOf(Segment).q1c = function () {
    var tmp0_safe_receiver = this.j1b_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.o1d();
    return tmp1_elvis_lhs == null ? false : tmp1_elvis_lhs;
  };
  protoOf(Segment).t1b = function () {
    var tmp0_elvis_lhs = this.j1b_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
    ...
    var tmp_1 = this.i1b_1;
    // Inline function 'kotlin.also' call
    t.q1d();
    return Segment_init_$Create$_0(this.g1b_1, tmp_0, tmp_1, t, false);
  };
  protoOf(Segment).t1c = function () {
    var result = this.l1b_1;
    if (!(this.m1b_1 == null)) {
      ensureNotNull(this.m1b_1).l1b_1 = this.l1b_1;
    }
    if (!(this.l1b_1 == null)) {
      ensureNotNull(this.l1b_1).m1b_1 = this.m1b_1;
    }
    this.l1b_1 = null;
    this.m1b_1 = null;
    return result;
  };
  protoOf(Segment).u1b = function (segment) {
    segment.m1b_1 = this;
    segment.l1b_1 = this.l1b_1;
    if (!(this.l1b_1 == null)) {
      ensureNotNull(this.l1b_1).m1b_1 = segment;
    }
    this.l1b_1 = segment;
    return segment;
  };
  protoOf(Segment).r1c = function (byteCount) {
    // Inline function 'kotlin.require' call
    if (!(byteCount > 0 && byteCount <= (this.i1b_1 - this.h1b_1 | 0))) {
    ...
    if (byteCount >= 1024) {
      ...
      var tmp0 = this.g1b_1;
      var tmp2 = prefix.g1b_1;
      var tmp5 = this.h1b_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = this.h1b_1 + byteCount | 0;
    ...
    prefix.i1b_1 = prefix.h1b_1 + byteCount | 0;
    this.h1b_1 = this.h1b_1 + byteCount | 0;
    if (!(this.m1b_1 == null)) {
      ensureNotNull(this.m1b_1).u1b(prefix);
    } else {
      prefix.l1b_1 = this;
      this.m1b_1 = prefix;
    }
  ...
  protoOf(Segment).v1b = function () {
    ...
    if (!ensureNotNull(this.m1b_1).k1b_1)
      return this;
    var byteCount = this.i1b_1 - this.h1b_1 | 0;
    var availableByteCount = (8192 - ensureNotNull(this.m1b_1).i1b_1 | 0) + (ensureNotNull(this.m1b_1).q1c() ? 0 : ensureNotNull(this.m1b_1).h1b_1) | 0;
    if (byteCount > availableByteCount)
      return this;
    var predecessor = this.m1b_1;
    this.s1c(ensureNotNull(predecessor), byteCount);
    var successor = this.t1c();
    // Inline function 'kotlin.check' call
    if (!(successor == null)) {
      throw IllegalStateException_init_$Create$('Check failed.');
    }
  ...
  protoOf(Segment).w1c = function (byte) {
    var _unary__edvuaz = this.i1b_1;
    this.i1b_1 = _unary__edvuaz + 1 | 0;
    this.g1b_1[_unary__edvuaz] = byte;
  };
  protoOf(Segment).y1c = function (short) {
    var data = this.g1b_1;
    var limit = this.i1b_1;
  ...
  protoOf(Segment).o1b = function () {
    var _unary__edvuaz = this.h1b_1;
    this.h1b_1 = _unary__edvuaz + 1 | 0;
    return this.g1b_1[_unary__edvuaz];
  };
  ...
  protoOf(Segment).s1c = function (sink, byteCount) {
    // Inline function 'kotlin.check' call
    if (!sink.k1b_1) {
      var message = 'only owner can write';
      throw IllegalStateException_init_$Create$(toString(message));
    }
    if ((sink.i1b_1 + byteCount | 0) > 8192) {
      if (sink.q1c())
        throw IllegalArgumentException_init_$Create$_0();
      if (((sink.i1b_1 + byteCount | 0) - sink.h1b_1 | 0) > 8192)
        throw IllegalArgumentException_init_$Create$_0();
      var tmp0 = sink.g1b_1;
      var tmp2 = sink.g1b_1;
      var tmp5 = sink.h1b_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = sink.i1b_1;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      var tmp = tmp0;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      arrayCopy(tmp, tmp2, 0, tmp5, endIndex);
      sink.i1b_1 = sink.i1b_1 - sink.h1b_1 | 0;
      sink.h1b_1 = 0;
    }
    var tmp0_0 = this.g1b_1;
    var tmp2_0 = sink.g1b_1;
    var tmp4 = sink.i1b_1;
    var tmp6 = this.h1b_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex_0 = this.h1b_1 + byteCount | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp_0 = tmp0_0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    sink.i1b_1 = sink.i1b_1 + byteCount | 0;
    this.h1b_1 = this.h1b_1 + byteCount | 0;
  };
  ...
  protoOf(Segment).n1c = function (src, srcStartOffset, srcEndOffset) {
    ...
    this.i1b_1 = this.i1b_1 + (srcEndOffset - srcStartOffset | 0) | 0;
  };
  protoOf(Segment).e1 = function () {
    return this.i1b_1 - this.h1b_1 | 0;
  };
  protoOf(Segment).m1c = function () {
    return this.g1b_1.length - this.i1b_1 | 0;
  };
  protoOf(Segment).r1d = function (readOnly) {
    return this.g1b_1;
  };
  protoOf(Segment).y1b = function (index) {
    return this.g1b_1[this.h1b_1 + index | 0];
  };
  protoOf(Segment).s1d = function (index, value) {
    this.g1b_1[this.i1b_1 + index | 0] = value;
  };
  protoOf(Segment).t1d = function (index, b0, b1) {
    var d = this.g1b_1;
    var l = this.i1b_1;
    d[l + index | 0] = b0;
    d[(l + index | 0) + 1 | 0] = b1;
  };
  protoOf(Segment).u1d = function (index, b0, b1, b2) {
    var d = this.g1b_1;
    var l = this.i1b_1;
    d[l + index | 0] = b0;
    d[(l + index | 0) + 1 | 0] = b1;
  ...
  protoOf(Segment).v1d = function (index, b0, b1, b2, b3) {
    var d = this.g1b_1;
    var l = this.i1b_1;
    d[l + index | 0] = b0;
    d[(l + index | 0) + 1 | 0] = b1;
  ...
  function indexOf_0(_this__u8e3s4, byte, startOffset, endOffset) {
    ...
    var p = _this__u8e3s4.h1b_1;
    var data = _this__u8e3s4.r1d(true);
  ...
  function indexOf_1(_this__u8e3s4, byte, startIndex, endIndex) {
    ...
    $l$loop: while (true) {
      ...
      if (compare(offset, endIndex) < 0) {
        ...
        tmp_0 = _this__u8e3s4.e1b(tmp$ret$2);
      } else {
        tmp_0 = false;
      }
      if (!tmp_0) {
  ...
  function readByteArrayImpl(_this__u8e3s4, size) {
    ...
    if (size === -1) {
      ...
      while (compare(_this__u8e3s4.b1b().e1(), new Long(2147483647, 0)) < 0 && _this__u8e3s4.e1b(fetchSize)) {
        // Inline function 'kotlin.Long.times' call
        var this_0 = fetchSize;
        fetchSize = multiply(this_0, fromInt(2));
      }
      // Inline function 'kotlin.check' call
      if (!(compare(_this__u8e3s4.b1b().e1(), new Long(2147483647, 0)) < 0)) {
        var message = "Can't create an array of size " + _this__u8e3s4.b1b().e1().toString();
        throw IllegalStateException_init_$Create$(toString(message));
      }
      arraySize = convertToInt(_this__u8e3s4.b1b().e1());
    } else {
      _this__u8e3s4.d1b(fromInt(size));
    }
    var array = new Int8Array(arraySize);
    readTo(_this__u8e3s4.b1b(), array);
    return array;
  }
  ...
  function readString(_this__u8e3s4, byteCount) {
    _this__u8e3s4.d1b(byteCount);
    return commonReadUtf8(_this__u8e3s4.b1b(), byteCount);
  }
  function readString_0(_this__u8e3s4) {
    _this__u8e3s4.e1b(new Long(-1, 2147483647));
    return commonReadUtf8(_this__u8e3s4.b1b(), _this__u8e3s4.b1b().e1());
  }
    ...
    while (i < endIndex) {
      ...
      if (c < 128) {
        $l$block_0: {
          ...
          ctx.z1d(tail, segmentOffset + _unary__edvuaz | 0, toByte(c));
          $l$loop: while (i < runLimit) {
            ...
            ctx.z1d(tail, segmentOffset + _unary__edvuaz_0 | 0, toByte(c));
          }
          var bytesWritten = i + segmentOffset | 0;
          if (bytesWritten === 1) {
            tail.i1b_1 = tail.i1b_1 + bytesWritten | 0;
            var tmp = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_3 = this_0.a1b_1;
            tmp.a1b_1 = add(this_3, fromInt(bytesWritten));
            break $l$block_0;
          }
          // Inline function 'kotlin.check' call
          ...
          if (!(bytesWritten === 0)) {
            ...
            var tmp_0 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_4 = this_0.a1b_1;
            tmp_0.a1b_1 = add(this_4, fromInt(bytesWritten));
            break $l$block_0;
          }
          if (isEmpty(tail)) {
            this_0.b1d();
        ...
        $l$block_2: {
          ...
          get_SegmentWriteContextImpl().y1d(tail_0, 0, toByte(c >> 6 | 192), toByte(c & 63 | 128));
          var bytesWritten_0 = 2;
          if (bytesWritten_0 === 2) {
            tail_0.i1b_1 = tail_0.i1b_1 + bytesWritten_0 | 0;
            var tmp_1 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_5 = this_0.a1b_1;
            tmp_1.a1b_1 = add(this_5, fromInt(bytesWritten_0));
            break $l$block_2;
          }
          // Inline function 'kotlin.check' call
          ...
          if (!(bytesWritten_0 === 0)) {
            ...
            var tmp_2 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_6 = this_0.a1b_1;
            tmp_2.a1b_1 = add(this_6, fromInt(bytesWritten_0));
            break $l$block_2;
          }
          if (isEmpty(tail_0)) {
            this_0.b1d();
        ...
        $l$block_4: {
          ...
          get_SegmentWriteContextImpl().x1d(tail_1, 0, toByte(c >> 12 | 224), toByte(c >> 6 & 63 | 128), toByte(c & 63 | 128));
          var bytesWritten_1 = 3;
          if (bytesWritten_1 === 3) {
            tail_1.i1b_1 = tail_1.i1b_1 + bytesWritten_1 | 0;
            var tmp_3 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_7 = this_0.a1b_1;
            tmp_3.a1b_1 = add(this_7, fromInt(bytesWritten_1));
            break $l$block_4;
          }
          // Inline function 'kotlin.check' call
          ...
          if (!(bytesWritten_1 === 0)) {
            ...
            var tmp_4 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_8 = this_0.a1b_1;
            tmp_4.a1b_1 = add(this_8, fromInt(bytesWritten_1));
            break $l$block_4;
          }
          if (isEmpty(tail_1)) {
            this_0.b1d();
        ...
        if (c > 56319 || !(56320 <= low ? low <= 57343 : false)) {
          ...
          $l$block_6: {
            ...
            get_SegmentWriteContextImpl().w1d(tail_2, 0, toByte(codePoint >> 18 | 240), toByte(codePoint >> 12 & 63 | 128), toByte(codePoint >> 6 & 63 | 128), toByte(codePoint & 63 | 128));
            var bytesWritten_2 = 4;
            if (bytesWritten_2 === 4) {
              tail_2.i1b_1 = tail_2.i1b_1 + bytesWritten_2 | 0;
              var tmp_6 = this_0;
              // Inline function 'kotlin.Long.plus' call
              var this_11 = this_0.a1b_1;
              tmp_6.a1b_1 = add(this_11, fromInt(bytesWritten_2));
              break $l$block_6;
            }
            // Inline function 'kotlin.check' call
            ...
            if (!(bytesWritten_2 === 0)) {
              ...
              var tmp_7 = this_0;
              // Inline function 'kotlin.Long.plus' call
              var this_12 = this_0.a1b_1;
              tmp_7.a1b_1 = add(this_12, fromInt(bytesWritten_2));
              break $l$block_6;
            }
            if (isEmpty(tail_2)) {
              this_0.b1d();
  ...
  function commonReadUtf8(_this__u8e3s4, byteCount) {
    if (equalsLong(byteCount, new Long(0, 0)))
      return '';
    // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.forEachSegment' call
    var curr = _this__u8e3s4.y1a_1;
    while (!(curr == null)) {
      get_SegmentReadContextImpl();
      if (compare(fromInt(curr.e1()), byteCount) >= 0) {
        var result = '';
        // Inline function 'kotlinx.io.unsafe.withData' call
        var tmp0 = curr.r1d(true);
        var tmp2 = curr.h1b_1;
        var tmp0_0 = curr.i1b_1;
  ...
  protoOf(SegmentReadContextImpl$1).z1c = function (segment, offset) {
    return segment.y1b(offset);
  };
  function SegmentWriteContextImpl$1() {
  }
  protoOf(SegmentWriteContextImpl$1).z1d = function (segment, offset, value) {
    segment.s1d(offset, value);
  };
  protoOf(SegmentWriteContextImpl$1).y1d = function (segment, offset, b0, b1) {
    segment.t1d(offset, b0, b1);
  };
  protoOf(SegmentWriteContextImpl$1).x1d = function (segment, offset, b0, b1, b2) {
    segment.u1d(offset, b0, b1, b2);
  };
  protoOf(SegmentWriteContextImpl$1).w1d = function (segment, offset, b0, b1, b2, b3) {
    segment.v1d(offset, b0, b1, b2, b3);
  };
