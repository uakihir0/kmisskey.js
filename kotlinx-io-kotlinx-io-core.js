(function (factory) {
  ...
  var Exception_init_$Init$_0 = kotlin_kotlin.$_$.g2;
  var Exception_init_$Init$_1 = kotlin_kotlin.$_$.i2;
  ...
  function write$default(source, startIndex, endIndex, $super) {
    ...
    var tmp;
    if ($super === VOID) {
      this.h1c(source, startIndex, endIndex);
      tmp = Unit_instance;
    } else {
      tmp = $super.h1c.call(this, source, startIndex, endIndex);
    }
    return tmp;
  }
  ...
  protoOf(Buffer).z1a = function (byteCount) {
  ...
  protoOf(Buffer).a1b = function (byteCount) {
    // Inline function 'kotlin.require' call
    if (!(compare(byteCount, new Long(0, 0)) >= 0)) {
  ...
  protoOf(Buffer).b1b = function () {
    var tmp0_elvis_lhs = this.u1a_1;
    var tmp;
    ...
    var v = segment.k1b();
    this.w1a_1 = subtract(this.w1a_1, new Long(1, 0));
    if (segmentSize === 1) {
      this.j1b();
    }
    return v;
  };
  protoOf(Buffer).l1b = function () {
    var tmp0_elvis_lhs = this.u1a_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
    ...
    var segmentSize = segment.e1();
    if (segmentSize < 2) {
      this.z1a(new Long(2, 0));
      if (segmentSize === 0) {
        this.j1b();
        return this.l1b();
      }
      // Inline function 'kotlinx.io.and' call
      var tmp_0 = (this.b1b() & 255) << 8;
      // Inline function 'kotlinx.io.and' call
      var tmp$ret$1 = this.b1b() & 255;
      return toShort(tmp_0 | tmp$ret$1);
    }
    var v = segment.m1b();
    this.w1a_1 = subtract(this.w1a_1, new Long(2, 0));
    if (segmentSize === 2) {
      this.j1b();
    }
    return v;
  };
  protoOf(Buffer).n1b = function () {
    return Unit_instance;
  };
  protoOf(Buffer).o1b = function (out, startIndex, endIndex) {
    ...
    out.w1a_1 = add(out.w1a_1, remainingByteCount);
    var s = this.u1a_1;
    while (compare(currentOffset, fromInt(ensureNotNull(s).e1b_1 - s.d1b_1 | 0)) >= 0) {
      currentOffset = subtract(currentOffset, fromInt(s.e1b_1 - s.d1b_1 | 0));
      s = s.h1b_1;
    }
    while (compare(remainingByteCount, new Long(0, 0)) > 0) {
      var copy = ensureNotNull(s).p1b();
      copy.d1b_1 = copy.d1b_1 + convertToInt(currentOffset) | 0;
      var tmp = copy;
      var tmp0 = copy.d1b_1 + convertToInt(remainingByteCount) | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b = copy.e1b_1;
      tmp.e1b_1 = Math.min(tmp0, b);
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (out.u1a_1 == null) {
        out.u1a_1 = copy;
        out.v1a_1 = copy;
      } else if (false) {
        out.v1a_1 = ensureNotNull(out.v1a_1).q1b(copy).r1b();
        if (ensureNotNull(out.v1a_1).i1b_1 == null) {
          out.u1a_1 = out.v1a_1;
        }
      } else {
        out.v1a_1 = ensureNotNull(out.v1a_1).q1b(copy);
      }
      remainingByteCount = subtract(remainingByteCount, fromInt(copy.e1b_1 - copy.d1b_1 | 0));
  ...
  protoOf(Buffer).s1b = function () {
    ...
    if (equalsLong(result, new Long(0, 0)))
      return new Long(0, 0);
    var tail = ensureNotNull(this.v1a_1);
    if (tail.e1b_1 < 8192 && tail.g1b_1) {
      result = subtract(result, fromInt(tail.e1b_1 - tail.d1b_1 | 0));
    }
    return result;
  };
  protoOf(Buffer).t1b = function (position) {
    ...
    if (equalsLong(position, new Long(0, 0))) {
      return ensureNotNull(this.u1a_1).u1b(0);
    }
    $l$block_1: {
      // Inline function 'kotlinx.io.seek' call
      if (this.u1a_1 == null) {
        var offset = new Long(-1, -1);
        return ensureNotNull(null).u1b(convertToInt(subtract(position, offset)));
      }
      if (compare(subtract(this.e1(), position), position) < 0) {
        var s = this.v1a_1;
        var offset_0 = this.e1();
        $l$loop: while (!(s == null) && compare(offset_0, position) > 0) {
          offset_0 = subtract(offset_0, fromInt(s.e1b_1 - s.d1b_1 | 0));
        ...
        return ensureNotNull(tmp0).u1b(convertToInt(subtract(position, offset_1)));
      } else {
        var s_0 = this.u1a_1;
        ...
        $l$loop_0: while (!(s_0 == null)) {
          ...
          var other = s_0.e1b_1 - s_0.d1b_1 | 0;
        ...
        return ensureNotNull(tmp0_1).u1b(convertToInt(subtract(position, offset_3)));
      }
    }
  };
  protoOf(Buffer).y2 = function () {
    return this.v1b(this.e1());
  };
  protoOf(Buffer).v1b = function (byteCount) {
    ...
    while (compare(remainingByteCount, new Long(0, 0)) > 0) {
      ...
      var b = head.e1b_1 - head.d1b_1 | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b_0 = fromInt(b);
      var tmp$ret$3 = compare(tmp0, b_0) <= 0 ? tmp0 : b_0;
      var toSkip = convertToInt(tmp$ret$3);
      this.w1a_1 = subtract(this.w1a_1, fromInt(toSkip));
      remainingByteCount = subtract(remainingByteCount, fromInt(toSkip));
      head.d1b_1 = head.d1b_1 + toSkip | 0;
      if (head.d1b_1 === head.e1b_1) {
        this.j1b();
      }
    }
  };
  protoOf(Buffer).w1b = function (sink, startIndex, endIndex) {
    ...
    s.x1b(sink, startIndex, startIndex + toCopy | 0);
    this.w1a_1 = subtract(this.w1a_1, fromInt(toCopy));
    if (isEmpty(s)) {
      this.j1b();
    }
    return toCopy;
  };
  protoOf(Buffer).y1b = function (sink, byteCount) {
    // Inline function 'kotlinx.io.checkByteCount' call
    // Inline function 'kotlin.require' call
    if (!(compare(byteCount, new Long(0, 0)) >= 0)) {
      var message = 'byteCount (' + byteCount.toString() + ') < 0';
    ...
    sink.z1b(this, bytesWritten);
    return bytesWritten;
  };
  protoOf(Buffer).a1c = function (sink, byteCount) {
    // Inline function 'kotlinx.io.checkByteCount' call
    // Inline function 'kotlin.require' call
    if (!(compare(byteCount, new Long(0, 0)) >= 0)) {
      var message = 'byteCount (' + byteCount.toString() + ') < 0';
    ...
    sink.z1b(this, byteCount);
  };
  protoOf(Buffer).b1c = function (sink) {
  ...
  protoOf(Buffer).c1c = function () {
    return buffered(new PeekSource(this));
  };
  protoOf(Buffer).d1c = function (minimumCapacity) {
    // Inline function 'kotlin.require' call
    ...
    if (this.v1a_1 == null) {
      var result = SegmentPool_instance.g1c();
      this.u1a_1 = result;
      this.v1a_1 = result;
      return result;
    }
    var t = ensureNotNull(this.v1a_1);
    if ((t.e1b_1 + minimumCapacity | 0) > 8192 || !t.g1b_1) {
      var newTail = t.q1b(SegmentPool_instance.g1c());
      this.v1a_1 = newTail;
      return newTail;
    }
    return t;
  };
  protoOf(Buffer).h1c = function (source, startIndex, endIndex) {
    // Inline function 'kotlinx.io.checkBounds' call
    ...
    while (currentOffset < endIndex) {
      ...
      var b = tail.i1c();
      var toCopy = Math.min(tmp0, b);
      tail.j1c(source, currentOffset, currentOffset + toCopy | 0);
      currentOffset = currentOffset + toCopy | 0;
    }
    var tmp = this;
    var tmp0_0 = this.w1a_1;
    // Inline function 'kotlin.Long.plus' call
    var other = endIndex - startIndex | 0;
    tmp.w1a_1 = add(tmp0_0, fromInt(other));
  };
  protoOf(Buffer).l1c = function (source, byteCount) {
    // Inline function 'kotlinx.io.checkByteCount' call
    // Inline function 'kotlin.require' call
    if (!(compare(byteCount, new Long(0, 0)) >= 0)) {
      var message = 'byteCount (' + byteCount.toString() + ') < 0';
    ...
    var remainingByteCount = byteCount;
    while (compare(remainingByteCount, new Long(0, 0)) > 0) {
      var read = source.y1b(this, remainingByteCount);
  ...
  protoOf(Buffer).z1b = function (source, byteCount) {
    // Inline function 'kotlin.require' call
    if (!!(source === this)) {
      var message = 'source == this';
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
    checkOffsetAndCount(source.w1a_1, new Long(0, 0), byteCount);
    var remainingByteCount = byteCount;
    while (compare(remainingByteCount, new Long(0, 0)) > 0) {
      if (compare(remainingByteCount, fromInt(ensureNotNull(source.u1a_1).e1())) < 0) {
        var tail = this.v1a_1;
        var tmp;
        if (!(tail == null) && tail.g1b_1) {
          var tmp0 = remainingByteCount;
          // Inline function 'kotlin.Long.plus' call
          var other = tail.e1b_1;
          var tmp0_0 = add(tmp0, fromInt(other));
          // Inline function 'kotlin.Long.minus' call
          var other_0 = tail.m1c() ? 0 : tail.d1b_1;
        ...
        if (tmp) {
          ensureNotNull(source.u1a_1).o1c(tail, convertToInt(remainingByteCount));
          source.w1a_1 = subtract(source.w1a_1, remainingByteCount);
          this.w1a_1 = add(this.w1a_1, remainingByteCount);
          return Unit_instance;
        } else {
          source.u1a_1 = ensureNotNull(source.u1a_1).n1c(convertToInt(remainingByteCount));
        }
      }
      var segmentToMove = ensureNotNull(source.u1a_1);
      var movedByteCount = fromInt(segmentToMove.e1());
      source.u1a_1 = segmentToMove.p1c();
      if (source.u1a_1 == null) {
        source.v1a_1 = null;
      }
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (this.u1a_1 == null) {
        this.u1a_1 = segmentToMove;
        this.v1a_1 = segmentToMove;
      } else if (true) {
        this.v1a_1 = ensureNotNull(this.v1a_1).q1b(segmentToMove).r1b();
        if (ensureNotNull(this.v1a_1).i1b_1 == null) {
          this.u1a_1 = this.v1a_1;
        }
      } else {
        this.v1a_1 = ensureNotNull(this.v1a_1).q1b(segmentToMove);
      }
      source.w1a_1 = subtract(source.w1a_1, movedByteCount);
      this.w1a_1 = add(this.w1a_1, movedByteCount);
      remainingByteCount = subtract(remainingByteCount, movedByteCount);
    }
  };
  protoOf(Buffer).q1c = function (source) {
    var totalBytesRead = new Long(0, 0);
    $l$loop: while (true) {
      var readCount = source.y1b(this, new Long(8192, 0));
  ...
  protoOf(Buffer).r1c = function (byte) {
    this.d1c(1).s1c(byte);
    this.w1a_1 = add(this.w1a_1, new Long(1, 0));
  };
  protoOf(Buffer).t1c = function (short) {
    this.d1c(2).u1c(short);
    this.w1a_1 = add(this.w1a_1, new Long(2, 0));
  };
  ...
  protoOf(Buffer).toString = function () {
    ...
    while (!(curr == null)) {
      ...
      while (bytesWritten < len && idx < segment.e1()) {
        ...
        var b_0 = tmp0.v1c(segment, _unary__edvuaz);
  ...
  protoOf(Buffer).j1b = function () {
    var oldHead = ensureNotNull(this.u1a_1);
    var nextHead = oldHead.h1b_1;
    this.u1a_1 = nextHead;
    if (nextHead == null) {
      this.v1a_1 = null;
    } else {
    ...
    oldHead.h1b_1 = null;
    SegmentPool_instance.w1c(oldHead);
  };
  protoOf(Buffer).x1c = function () {
    var oldTail = ensureNotNull(this.v1a_1);
    var newTail = oldTail.i1b_1;
    this.v1a_1 = newTail;
    if (newTail == null) {
      this.u1a_1 = null;
    } else {
    ...
    oldTail.i1b_1 = null;
    SegmentPool_instance.w1c(oldTail);
  };
    ...
    $l$block_1: {
      ...
      if (compare(subtract(_this__u8e3s4.e1(), startIndex), startIndex) < 0) {
        ...
        do {
          ...
          segment_0 = segment_0.h1b_1;
        }
         while (!(segment_0 == null) && compare(offset_1, endOffset) < 0);
        return new Long(-1, -1);
      } else {
        var s_0 = _this__u8e3s4.u1a_1;
        var offset_2 = new Long(0, 0);
        $l$loop_0: while (!(s_0 == null)) {
          var tmp0_4 = offset_2;
          // Inline function 'kotlin.Long.plus' call
          var other_1 = s_0.e1b_1 - s_0.d1b_1 | 0;
  ...
  function readByteString(_this__u8e3s4, byteCount) {
    return UnsafeByteStringOperations_instance.t1a(readByteArray_0(_this__u8e3s4, byteCount));
  }
  ...
  function PeekSource(upstream) {
    this.y1c_1 = upstream;
    this.z1c_1 = this.y1c_1.x1a();
    this.a1d_1 = this.z1c_1.u1a_1;
    var tmp = this;
    var tmp0_safe_receiver = this.z1c_1.u1a_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.d1b_1;
    tmp.b1d_1 = tmp1_elvis_lhs == null ? -1 : tmp1_elvis_lhs;
    this.c1d_1 = false;
    this.d1d_1 = new Long(0, 0);
  }
  protoOf(PeekSource).y1b = function (sink, byteCount) {
    // Inline function 'kotlin.check' call
    if (!!this.c1d_1) {
    ...
    // Inline function 'kotlin.check' call
    if (!(this.a1d_1 == null || (this.a1d_1 === this.z1c_1.u1a_1 && this.b1d_1 === ensureNotNull(this.z1c_1.u1a_1).d1b_1))) {
    ...
    if (!this.y1c_1.a1b(tmp$ret$7))
      return new Long(-1, -1);
    if (this.a1d_1 == null && !(this.z1c_1.u1a_1 == null)) {
      this.a1d_1 = this.z1c_1.u1a_1;
      this.b1d_1 = ensureNotNull(this.z1c_1.u1a_1).d1b_1;
    }
    // Inline function 'kotlin.comparisons.minOf' call
    var b = subtract(this.z1c_1.e1(), this.d1d_1);
    var toCopy = compare(byteCount, b) <= 0 ? byteCount : b;
    this.z1c_1.o1b(sink, this.d1d_1, add(this.d1d_1, toCopy));
    this.d1d_1 = add(this.d1d_1, toCopy);
    return toCopy;
  };
  ...
  function RealSource(source) {
    this.e1d_1 = source;
    this.f1d_1 = false;
    this.g1d_1 = new Buffer();
  }
  protoOf(RealSource).x1a = function () {
    return this.g1d_1;
  };
  protoOf(RealSource).y1b = function (sink, byteCount) {
    ...
    if (equalsLong(this.g1d_1.e1(), new Long(0, 0))) {
      var read = this.e1d_1.y1b(this.g1d_1, new Long(8192, 0));
      if (equalsLong(read, new Long(-1, -1)))
        return new Long(-1, -1);
    }
    // Inline function 'kotlin.comparisons.minOf' call
    ...
    return this.g1d_1.y1b(sink, toRead);
  };
  protoOf(RealSource).y1a = function () {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    if (!!this.f1d_1) {
      var message = 'Source is closed.';
    ...
    return this.g1d_1.y1a() && equalsLong(this.e1d_1.y1b(this.g1d_1, new Long(8192, 0)), new Long(-1, -1));
  };
  protoOf(RealSource).z1a = function (byteCount) {
    if (!this.a1b(byteCount))
      throw EOFException_init_$Create$_0("Source doesn't contain required number of bytes (" + byteCount.toString() + ').');
  };
  protoOf(RealSource).a1b = function (byteCount) {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    if (!!this.f1d_1) {
      var message = 'Source is closed.';
    ...
    while (compare(this.g1d_1.e1(), byteCount) < 0) {
      if (equalsLong(this.e1d_1.y1b(this.g1d_1, new Long(8192, 0)), new Long(-1, -1)))
        return false;
    }
    return true;
  };
  protoOf(RealSource).b1b = function () {
    this.z1a(new Long(1, 0));
    return this.g1d_1.b1b();
  };
  protoOf(RealSource).w1b = function (sink, startIndex, endIndex) {
    // Inline function 'kotlinx.io.checkBounds' call
    var size = sink.length;
    checkBounds(fromInt(size), fromInt(startIndex), fromInt(endIndex));
    if (equalsLong(this.g1d_1.e1(), new Long(0, 0))) {
    ...
    return this.g1d_1.w1b(sink, startIndex, startIndex + toRead | 0);
  };
  protoOf(RealSource).a1c = function (sink, byteCount) {
    try {
      this.z1a(byteCount);
    } catch ($p) {
      if ($p instanceof EOFException) {
        var e = $p;
        sink.z1b(this.g1d_1, this.g1d_1.e1());
        throw e;
      } else {
        throw $p;
      }
    }
    this.g1d_1.a1c(sink, byteCount);
  };
  protoOf(RealSource).b1c = function (sink) {
    var totalBytesWritten = new Long(0, 0);
    while (!equalsLong(this.e1d_1.y1b(this.g1d_1, new Long(8192, 0)), new Long(-1, -1))) {
      var emitByteCount = this.g1d_1.s1b();
      if (compare(emitByteCount, new Long(0, 0)) > 0) {
        totalBytesWritten = add(totalBytesWritten, emitByteCount);
        sink.z1b(this.g1d_1, emitByteCount);
      }
    }
    if (compare(this.g1d_1.e1(), new Long(0, 0)) > 0) {
      totalBytesWritten = add(totalBytesWritten, this.g1d_1.e1());
      sink.z1b(this.g1d_1, this.g1d_1.e1());
    }
    return totalBytesWritten;
  };
  protoOf(RealSource).l1b = function () {
    this.z1a(new Long(2, 0));
    return this.g1d_1.l1b();
  };
  protoOf(RealSource).c1c = function () {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    if (!!this.f1d_1) {
      var message = 'Source is closed.';
  ...
  protoOf(RealSource).toString = function () {
    return 'buffered(' + toString(this.e1d_1) + ')';
  };
  function Segment_init_$Init$($this) {
    Segment.call($this);
    $this.c1b_1 = new Int8Array(8192);
    $this.g1b_1 = true;
    $this.f1b_1 = null;
    return $this;
  }
  ...
  protoOf(Companion).j1d = function () {
  ...
  protoOf(Segment).p1b = function () {
    ...
    var t = tmp;
    var tmp_0 = this.d1b_1;
    var tmp_1 = this.e1b_1;
    // Inline function 'kotlin.also' call
    t.m1d();
    return Segment_init_$Create$_0(this.c1b_1, tmp_0, tmp_1, t, false);
  };
  protoOf(Segment).p1c = function () {
    var result = this.h1b_1;
    if (!(this.i1b_1 == null)) {
      ensureNotNull(this.i1b_1).h1b_1 = this.h1b_1;
    }
    if (!(this.h1b_1 == null)) {
      ensureNotNull(this.h1b_1).i1b_1 = this.i1b_1;
    }
    this.h1b_1 = null;
    this.i1b_1 = null;
    return result;
  };
  protoOf(Segment).q1b = function (segment) {
    segment.i1b_1 = this;
    segment.h1b_1 = this.h1b_1;
    if (!(this.h1b_1 == null)) {
      ensureNotNull(this.h1b_1).i1b_1 = segment;
    }
    this.h1b_1 = segment;
    return segment;
  };
  protoOf(Segment).n1c = function (byteCount) {
    // Inline function 'kotlin.require' call
    if (!(byteCount > 0 && byteCount <= (this.e1b_1 - this.d1b_1 | 0))) {
    ...
    if (byteCount >= 1024) {
      ...
      prefix = SegmentPool_instance.g1c();
      var tmp0 = this.c1b_1;
      var tmp2 = prefix.c1b_1;
      var tmp5 = this.d1b_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = this.d1b_1 + byteCount | 0;
    ...
    prefix.e1b_1 = prefix.d1b_1 + byteCount | 0;
    this.d1b_1 = this.d1b_1 + byteCount | 0;
    if (!(this.i1b_1 == null)) {
      ensureNotNull(this.i1b_1).q1b(prefix);
    } else {
      prefix.h1b_1 = this;
      this.i1b_1 = prefix;
    }
  ...
  protoOf(Segment).r1b = function () {
    // Inline function 'kotlin.check' call
    if (!!(this.i1b_1 == null)) {
      var message = 'cannot compact';
      throw IllegalStateException_init_$Create$(toString(message));
    }
    if (!ensureNotNull(this.i1b_1).g1b_1)
      return this;
    var byteCount = this.e1b_1 - this.d1b_1 | 0;
    var availableByteCount = (8192 - ensureNotNull(this.i1b_1).e1b_1 | 0) + (ensureNotNull(this.i1b_1).m1c() ? 0 : ensureNotNull(this.i1b_1).d1b_1) | 0;
    if (byteCount > availableByteCount)
      return this;
    var predecessor = this.i1b_1;
    this.o1c(ensureNotNull(predecessor), byteCount);
    var successor = this.p1c();
    // Inline function 'kotlin.check' call
    if (!(successor == null)) {
      throw IllegalStateException_init_$Create$('Check failed.');
    }
    SegmentPool_instance.w1c(this);
    return predecessor;
  };
  protoOf(Segment).s1c = function (byte) {
    var _unary__edvuaz = this.e1b_1;
    this.e1b_1 = _unary__edvuaz + 1 | 0;
    this.c1b_1[_unary__edvuaz] = byte;
  };
  protoOf(Segment).u1c = function (short) {
    var data = this.c1b_1;
  ...
  protoOf(Segment).k1b = function () {
    var _unary__edvuaz = this.d1b_1;
    this.d1b_1 = _unary__edvuaz + 1 | 0;
    return this.c1b_1[_unary__edvuaz];
  };
  ...
  protoOf(Segment).o1c = function (sink, byteCount) {
    // Inline function 'kotlin.check' call
    if (!sink.g1b_1) {
      var message = 'only owner can write';
      throw IllegalStateException_init_$Create$(toString(message));
    }
    if ((sink.e1b_1 + byteCount | 0) > 8192) {
      if (sink.m1c())
        throw IllegalArgumentException_init_$Create$_0();
      if (((sink.e1b_1 + byteCount | 0) - sink.d1b_1 | 0) > 8192)
        throw IllegalArgumentException_init_$Create$_0();
      var tmp0 = sink.c1b_1;
      var tmp2 = sink.c1b_1;
      var tmp5 = sink.d1b_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = sink.e1b_1;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      var tmp = tmp0;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      arrayCopy(tmp, tmp2, 0, tmp5, endIndex);
      sink.e1b_1 = sink.e1b_1 - sink.d1b_1 | 0;
      sink.d1b_1 = 0;
    }
    var tmp0_0 = this.c1b_1;
    var tmp2_0 = sink.c1b_1;
    var tmp4 = sink.e1b_1;
    var tmp6 = this.d1b_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex_0 = this.d1b_1 + byteCount | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp_0 = tmp0_0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    sink.e1b_1 = sink.e1b_1 + byteCount | 0;
    this.d1b_1 = this.d1b_1 + byteCount | 0;
  };
  protoOf(Segment).x1b = function (dst, dstStartOffset, dstEndOffset) {
    var len = dstEndOffset - dstStartOffset | 0;
    var tmp0 = this.c1b_1;
    var tmp6 = this.d1b_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex = this.d1b_1 + len | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = tmp0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    this.d1b_1 = this.d1b_1 + len | 0;
  };
  protoOf(Segment).j1c = function (src, srcStartOffset, srcEndOffset) {
    var tmp2 = this.c1b_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destinationOffset = this.e1b_1;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = src;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    this.e1b_1 = this.e1b_1 + (srcEndOffset - srcStartOffset | 0) | 0;
  };
  protoOf(Segment).e1 = function () {
    return this.e1b_1 - this.d1b_1 | 0;
  };
  protoOf(Segment).i1c = function () {
    return this.c1b_1.length - this.e1b_1 | 0;
  };
  protoOf(Segment).n1d = function (readOnly) {
    return this.c1b_1;
  };
  protoOf(Segment).u1b = function (index) {
    return this.c1b_1[this.d1b_1 + index | 0];
  };
  protoOf(Segment).o1d = function (index, value) {
    this.c1b_1[this.e1b_1 + index | 0] = value;
  };
  protoOf(Segment).p1d = function (index, b0, b1) {
    var d = this.c1b_1;
    var l = this.e1b_1;
    d[l + index | 0] = b0;
    d[(l + index | 0) + 1 | 0] = b1;
  };
  protoOf(Segment).q1d = function (index, b0, b1, b2) {
    var d = this.c1b_1;
    var l = this.e1b_1;
    d[l + index | 0] = b0;
    d[(l + index | 0) + 1 | 0] = b1;
  ...
  protoOf(Segment).r1d = function (index, b0, b1, b2, b3) {
    var d = this.c1b_1;
    var l = this.e1b_1;
    d[l + index | 0] = b0;
    d[(l + index | 0) + 1 | 0] = b1;
  ...
  protoOf(AlwaysSharedCopyTracker).k1d = function () {
    return true;
  };
  protoOf(AlwaysSharedCopyTracker).m1d = function () {
    return Unit_instance;
  };
  ...
  function indexOf_0(_this__u8e3s4, byte, startOffset, endOffset) {
    ...
    var p = _this__u8e3s4.d1b_1;
    var data = _this__u8e3s4.n1d(true);
  ...
  function indexOf_1(_this__u8e3s4, byte, startIndex, endIndex) {
    ...
    $l$loop: while (true) {
      ...
      if (compare(offset, endIndex) < 0) {
        ...
        tmp_0 = _this__u8e3s4.a1b(tmp$ret$2);
      } else {
        tmp_0 = false;
      }
      if (!tmp_0) {
  ...
  function readByteArrayImpl(_this__u8e3s4, size) {
    ...
    if (size === -1) {
      ...
      while (compare(_this__u8e3s4.x1a().e1(), new Long(2147483647, 0)) < 0 && _this__u8e3s4.a1b(fetchSize)) {
        // Inline function 'kotlin.Long.times' call
        var this_0 = fetchSize;
        fetchSize = multiply(this_0, fromInt(2));
      }
      // Inline function 'kotlin.check' call
      if (!(compare(_this__u8e3s4.x1a().e1(), new Long(2147483647, 0)) < 0)) {
        var message = "Can't create an array of size " + _this__u8e3s4.x1a().e1().toString();
        throw IllegalStateException_init_$Create$(toString(message));
      }
      arraySize = convertToInt(_this__u8e3s4.x1a().e1());
    } else {
      _this__u8e3s4.z1a(fromInt(size));
    }
    var array = new Int8Array(arraySize);
    readTo(_this__u8e3s4.x1a(), array);
    return array;
  }
  function readTo(_this__u8e3s4, sink, startIndex, endIndex) {
    ...
    while (offset < endIndex) {
      var bytesRead = _this__u8e3s4.w1b(sink, offset, endIndex);
      if (bytesRead === -1) {
  ...
  function readString(_this__u8e3s4, byteCount) {
    _this__u8e3s4.z1a(byteCount);
    return commonReadUtf8(_this__u8e3s4.x1a(), byteCount);
  }
  function readString_0(_this__u8e3s4) {
    _this__u8e3s4.a1b(new Long(-1, 2147483647));
    return commonReadUtf8(_this__u8e3s4.x1a(), _this__u8e3s4.x1a().e1());
  }
    ...
    while (i < endIndex) {
      ...
      if (c < 128) {
        $l$block_0: {
          ...
          ctx.v1d(tail, segmentOffset + _unary__edvuaz | 0, toByte(c));
          $l$loop: while (i < runLimit) {
            ...
            ctx.v1d(tail, segmentOffset + _unary__edvuaz_0 | 0, toByte(c));
          }
          var bytesWritten = i + segmentOffset | 0;
          if (bytesWritten === 1) {
            tail.e1b_1 = tail.e1b_1 + bytesWritten | 0;
            var tmp = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_3 = this_0.w1a_1;
            tmp.w1a_1 = add(this_3, fromInt(bytesWritten));
            break $l$block_0;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten ? bytesWritten <= tail.i1c() : false)) {
            var message = 'Invalid number of bytes written: ' + bytesWritten + '. Should be in 0..' + tail.i1c();
            throw IllegalStateException_init_$Create$(toString(message));
          }
          if (!(bytesWritten === 0)) {
            tail.e1b_1 = tail.e1b_1 + bytesWritten | 0;
            var tmp_0 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_4 = this_0.w1a_1;
            tmp_0.w1a_1 = add(this_4, fromInt(bytesWritten));
            break $l$block_0;
          }
          if (isEmpty(tail)) {
            this_0.x1c();
        ...
        $l$block_2: {
          // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
          var tail_0 = this_0.d1c(2);
          get_SegmentWriteContextImpl().u1d(tail_0, 0, toByte(c >> 6 | 192), toByte(c & 63 | 128));
          var bytesWritten_0 = 2;
          if (bytesWritten_0 === 2) {
            tail_0.e1b_1 = tail_0.e1b_1 + bytesWritten_0 | 0;
            var tmp_1 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_5 = this_0.w1a_1;
            tmp_1.w1a_1 = add(this_5, fromInt(bytesWritten_0));
            break $l$block_2;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten_0 ? bytesWritten_0 <= tail_0.i1c() : false)) {
            var message_0 = 'Invalid number of bytes written: ' + bytesWritten_0 + '. Should be in 0..' + tail_0.i1c();
          ...
          if (!(bytesWritten_0 === 0)) {
            ...
            var tmp_2 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_6 = this_0.w1a_1;
            tmp_2.w1a_1 = add(this_6, fromInt(bytesWritten_0));
            break $l$block_2;
          }
          if (isEmpty(tail_0)) {
            this_0.x1c();
        ...
        $l$block_4: {
          // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
          var tail_1 = this_0.d1c(3);
          get_SegmentWriteContextImpl().t1d(tail_1, 0, toByte(c >> 12 | 224), toByte(c >> 6 & 63 | 128), toByte(c & 63 | 128));
          var bytesWritten_1 = 3;
          if (bytesWritten_1 === 3) {
            tail_1.e1b_1 = tail_1.e1b_1 + bytesWritten_1 | 0;
            var tmp_3 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_7 = this_0.w1a_1;
            tmp_3.w1a_1 = add(this_7, fromInt(bytesWritten_1));
            break $l$block_4;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten_1 ? bytesWritten_1 <= tail_1.i1c() : false)) {
            var message_1 = 'Invalid number of bytes written: ' + bytesWritten_1 + '. Should be in 0..' + tail_1.i1c();
            throw IllegalStateException_init_$Create$(toString(message_1));
          }
          if (!(bytesWritten_1 === 0)) {
            tail_1.e1b_1 = tail_1.e1b_1 + bytesWritten_1 | 0;
            var tmp_4 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_8 = this_0.w1a_1;
            tmp_4.w1a_1 = add(this_8, fromInt(bytesWritten_1));
            break $l$block_4;
          }
          if (isEmpty(tail_1)) {
            this_0.x1c();
        ...
        if (c > 56319 || !(56320 <= low ? low <= 57343 : false)) {
          ...
          this_0.r1c(toByte(tmp$ret$29));
          i = i + 1 | 0;
        } else {
          var codePoint = 65536 + ((c & 1023) << 10 | low & 1023) | 0;
          $l$block_6: {
            // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
            var tail_2 = this_0.d1c(4);
            get_SegmentWriteContextImpl().s1d(tail_2, 0, toByte(codePoint >> 18 | 240), toByte(codePoint >> 12 & 63 | 128), toByte(codePoint >> 6 & 63 | 128), toByte(codePoint & 63 | 128));
            var bytesWritten_2 = 4;
            if (bytesWritten_2 === 4) {
              tail_2.e1b_1 = tail_2.e1b_1 + bytesWritten_2 | 0;
              var tmp_6 = this_0;
              // Inline function 'kotlin.Long.plus' call
              var this_11 = this_0.w1a_1;
              tmp_6.w1a_1 = add(this_11, fromInt(bytesWritten_2));
              break $l$block_6;
            }
            // Inline function 'kotlin.check' call
            if (!(0 <= bytesWritten_2 ? bytesWritten_2 <= tail_2.i1c() : false)) {
              var message_2 = 'Invalid number of bytes written: ' + bytesWritten_2 + '. Should be in 0..' + tail_2.i1c();
            ...
            if (!(bytesWritten_2 === 0)) {
              ...
              var tmp_7 = this_0;
              // Inline function 'kotlin.Long.plus' call
              var this_12 = this_0.w1a_1;
              tmp_7.w1a_1 = add(this_12, fromInt(bytesWritten_2));
              break $l$block_6;
            }
            if (isEmpty(tail_2)) {
              this_0.x1c();
  ...
  protoOf(SegmentReadContextImpl$1).v1c = function (segment, offset) {
    return segment.u1b(offset);
  };
  function SegmentWriteContextImpl$1() {
  }
  protoOf(SegmentWriteContextImpl$1).v1d = function (segment, offset, value) {
    segment.o1d(offset, value);
  };
  protoOf(SegmentWriteContextImpl$1).u1d = function (segment, offset, b0, b1) {
    segment.p1d(offset, b0, b1);
  };
  protoOf(SegmentWriteContextImpl$1).t1d = function (segment, offset, b0, b1, b2) {
    segment.q1d(offset, b0, b1, b2);
  };
  protoOf(SegmentWriteContextImpl$1).s1d = function (segment, offset, b0, b1, b2, b3) {
    segment.r1d(offset, b0, b1, b2, b3);
  };
  function BufferIterationContextImpl$1() {
  }
  protoOf(BufferIterationContextImpl$1).v1c = function (segment, offset) {
    return get_SegmentReadContextImpl().v1c(segment, offset);
  };
  ...
  protoOf(SegmentPool).g1c = function () {
    return Companion_instance.j1d();
  };
  protoOf(SegmentPool).w1c = function (segment) {
  };
  protoOf(SegmentPool).l1d = function () {
  ...
  protoOf(Buffer).k1c = write$default;
  //endregion
  //region block: init
