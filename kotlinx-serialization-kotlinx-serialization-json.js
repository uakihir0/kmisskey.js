(function (root, factory) {
  ...
  var asJsReadonlyArrayView = kotlin_kotlin.$_$.s5;
  ...
  function tryCoerceValue(_this__u8e3s4, descriptor, index, peekNull, peekString, onEnumCoercing) {
    ...
    if (!elementDescriptor.get_isNullable_67sy7o_k$() && peekNull(true))
      return true;
  ...
  function decodeSerializableValuePolymorphic(_this__u8e3s4, deserializer) {
    ...
    if (!(value instanceof JsonObject)) {
      throw JsonDecodingException_1(-1, 'Expected ' + toString(getKClass(JsonObject)) + ' as the serialized body of ' + descriptor.get_serialName_u2rqhk_k$() + ', but had ' + toString(getKClassFromExpression(value)));
    }
    var jsonTree = value;
  ...
  protoOf(AbstractJsonTreeDecoder).beginStructure_yljocp_k$ = function (descriptor) {
    ...
    if (tmp_0) {
      ...
      if (!(currentObject instanceof JsonArray)) {
        throw JsonDecodingException_1(-1, 'Expected ' + toString(getKClass(JsonArray)) + ' as the serialized body of ' + descriptor.get_serialName_u2rqhk_k$() + ', but had ' + toString(getKClassFromExpression(currentObject)));
      }
      ...
      if (equals(tmp0_subject, MAP_getInstance())) {
        ...
        if (tmp_3) {
          ...
          if (!(currentObject instanceof JsonObject)) {
            throw JsonDecodingException_1(-1, 'Expected ' + toString(getKClass(JsonObject)) + ' as the serialized body of ' + descriptor.get_serialName_u2rqhk_k$() + ', but had ' + toString(getKClassFromExpression(currentObject)));
          }
  ...
  protoOf(AbstractJsonTreeDecoder).getPrimitiveValue_54kwg6_k$ = function (tag) {
    ...
    var tmp;
    if (tmp0_elvis_lhs == null) {
      throw JsonDecodingException_0(-1, 'Expected JsonPrimitive at ' + tag + ', found ' + toString(currentElement), toString(this.currentObject_yxe2oo_k$()));
    } else {
      tmp = tmp0_elvis_lhs;
    }
    return tmp;
  ...
  protoOf(AbstractJsonTreeDecoder).decodeTaggedChar_ha7850_k$ = function (tag) {
    ...
    $l$block: {
      ...
      try {
        ...
        var tmp0_elvis_lhs = new Char(single(this_0.get_content_h02jrk_k$()));
        var tmp;
        if (tmp0_elvis_lhs == null) {
  ...
  protoOf(JsonTreeDecoder).beginStructure_yljocp_k$ = function (descriptor) {
    if (descriptor === this.polyDescriptor_1) {
      ...
      if (!(value instanceof JsonObject)) {
        throw JsonDecodingException_1(-1, 'Expected ' + toString(getKClass(JsonObject)) + ' as the serialized body of ' + descriptor_0.get_serialName_u2rqhk_k$() + ', but had ' + toString(getKClassFromExpression(value)));
      }
  ...
  protoOf(JsonTreeDecoder).endStructure_1xqz0n_k$ = function (descriptor) {
    ...
    while (tmp1_iterator.hasNext_bitz1p_k$()) {
      ...
      if (!names.contains_aljjnj_k$(key) && !(key === this.polyDiscriminator_1)) {
  ...
  protoOf(StringJsonLexer).consumeNextToken_uf1vsa_k$ = function () {
    ...
    $l$loop: while (!(this.get_currentPosition_5vz2du_k$() === -1) && this.get_currentPosition_5vz2du_k$() < source.length) {
      var tmp1 = this.get_currentPosition_5vz2du_k$();
      this.set_currentPosition_2hvbai_k$(tmp1 + 1 | 0);
  ...
  protoOf(StringJsonLexer).tryConsumeComma_9n2ve4_k$ = function () {
    var current = this.skipWhitespaces_ox013r_k$();
    if (current === this.source_1.length || current === -1)
      return false;
    if (charSequenceGet(this.source_1, current) === _Char___init__impl__6a9atx(44)) {
      this.set_currentPosition_2hvbai_k$(this.get_currentPosition_5vz2du_k$() + 1 | 0);
      this.get_currentPosition_5vz2du_k$();
      return true;
    }
    return false;
  };
  ...
  protoOf(StringJsonLexer).consumeNextToken_o6jhkj_k$ = function (expected) {
    ...
    var source = this.source_1;
    $l$loop: while (this.get_currentPosition_5vz2du_k$() < source.length) {
      var tmp1 = this.get_currentPosition_5vz2du_k$();
      this.set_currentPosition_2hvbai_k$(tmp1 + 1 | 0);
  ...
  protoOf(StringJsonLexer).consumeKeyString_mfa3ws_k$ = function () {
    ...
    if (inductionVariable < closingQuote)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        if (charSequenceGet(this.source_1, i) === _Char___init__impl__6a9atx(92)) {
          return this.consumeString2(this.source_1, this.get_currentPosition_5vz2du_k$(), i);
        }
      }
  ...
  protoOf(JsonObject).asJsReadonlyMapView = asJsReadonlyMapView;
  protoOf(JsonArray).asJsReadonlyArrayView_ch6hjz_k$ = asJsReadonlyArrayView;
