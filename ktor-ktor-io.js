(function (factory) {
  ...
  function resume() {
    return this.q1z().y8(Companion_getInstance().n1z_1);
  }
  function resume_0(throwable) {
    ...
    return tmp.y8(tmp1_elvis_lhs == null ? Companion_getInstance().n1z_1 : tmp1_elvis_lhs.gn_1);
  }
  ...
  function awaitContent$default(min, $completion, $super) {
    min = min === VOID ? 1 : min;
    return $super === VOID ? this.x21(min, $completion) : $super.x21.call(this, min, $completion);
  }
  ...
  function Companion() {
    ...
    this.m1z_1 = new Closed(null);
    var tmp = this;
    // Inline function 'kotlin.Companion.success' call
    tmp.n1z_1 = _Result___init__impl__xyqfz8(Unit_instance);
  }
  ...
  protoOf(Closed).toString = function () {
    return 'Closed(cause=' + toString(this.o1z_1) + ')';
  };
  protoOf(Closed).hashCode = function () {
    return this.o1z_1 == null ? 0 : hashCode(this.o1z_1);
  };
  protoOf(Closed).equals = function (other) {
    ...
    if (!(other instanceof Closed))
      return false;
    if (!equals(this.o1z_1, other.o1z_1))
      return false;
    return true;
  };
  function Task() {
  ...
  function Read(continuation) {
    this.u1z_1 = continuation;
    this.v1z_1 = null;
    if (get_DEVELOPMENT_MODE()) {
      var tmp = this;
      // Inline function 'kotlin.also' call
      var this_0 = newThrowable('ReadTask 0x' + toString_0(hashCode(this.u1z_1), 16));
  ...
  function Write(continuation) {
    this.w1z_1 = continuation;
    this.x1z_1 = null;
    if (get_DEVELOPMENT_MODE()) {
      var tmp = this;
      // Inline function 'kotlin.also' call
      var this_0 = newThrowable('WriteTask 0x' + toString_0(hashCode(this.w1z_1), 16));
      stackTraceToString(this_0);
      tmp.x1z_1 = this_0;
    }
  }
  ...
  function moveFlushToReadBuffer($this) {
    ...
    $this.b20_1;
    $this.z1z_1.b1c($this.d20_1);
    $this.a20_1 = 0;
    // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
    var current = $this.c20_1.kotlinx$atomicfu$value;
    var tmp;
    if (current instanceof Write) {
      tmp = $this.c20_1.atomicfu$compareAndSet(current, Empty_instance);
    } else {
      tmp = false;
    }
    if (tmp) {
  ...
  function closeSlot($this, cause) {
    var closeContinuation = !(cause == null) ? new Closed(cause) : Companion_getInstance().m1z_1;
    var continuation = $this.c20_1.atomicfu$getAndSet(closeContinuation);
    if (isInterface(continuation, Task)) {
      continuation.t1z(cause);
    }
    var tmp0_safe_receiver = $this.g20_1.atomicfu$getAndSet(null);
  ...
  function ByteChannel$invokeOnClose$lambda_1(this$0, $handler) {
    return function () {
      this$0.g20_1.atomicfu$compareAndSet($handler, null);
      return Unit_instance;
    };
  }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            if (compare(this.q20_1.d20_1.e1(), fromInt(this.r20_1)) >= 0)
              return true;
            this.s20_1 = this.q20_1;
            this.n8_1 = 1;
            continue $sm;
          case 1:
            if (!(compare(add(numberToLong(this.q20_1.a20_1), this.q20_1.d20_1.e1()), fromInt(this.r20_1)) < 0 && this.q20_1.f20_1.kotlinx$atomicfu$value == null)) {
              this.n8_1 = 3;
              continue $sm;
            }
            ...
            l$ret$1: do {
              var previous = tmp0.c20_1.kotlinx$atomicfu$value;
              if (!(previous instanceof Closed)) {
                if (!tmp0.c20_1.atomicfu$compareAndSet(previous, tmp2)) {
                  tmp2.s1z();
                  break l$ret$1;
                }
              }
              if (previous instanceof Read) {
                previous.t1z(new ConcurrentIOException(tmp2.r1z(), previous.p1z()));
              } else {
                if (isInterface(previous, Task)) {
                  previous.s1z();
                } else {
                  if (previous instanceof Closed) {
                    tmp2.t1z(previous.o1z_1);
                    break l$ret$1;
                  } else {
              ...
              if (!(compare(add(numberToLong(this.q20_1.a20_1), this.q20_1.d20_1.e1()), fromInt(this.r20_1)) < 0 && this.q20_1.f20_1.kotlinx$atomicfu$value == null)) {
                var current = tmp0.c20_1.kotlinx$atomicfu$value;
                var tmp_0;
                if (current instanceof Read) {
                  tmp_0 = tmp0.c20_1.atomicfu$compareAndSet(current, Empty_instance);
                } else {
                  tmp_0 = false;
                }
                if (tmp_0) {
          ...
          case 2:
            ...
            continue $sm;
          case 3:
            if (compare(this.q20_1.d20_1.e1(), new Long(1048576, 0)) < 0) {
              moveFlushToReadBuffer(this.q20_1);
            }

            return compare(this.q20_1.d20_1.e1(), fromInt(this.r20_1)) >= 0;
          case 4:
            throw this.q8_1;
        }
      } catch ($p) {
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 4;
            rethrowCloseCauseIfNeeded_0(this.b21_1);
            this.b21_1.d21();
            if (this.b21_1.e21())
              return Unit_instance;
            ...
            continue $sm;
          case 1:
            if (!(!this.b21_1.e21() && this.b21_1.f20_1.kotlinx$atomicfu$value == null)) {
              this.n8_1 = 3;
              continue $sm;
            }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            this.o8_1 = 2;
            this.p21_1 = Companion_instance;
            this.n8_1 = 1;
            suspendResult = this_0.q21(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            var tmp_0 = this;
            this.p21_1;
            tmp_0.o21_1 = _Result___init__impl__xyqfz8(Unit_instance);
            this.o8_1 = 4;
            this.n8_1 = 3;
            continue $sm;
          case 2:
            ...
            if (tmp_1 instanceof Error) {
              var e = this.q8_1;
              var tmp_2 = this;
              tmp_2.o21_1 = _Result___init__impl__xyqfz8(createFailure(e));
              this.n8_1 = 3;
              continue $sm;
            } else {
              throw this.q8_1;
          ...
          case 3:
            this.o8_1 = 4;
            if (!this.n21_1.f20_1.atomicfu$compareAndSet(null, get_CLOSED()))
              return Unit_instance;
            closeSlot(this.n21_1, null);
            return Unit_instance;
          case 4:
            throw this.q8_1;
        }
  ...
  function ByteChannel(autoFlush) {
    ...
    this.y1z_1 = autoFlush;
    this.z1z_1 = new Buffer();
    this.a20_1 = 0;
    this.b20_1 = new Object();
    this.c20_1 = atomic$ref$1(Empty_instance);
    this.d20_1 = new Buffer();
    this.e20_1 = new Buffer();
    this.f20_1 = atomic$ref$1(null);
    this.g20_1 = atomic$ref$1(null);
  }
  protoOf(ByteChannel).r21 = function () {
    return this.y1z_1;
  };
  protoOf(ByteChannel).e21 = function () {
    return this.a20_1 < 1048576;
  };
  protoOf(ByteChannel).s21 = function () {
    var tmp0_safe_receiver = this.f20_1.kotlinx$atomicfu$value;
    if (tmp0_safe_receiver == null)
      null;
    else {
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          tmp = access$_get_origin__hdh1qz(tmp0_safe_receiver).u1l();
        } else {
    ...
    if (this.u21()) {
      ...
      if (tmp0_safe_receiver == null) {
        ...
        if (tmp0_subject == null) {
          ...
          if (isInterface(tmp0_subject, CopyableThrowable)) {
            tmp_0 = access$_get_origin__hdh1qz(tmp0_safe_receiver).u1l();
          } else {
            if (tmp0_subject instanceof CancellationException) {
  ...
  protoOf(ByteChannel).u21 = function () {
    return !(this.f20_1.kotlinx$atomicfu$value == null);
  };
  protoOf(ByteChannel).w21 = function () {
    return !(this.v21() == null) || (this.u21() && this.a20_1 === 0 && this.d20_1.y1a());
  };
  protoOf(ByteChannel).x21 = function (min, $completion) {
    var tmp = new $awaitContentCOROUTINE$(this, min, $completion);
    tmp.p8_1 = Unit_instance;
    tmp.q8_1 = null;
    return tmp.v8();
  };
  protoOf(ByteChannel).q21 = function ($completion) {
    var tmp = new $flushCOROUTINE$(this, $completion);
    tmp.p8_1 = Unit_instance;
    tmp.q8_1 = null;
    return tmp.v8();
  };
  protoOf(ByteChannel).d21 = function () {
    if (this.e20_1.y1a())
      return Unit_instance;
    // Inline function 'io.ktor.utils.io.locks.synchronized' call
    this.b20_1;
    var count = convertToInt(this.e20_1.e1());
    this.z1z_1.q1c(this.e20_1);
    this.a20_1 = this.a20_1 + count | 0;
    // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
    var current = this.c20_1.kotlinx$atomicfu$value;
    var tmp;
    if (current instanceof Read) {
  ...
  protoOf(ByteChannel).h4 = function () {
    this.d21();
    if (!this.f20_1.atomicfu$compareAndSet(null, get_CLOSED()))
      return Unit_instance;
    closeSlot(this, null);
  };
  protoOf(ByteChannel).z21 = function ($completion) {
    var tmp = new $flushAndCloseCOROUTINE$(this, $completion);
    tmp.p8_1 = Unit_instance;
    tmp.q8_1 = null;
    return tmp.v8();
  };
  protoOf(ByteChannel).a22 = function (cause) {
    if (!(this.f20_1.kotlinx$atomicfu$value == null))
      return Unit_instance;
    var closedToken = new CloseToken(cause);
    this.f20_1.atomicfu$compareAndSet(null, closedToken);
    // Inline function 'io.ktor.utils.io.Companion.wrapCause' call
    ...
    if (tmp0_subject == null) {
      ...
      if (isInterface(tmp0_subject, CopyableThrowable)) {
        tmp = access$_get_origin__hdh1qz(closedToken).u1l();
      } else {
        if (tmp0_subject instanceof CancellationException) {
  ...
  protoOf(ByteChannel).b22 = function (handler) {
    var existingCause = this.f20_1.kotlinx$atomicfu$value;
    if (!(existingCause == null)) {
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          tmp = access$_get_origin__hdh1qz(existingCause).u1l();
        } else {
          if (tmp0_subject instanceof CancellationException) {
    ...
    if (!this.g20_1.atomicfu$compareAndSet(null, handler)) {
      // Inline function 'kotlin.error' call
      var message = 'Only one invokeOnClose handler is supported per channel';
      throw IllegalStateException_init_$Create$(toString_1(message));
    }
    var cause = this.f20_1.kotlinx$atomicfu$value;
    if (!(cause == null) && this.g20_1.atomicfu$compareAndSet(handler, null)) {
      // Inline function 'io.ktor.utils.io.Companion.wrapCause' call
      ...
      if (tmp0_subject_0 == null) {
        ...
        if (isInterface(tmp0_subject_0, CopyableThrowable)) {
          tmp_1 = access$_get_origin__hdh1qz(cause).u1l();
        } else {
        ...
        switch (tmp) {
          ...
          case 1:
            if (!this.o23_1.g22_1.y1a()) {
              ...
              this.n8_1 = 2;
              suspendResult = this.o23_1.c22_1.y21(VOID, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 7:
            ...
            this.n8_1 = 8;
            suspendResult = this.o23_1.e22_1.q21(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
        ...
        switch (tmp) {
          ...
          case 1:
            if (!this.t22_1.g22_1.y1a()) {
              ...
              this.n8_1 = 2;
              suspendResult = this.t22_1.c22_1.y21(VOID, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
        ...
        switch (tmp) {
          ...
          case 1:
            if (!this.d23_1.g22_1.y1a()) {
              ...
              this.n8_1 = 2;
              suspendResult = this.d23_1.c22_1.y21(VOID, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
  ...
  function attachWriterJob(_this__u8e3s4, writerJob) {
    var tmp = writerJob.s23_1;
    var tmp0_safe_receiver = tmp instanceof ByteChannel ? tmp : null;
    if (tmp0_safe_receiver == null)
      null;
    else {
      tmp0_safe_receiver.b22(attachWriterJob$lambda(_this__u8e3s4));
    }
  }
  function attachWriterJob$lambda($this_attachWriterJob) {
    return function (cause) {
      var tmp;
      if (!(cause == null)) {
        $this_attachWriterJob.a22(cause);
        tmp = Unit_instance;
      }
      return Unit_instance;
    };
  ...
  protoOf(ByteReadChannel$Companion$Empty$1).s21 = function () {
    return this.v23_1;
  };
  protoOf(ByteReadChannel$Companion$Empty$1).x21 = function (min, $completion) {
    return false;
  };
  protoOf(ByteReadChannel$Companion$Empty$1).a22 = function (cause) {
  };
  function Companion_0() {
    Companion_instance_1 = this;
    var tmp = this;
    tmp.w23_1 = new ByteReadChannel$Companion$Empty$1();
  }
  ...
  function cancel_0(_this__u8e3s4) {
    _this__u8e3s4.a22(IOException_init_$Create$('Channel was cancelled'));
  }
  ...
  function get_availableForRead(_this__u8e3s4) {
    return convertToInt(_this__u8e3s4.s21().x1a().e1());
  }
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            this.g24_1.q1c(this.f24_1.s21());
            this.n8_1 = 2;
            suspendResult = this.f24_1.y21(VOID, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 2:
            ...
            continue $sm;
          case 3:
            rethrowCloseCauseIfNeeded(this.f24_1);
            return this.g24_1.x1a();
          case 4:
            throw this.q8_1;
        }
      } catch ($p) {
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 5;
            this.r24_1 = this.q24_1;
            this.n8_1 = 1;
            continue $sm;
          case 1:
            if (!(compare(this.r24_1, new Long(0, 0)) > 0 && !this.p24_1.w21())) {
              this.n8_1 = 4;
              continue $sm;
            }

            if (get_availableForRead(this.p24_1) === 0) {
              this.n8_1 = 2;
              suspendResult = this.p24_1.y21(VOID, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 3:
            var tmp0 = this.r24_1;
            var b = get_remaining(this.p24_1.s21());
            var count = compare(tmp0, b) <= 0 ? tmp0 : b;
            discard_0(this.p24_1.s21(), count);
            this.r24_1 = subtract(this.r24_1, count);
            this.n8_1 = 1;
            continue $sm;
          case 4:
            return subtract(this.q24_1, this.r24_1);
          case 5:
            throw this.q8_1;
        }
      } catch ($p) {
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            if (this.a25_1.w21())
              return -1;
            if (this.a25_1.s21().y1a()) {
              this.n8_1 = 1;
              suspendResult = this.a25_1.y21(VOID, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 2:
            if (this.a25_1.w21())
              return -1;
            return readAvailable_0(this.a25_1.s21(), this.b25_1, this.c25_1, this.d25_1);
          case 3:
            throw this.q8_1;
        }
      } catch ($p) {
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 2;
            this.n8_1 = 1;
            suspendResult = readBuffer(this.m25_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            continue $sm;
          case 2:
            if (!(!this.v25_1.w21() && compare(this.y25_1, new Long(0, 0)) > 0)) {
              this.n8_1 = 6;
              continue $sm;
            }

            if (this.v25_1.s21().y1a()) {
              this.n8_1 = 3;
              suspendResult = this.v25_1.y21(VOID, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 4:
            var tmp0 = this.y25_1;
            var b = get_remaining(this.v25_1.s21());
            var count = compare(tmp0, b) <= 0 ? tmp0 : b;
            this.v25_1.s21().a1c(this.w25_1.t21(), count);
            this.y25_1 = subtract(this.y25_1, count);
            this.n8_1 = 5;
            suspendResult = this.w25_1.q21(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 7:
            ...
            if (tmp_0 instanceof Error) {
              var cause = this.q8_1;
              this.v25_1.a22(cause);
              close_0(this.w25_1, cause);
              throw cause;
            } else {
              throw this.q8_1;
            }
          ...
          case 10:
            ...
            continue $sm;
          case 11:
            return subtract(this.x25_1, this.y25_1);
          case 12:
            throw this.q8_1;
        }
      } catch ($p) {
  ...
  function $skipIfFoundCOROUTINE$(_this__u8e3s4, byteString, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this.i26_1 = _this__u8e3s4;
    this.j26_1 = byteString;
  }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 4;
            this.n8_1 = 1;
            suspendResult = peek(this.i26_1, this.j26_1.e1(), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            var ARGUMENT = suspendResult;
            if (equals(ARGUMENT, this.j26_1)) {
              this.n8_1 = 3;
              suspendResult = discard(this.i26_1, fromInt(this.j26_1.e1()), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            continue $sm;
          case 1:
            if (!(compare(this.u26_1.e1(), fromInt(this.t26_1)) < 0)) {
              this.n8_1 = 5;
              continue $sm;
            }

            if (this.s26_1.s21().y1a()) {
              this.n8_1 = 2;
              suspendResult = this.s26_1.y21(VOID, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 4:
            if (compare(get_remaining(this.s26_1.s21()), subtract(numberToLong(this.t26_1), this.u26_1.e1())) > 0) {
              this.s26_1.s21().a1c(this.u26_1, subtract(numberToLong(this.t26_1), this.u26_1.e1()));
            } else {
              this.s26_1.s21().b1c(this.u26_1);
            }
          ...
          case 5:
            if (compare(this.u26_1.e1(), fromInt(this.t26_1)) < 0) {
              throw EOFException_init_$Create$('Not enough data available, required ' + this.t26_1 + ' bytes but only ' + this.u26_1.e1().toString() + ' available');
            }
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            this.e27_1.q1c(this.d27_1.s21());
            this.n8_1 = 2;
            suspendResult = this.d27_1.y21(VOID, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 2:
            ...
            continue $sm;
          case 3:
            var tmp0_safe_receiver = this.d27_1.v21();
            if (tmp0_safe_receiver == null)
              null;
            else {
              throw tmp0_safe_receiver;
        ...
        switch (tmp) {
          case 0:
            ...
            if (this.n27_1.w21())
              return null;
            this.n8_1 = 1;
            suspendResult = this.n27_1.x21(this.o27_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 2:
            return readByteString(this.n27_1.s21().c1c(), this.o27_1);
          case 3:
            throw this.q8_1;
        }
      } catch ($p) {
  ...
  function $internalReadLineToCOROUTINE$(_this__u8e3s4, out, limit, lenientLineEnding, throwOnIncompleteLine, resultContinuation) {
    ...
    this.y27_1 = out;
    this.z27_1 = limit;
    this.a28_1 = lenientLineEnding;
    this.b28_1 = throwOnIncompleteLine;
  }
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 18;
            this.d28_1 = this.x27_1.s21();
            if (this.d28_1.y1a()) {
              this.n8_1 = 1;
              suspendResult = this.x27_1.y21(VOID, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 2:
            if (this.x27_1.w21())
              return new Long(-1, -1);
            this.c28_1 = {_v: new Long(0, 0)};
            this.n8_1 = 3;
            continue $sm;
          case 3:
            if (!(compare(this.c28_1._v, this.z27_1) < 0 && !this.x27_1.w21())) {
              this.n8_1 = 10;
              continue $sm;
            }

            var limitLeft = subtract(this.z27_1, this.c28_1._v);
            var lfIndex = indexOf(this.d28_1, 10, VOID, limitLeft);
            var crIndex = internalReadLineTo$scanForSoleCr(this.d28_1, this.a28_1, lfIndex, limitLeft);
            if (compare(crIndex, new Long(0, 0)) >= 0) {
              internalReadLineTo$transferString(this.d28_1, this.y27_1, this.c28_1, crIndex);
              discard_0(this.d28_1, new Long(1, 0));
              return this.c28_1._v;
            }
            ...
            if (compare(lfIndex, new Long(0, 0)) > 0) {
              ...
              var isCrlf = tmp_0;
              internalReadLineTo$transferString(this.d28_1, this.y27_1, this.c28_1, subtract(lfIndex, isCrlf));
              discard_0(this.d28_1, add(numberToLong(1), isCrlf));
              return this.c28_1._v;
            }

            var b = get_remaining(this.d28_1);
            var count = compare(limitLeft, b) <= 0 ? limitLeft : b;
            var tmp_2 = this.d28_1.x1a();
            if (tmp_2.t1b(subtract(count, fromInt(1))) === 13) {
              internalReadLineTo$transferString(this.d28_1, this.y27_1, this.c28_1, subtract(count, fromInt(1)));
              this.n8_1 = 4;
              suspendResult = internalReadLineTo$discardCrlfOrCr(this.d28_1, this.x27_1, this.a28_1, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
            } else {
              internalReadLineTo$transferString(this.d28_1, this.y27_1, this.c28_1, count);
              this.n8_1 = 6;
              continue $sm;
            }
          ...
          case 5:
            internalReadLineTo$transferString(this.d28_1, this.y27_1, this.c28_1, new Long(1, 0));
            this.n8_1 = 6;
            continue $sm;
          case 6:
            if (compare(this.c28_1._v, this.z27_1) < 0 && equalsLong(get_remaining(this.d28_1), new Long(0, 0))) {
              this.n8_1 = 7;
              suspendResult = this.x27_1.y21(VOID, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
          ...
          case 9:
            ...
            continue $sm;
          case 10:
            if (equalsLong(this.c28_1._v, new Long(0, 0)) && this.x27_1.w21())
              return new Long(-1, -1);
            if (!(compare(this.c28_1._v, this.z27_1) <= 0)) {
              var message = 'Consumed bytes exceed the limit: ' + this.c28_1._v.toString() + ' > ' + this.z27_1.toString() + ". It's an implementation bug, please report it.";
              throw IllegalStateException_init_$Create$(toString_1(message));
            }

            if (equalsLong(this.c28_1._v, this.z27_1)) {
              if (equalsLong(this.z27_1, new Long(-1, 2147483647)))
                throw new TooLongLineException('Max line length exceeded');
              if (equalsLong(get_remaining(this.d28_1), new Long(0, 0))) {
                this.n8_1 = 12;
                suspendResult = this.x27_1.y21(VOID, this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
          ...
          case 11:
            if (this.b28_1) {
              throwEndOfStreamException(this.c28_1._v);
            }
          ...
          case 13:
            ...
            break;
          case 14:
            var tmp0_subject = this.d28_1.x1a().t1b(new Long(0, 0));
            if (tmp0_subject === 10) {
              discard_0(this.d28_1, new Long(1, 0));
              return this.c28_1._v;
            } else {
          ...
          case 16:
            ...
            continue $sm;
          case 17:
            throwTooLongLineException(this.z27_1);
            break;
          case 18:
            throw this.q8_1;
        }
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            this.q28_1 = add(this.q28_1, this.o28_1.s21().b1c(this.p28_1.t21()));
            this.n8_1 = 3;
            suspendResult = this.p28_1.q21(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 3:
            this.n8_1 = 4;
            suspendResult = this.o28_1.y21(VOID, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 6:
            ...
            if (tmp_0 instanceof Error) {
              var cause = this.q8_1;
              this.o28_1.a22(cause);
              close_0(this.p28_1, cause);
              throw cause;
            } else {
              throw this.q8_1;
            }
  ...
  function $internalReadLineTo$discardCrlfOrCrCOROUTINE$(_this__u8e3s4, $this_internalReadLineTo, $lenientLineEnding, resultContinuation) {
    CoroutineImpl.call(this, resultContinuation);
    this.a29_1 = _this__u8e3s4;
    this.b29_1 = $this_internalReadLineTo;
    this.c29_1 = $lenientLineEnding;
  }
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 5;
            if (compare(get_remaining(this.a29_1), new Long(2, 0)) >= 0) {
              this.e29_1 = true;
              this.n8_1 = 2;
              continue $sm;
            } else {
              this.n8_1 = 1;
              suspendResult = this.b29_1.x21(2, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 1:
            this.e29_1 = suspendResult;
            this.n8_1 = 2;
            continue $sm;
          case 2:
            if (this.e29_1) {
              this.d29_1 = this.a29_1.x1a().t1b(new Long(1, 0)) === 10;
              this.n8_1 = 3;
              continue $sm;
            } else {
              this.d29_1 = false;
          ...
          case 3:
            if (this.d29_1) {
              discard_0(this.a29_1, new Long(2, 0));
              return true;
            } else {
              this.n8_1 = 4;
              continue $sm;
          ...
          case 4:
            if (this.c29_1) {
              discard_0(this.a29_1, new Long(1, 0));
              return true;
            }
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 3;
            rethrowCloseCauseIfNeeded_1(this.n29_1);
            if (this.n29_1.r21() || get_size(this.n29_1.t21()) >= 1048576) {
              this.n8_1 = 1;
              suspendResult = this.n29_1.q21(this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
  ...
  protoOf(ByteWriteChannel$flushAndClose$ref).c2a = function ($completion) {
    return this.b2a_1.z21($completion);
  };
  protoOf(ByteWriteChannel$flushAndClose$ref).i9 = function ($completion) {
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (get_job(this.n2a_1.j1e()).f1f()) {
              this.m2a_1.a22(get_job(this.n2a_1.j1e()).i1f());
              tmp_0 = Unit_instance;
            }
          ...
          case 5:
            ...
            this.n8_1 = 6;
            suspendResult = this.m2a_1.z21(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  function transferFromDelegate($this) {
    updateConsumed($this);
    var appended = $this.y2a_1.q1c($this.x2a_1.s21());
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 3;
            if (compare(this.j2b_1.s21().e1(), fromInt(this.k2b_1)) >= 0) {
              return true;
            }

            this.n8_1 = 1;
            suspendResult = this.j2b_1.x2a_1.x21(this.k2b_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(CountedByteReadChannel).w21 = function () {
    return this.y2a_1.y1a() && this.x2a_1.w21();
  };
  protoOf(CountedByteReadChannel).s21 = function () {
    transferFromDelegate(this);
    return this.y2a_1;
  };
  protoOf(CountedByteReadChannel).x21 = function (min, $completion) {
    var tmp = new $awaitContentCOROUTINE$_0(this, min, $completion);
    tmp.p8_1 = Unit_instance;
    tmp.q8_1 = null;
    return tmp.v8();
  };
  protoOf(CountedByteReadChannel).a22 = function (cause) {
    this.x2a_1.a22(cause);
    this.y2a_1.h4();
  };
  ...
  function LineEndingMode__toString_impl_j4h76r($this) {
    var tmp;
    if ($this === Companion_getInstance_2().m2b_1) {
      tmp = 'CR';
    } else if ($this === Companion_getInstance_2().n2b_1) {
      tmp = 'LF';
    } else if ($this === Companion_getInstance_2().o2b_1) {
      tmp = 'CRLF';
    } else {
      // Inline function 'kotlin.collections.filter' call
      var tmp0 = Companion_getInstance_2().q2b_1;
  ...
  protoOf(SourceByteReadChannel).s21 = function () {
  ...
  protoOf(SourceByteReadChannel).x21 = function (min, $completion) {
    var tmp0_safe_receiver = this.v21();
    if (tmp0_safe_receiver == null)
      null;
    else {
  ...
  protoOf(SourceByteReadChannel).a22 = function (cause) {
    if (!(this.t2b_1 == null))
      return Unit_instance;
    this.s2b_1.h4();
    var tmp = this;
  ...
  protoOf(Companion_3).l2c = function (name) {
    switch (name) {
      case 'UTF-8':
      case 'utf-8':
      case 'UTF8':
  ...
  function forName(_this__u8e3s4, name) {
    return Companion_instance_4.l2c(name);
  }
  ...
  protoOf(Read).s1z = resume;
  protoOf(Read).t1z = resume_0;
  protoOf(Write).s1z = resume;
  protoOf(Write).t1z = resume_0;
  protoOf(ByteChannel).y21 = awaitContent$default;
  protoOf(ByteReadChannel$Companion$Empty$1).y21 = awaitContent$default;
  protoOf(CountedByteReadChannel).y21 = awaitContent$default;
  protoOf(SourceByteReadChannel).y21 = awaitContent$default;
