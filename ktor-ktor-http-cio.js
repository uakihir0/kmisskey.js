(function (factory) {
  ...
  function CIOMultipartDataBase(coroutineContext, channel, contentType, contentLength, formFieldLimit) {
    ...
    this.p3n_1 = coroutineContext;
    this.q3n_1 = null;
    this.r3n_1 = parseMultipart(this, channel, contentType, contentLength, formFieldLimit);
  }
  ...
  function thresholdReached($this) {
    return $this.t3n_1 >= $this.u3n_1 * 0.75;
  }
  function resize($this) {
    var prevSize = $this.t3n_1;
    var prevData = $this.v3n_1;
    $this.t3n_1 = 0;
    $this.u3n_1 = imul($this.u3n_1, 2) | 128;
    var tmp = $this;
    // Inline function 'kotlin.apply' call
    var this_0 = get_HeadersDataPool().j2c();
    this_0.y3n(imul(prevData.x3n(), 2) | 1);
    tmp.v3n_1 = this_0;
    var _iterator__ex2g4s = prevData.z3n().t();
    while (_iterator__ex2g4s.u()) {
      var headerOffset = _iterator__ex2g4s.v();
      $this.b3o(prevData.a3o(headerOffset + 1 | 0), prevData.a3o(headerOffset + 2 | 0), prevData.a3o(headerOffset + 3 | 0), prevData.a3o(headerOffset + 4 | 0));
    }
    get_HeadersDataPool().k2c(prevData);
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.require' call
    if (!(prevSize === $this.t3n_1)) {
      var message = 'Failed requirement.';
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
  }
  function headerHasName($this, name, headerOffset) {
    var nameStartIndex = $this.v3n_1.a3o(headerOffset + 1 | 0);
    var nameEndIndex = $this.v3n_1.a3o(headerOffset + 2 | 0);
    return equalsLowerCase($this.s3n_1, nameStartIndex, nameEndIndex, name);
  }
  function HttpHeadersMap(builder) {
    this.s3n_1 = builder;
    this.t3n_1 = 0;
    this.u3n_1 = 0;
    this.v3n_1 = get_HeadersDataPool().j2c();
  }
  protoOf(HttpHeadersMap).p2e = function (name) {
    ...
    var hash = abs(this_0);
    var headerIndex = hash % this.u3n_1 | 0;
    while (!(this.v3n_1.a3o(imul(headerIndex, 6) + 0 | 0) === -1)) {
      if (headerHasName(this, name, imul(headerIndex, 6))) {
        return this.c3o(imul(headerIndex, 6));
      }
      headerIndex = (headerIndex + 1 | 0) % this.u3n_1 | 0;
    }
    return null;
  };
  protoOf(HttpHeadersMap).d3o = function () {
    return this.v3n_1.z3n();
  };
  protoOf(HttpHeadersMap).b3o = function (nameStartIndex, nameEndIndex, valueStartIndex, valueEndIndex) {
    if (thresholdReached(this)) {
      resize(this);
    }
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(this.s3n_1, nameStartIndex, nameEndIndex);
    var hash = abs(this_0);
    var name = this.s3n_1.c(nameStartIndex, nameEndIndex);
    var headerIndex = hash % this.u3n_1 | 0;
    ...
    this.v3n_1.l3o(headerOffset + 0 | 0, hash);
    this.v3n_1.l3o(headerOffset + 1 | 0, nameStartIndex);
    this.v3n_1.l3o(headerOffset + 2 | 0, nameEndIndex);
    this.v3n_1.l3o(headerOffset + 3 | 0, valueStartIndex);
    this.v3n_1.l3o(headerOffset + 4 | 0, valueEndIndex);
    this.v3n_1.l3o(headerOffset + 5 | 0, -1);
    if (!(sameNameHeaderIndex === -1)) {
      this.v3n_1.l3o(imul(sameNameHeaderIndex, 6) + 5 | 0, headerIndex);
    }
    this.t3n_1 = this.t3n_1 + 1 | 0;
  };
  protoOf(HttpHeadersMap).m3o = function (headerOffset) {
    var nameStartIndex = this.v3n_1.a3o(headerOffset + 1 | 0);
    var nameEndIndex = this.v3n_1.a3o(headerOffset + 2 | 0);
    return this.s3n_1.c(nameStartIndex, nameEndIndex);
  };
  protoOf(HttpHeadersMap).c3o = function (headerOffset) {
    var valueStartIndex = this.v3n_1.a3o(headerOffset + 3 | 0);
    var valueEndIndex = this.v3n_1.a3o(headerOffset + 4 | 0);
    return this.s3n_1.c(valueStartIndex, valueEndIndex);
  };
  protoOf(HttpHeadersMap).r2y = function () {
    this.t3n_1 = 0;
    this.u3n_1 = 0;
    get_HeadersDataPool().k2c(this.v3n_1);
    this.v3n_1 = get_HeadersDataPool().j2c();
  };
  ...
  protoOf(HeadersData$headersStarts$slambda).b3p = function ($this$sequence, $completion) {
    var tmp = this.c3p($this$sequence, $completion);
    tmp.p8_1 = Unit_instance;
    tmp.q8_1 = null;
    return tmp.v8();
  };
  protoOf(HeadersData$headersStarts$slambda).i9 = function (p1, $completion) {
    return this.b3p(p1 instanceof SequenceScope ? p1 : THROW_CCE(), $completion);
  };
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            this.z3o_1 = this.a3p_1.v();
            this.y3o_1 = 0;
            this.n8_1 = 2;
            continue $sm;
          case 2:
            if (!(this.y3o_1 < this.z3o_1.length)) {
              this.n8_1 = 5;
              continue $sm;
            }

            if (!(this.v3o_1.a3o(this.x3o_1 + 0 | 0) === -1)) {
              this.n8_1 = 3;
              suspendResult = this.w3o_1.zf(this.x3o_1, this);
          ...
          case 3:
            ...
            continue $sm;
          case 4:
            this.y3o_1 = this.y3o_1 + 6 | 0;
            this.x3o_1 = this.x3o_1 + 6 | 0;
            this.n8_1 = 2;
            continue $sm;
          case 5:
            this.n8_1 = 1;
  ...
  protoOf(HeadersData$headersStarts$slambda).c3p = function ($this$sequence, completion) {
    var i = new HeadersData$headersStarts$slambda(this.v3o_1, completion);
    i.w3o_1 = $this$sequence;
    return i;
  };
  function HeadersData$headersStarts$slambda_0(this$0, resultContinuation) {
    ...
    var l = function ($this$sequence, $completion) {
      return i.b3p($this$sequence, $completion);
    };
    l.$arity = 1;
    return l;
  }
  function HeadersData() {
    ...
    tmp.w3n_1 = ArrayList_init_$Create$();
  }
  protoOf(HeadersData).x3n = function () {
    return this.w3n_1.e1();
  };
  protoOf(HeadersData).y3n = function (subArraysCount) {
    ...
    if (inductionVariable < subArraysCount)
      do {
        ...
        this.w3n_1.b1(get_IntArrayPool().j2c());
      }
       while (inductionVariable < subArraysCount);
  };
  protoOf(HeadersData).a3o = function (index) {
    return this.w3n_1.d1(index / 768 | 0)[index % 768 | 0];
  };
  protoOf(HeadersData).l3o = function (index, value) {
    this.w3n_1.d1(index / 768 | 0)[index % 768 | 0] = value;
  };
  protoOf(HeadersData).z3n = function () {
    return sequence(HeadersData$headersStarts$slambda_0(this, null));
  };
  protoOf(HeadersData).r2y = function () {
    var _iterator__ex2g4s = this.w3n_1.t();
    while (_iterator__ex2g4s.u()) {
  ...
  function dumpTo(_this__u8e3s4, indent, out) {
    _init_properties_HttpHeadersMap_kt__hwatby();
    var _iterator__ex2g4s = _this__u8e3s4.d3o().t();
    while (_iterator__ex2g4s.u()) {
      var offset = _iterator__ex2g4s.v();
      out.c1(indent);
      out.c1(_this__u8e3s4.m3o(offset));
      out.c1(' => ');
      out.c1(_this__u8e3s4.c3o(offset));
      out.c1('\n');
    }
  }
  ...
  protoOf(IntArrayPool$1).g3p = function (instance) {
    fill(instance, -1);
    return protoOf(DefaultPool).h2c.call(this, instance);
  };
  protoOf(IntArrayPool$1).h2c = function (instance) {
    return this.g3p(isIntArray(instance) ? instance : THROW_CCE());
  };
  ...
  protoOf(HeadersDataPool$1).k3p = function (instance) {
    instance.r2y();
    return protoOf(DefaultPool).h2c.call(this, instance);
  };
  protoOf(HeadersDataPool$1).h2c = function (instance) {
    return this.k3p(instance instanceof HeadersData ? instance : THROW_CCE());
  };
  ...
  function parseHeaderName(text, range) {
    _init_properties_HttpParser_kt__gbdom1();
    var index = range.y3p_1;
    var end = range.z3p_1;
    while (index < end) {
      var ch = text.b(index);
      if (ch === _Char___init__impl__6a9atx(58) && !(index === range.y3p_1)) {
        range.y3p_1 = index + 1 | 0;
        return index;
      }
      if (isDelimiter(ch)) {
        parseHeaderNameFailed(text, index, range.y3p_1, ch);
      }
      index = index + 1 | 0;
    }
  ...
  function parseHeaderValue(text, range) {
    ...
    range.y3p_1 = valueStart;
    range.z3p_1 = valueLastIndex + 1 | 0;
  }
  ...
  function noColonFound(text, range) {
    _init_properties_HttpParser_kt__gbdom1();
    var tmp2 = range.y3p_1;
    // Inline function 'kotlin.text.substring' call
    var endIndex = range.z3p_1;
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 7;
            this.w3p_1 = new HttpHeadersMap(this.u3p_1);
            this.o8_1 = 6;
            this.n8_1 = 1;
            continue $sm;
          case 1:
            ...
            this.n8_1 = 2;
            suspendResult = readLineStrictTo(this.t3p_1, this.u3p_1, new Long(8192, 0), VOID, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 3:
            this.v3p_1.z3p_1 = this.u3p_1.k3o_1;
            this.x3p_1 = this.v3p_1.z3p_1 - this.v3p_1.y3p_1 | 0;
            if (this.x3p_1 === 0) {
              this.n8_1 = 5;
              continue $sm;
            } else {
          ...
          case 4:
            ...
            var nameStart = this.v3p_1.y3p_1;
            var nameEnd = parseHeaderName(this.u3p_1, this.v3p_1);
            var headerEnd = this.v3p_1.z3p_1;
            parseHeaderValue(this.u3p_1, this.v3p_1);
            var valueStart = this.v3p_1.y3p_1;
            var valueEnd = this.v3p_1.z3p_1;
            this.v3p_1.y3p_1 = headerEnd;
            this.w3p_1.b3o(nameStart, nameEnd, valueStart, valueEnd);
            this.n8_1 = 1;
            continue $sm;
          case 5:
            var host = this.w3p_1.p2e('Host');
            if (!(host == null)) {
  ...
  function _init_properties_HttpParser_kt__gbdom1() {
    if (!properties_initialized_HttpParser_kt_uedryv) {
      ...
      versions = Companion_instance.a3q(listOf(['HTTP/1.0', 'HTTP/1.1']));
    }
  }
  function get_CrLf() {
  ...
  function parseMultipart(_this__u8e3s4, input, contentType, contentLength, maxPartSize) {
    ...
    _init_properties_Multipart_kt__ato98a();
    if (!MultiPart_getInstance().f2m(contentType)) {
  ...
  function parseMultipart$slambda$slambda($firstBoundary, $countedInput, resultContinuation) {
    this.y3r_1 = $firstBoundary;
    this.z3r_1 = $countedInput;
    CoroutineImpl.call(this, resultContinuation);
  }
  protoOf(parseMultipart$slambda$slambda).b3s = function ($this$writer, $completion) {
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 3;
            this.n8_1 = 1;
            suspendResult = parsePreambleImpl(this.y3r_1, this.z3r_1, this.a3s_1.o29_1, new Long(8193, 0), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            this.n8_1 = 2;
            suspendResult = this.a3s_1.o29_1.a22(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(parseMultipart$slambda$slambda).c3s = function ($this$writer, completion) {
    var i = new parseMultipart$slambda$slambda(this.y3r_1, this.z3r_1, completion);
    i.a3s_1 = $this$writer;
    return i;
  };
  ...
  function parseMultipart$slambda($input, $boundaryPrefixed, $maxPartSize, $totalLength, resultContinuation) {
    this.l3s_1 = $input;
    this.m3s_1 = $boundaryPrefixed;
    this.n3s_1 = $maxPartSize;
    this.o3s_1 = $totalLength;
    CoroutineImpl.call(this, resultContinuation);
  }
  protoOf(parseMultipart$slambda).x3s = function ($this$produce, $completion) {
    var tmp = this.y3s($this$produce, $completion);
    tmp.p8_1 = Unit_instance;
    tmp.q8_1 = null;
    return tmp.v8();
  };
  protoOf(parseMultipart$slambda).i9 = function (p1, $completion) {
    return this.x3s((!(p1 == null) ? isInterface(p1, ProducerScope) : false) ? p1 : THROW_CCE(), $completion);
  };
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 25;
            this.q3s_1 = counted(this.l3s_1);
            this.r3s_1 = this.q3s_1.l2b();
            this.v3s_1 = this.m3s_1.q1a(get_PrefixString().e1());
            this.n8_1 = 1;
            suspendResult = readRemaining(writer(this.p3s_1, VOID, VOID, parseMultipart$slambda$slambda_0(this.v3s_1, this.q3s_1, null)).m29_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            ...
            if (compare(get_remaining(preambleData), new Long(0, 0)) > 0) {
              this.n8_1 = 2;
              suspendResult = this.p3s_1.m1v(new Preamble(preambleData), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 4:
            if (!this.q3s_1.x21()) {
              this.n8_1 = 5;
              suspendResult = skipIfFound(this.q3s_1, get_PrefixString(), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 6:
            ...
            this.n8_1 = 7;
            suspendResult = skipIfFound(this.q3s_1, get_CrLf(), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 7:
            this.n8_1 = 8;
            suspendResult = skipIfFound(this.q3s_1, this.v3s_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 9:
            this.s3s_1 = new ByteChannel();
            this.u3s_1 = CompletableDeferred();
            var part = new MultipartPart(this.u3s_1, this.s3s_1);
            this.n8_1 = 10;
            suspendResult = this.p3s_1.m1v(part, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 10:
            ...
            this.o8_1 = 14;
            this.n8_1 = 11;
            suspendResult = parsePartHeadersImpl(this.q3s_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 11:
            ...
            if (!this.u3s_1.j1l(this.t3s_1)) {
              this.t3s_1.r2y();
              throw CancellationException_init_$Create$('Multipart processing has been cancelled');
            }

            this.n8_1 = 12;
            suspendResult = parsePartBodyImpl(this.m3s_1, this.q3s_1, this.s3s_1, this.t3s_1, this.n3s_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 14:
            ...
            if (tmp_0 instanceof Error) {
              var cause = this.q8_1;
              if (this.u3s_1.k1l(cause)) {
                var tmp0_safe_receiver = this.t3s_1;
                if (tmp0_safe_receiver == null)
                  null;
                else {
                  tmp0_safe_receiver.r2y();
                }
              }
              close(this.s3s_1, cause);
              throw cause;
            } else {
              throw this.q8_1;
            }
          ...
          case 17:
            if (!(this.o3s_1 == null)) {
              var consumedExceptEpilogue = subtract(this.q3s_1.l2b(), this.r3s_1);
              var size = subtract(this.o3s_1, consumedExceptEpilogue);
              ...
              if (compare(size, new Long(0, 0)) > 0) {
                this.n8_1 = 21;
                suspendResult = readPacket(this.q3s_1, convertToInt(size), this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
                }
                continue $sm;
              ...
              this.n8_1 = 18;
              suspendResult = readRemaining(this.q3s_1, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 18:
            ...
            if (!epilogueContent.y1a()) {
              this.n8_1 = 19;
              suspendResult = this.p3s_1.m1v(new Epilogue(epilogueContent), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 21:
            ...
            this.n8_1 = 22;
            suspendResult = this.p3s_1.m1v(ARGUMENT_0, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(parseMultipart$slambda).y3s = function ($this$produce, completion) {
    var i = new parseMultipart$slambda(this.l3s_1, this.m3s_1, this.n3s_1, this.o3s_1, completion);
    i.p3s_1 = $this$produce;
    return i;
  };
  function parseMultipart$slambda_0($input, $boundaryPrefixed, $maxPartSize, $totalLength, resultContinuation) {
    ...
    var l = function ($this$produce, $completion) {
      return i.x3s($this$produce, $completion);
    };
    l.$arity = 1;
    return l;
  }
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 3;
            this.o3q_1 = new CharArrayBuilder();
            this.o8_1 = 2;
            this.n8_1 = 1;
            suspendResult = parseHeaders(this.n3q_1, this.o3q_1, VOID, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 6;
            var tmp0_safe_receiver = this.a3r_1.p2e('Content-Length');
            var contentLength = tmp0_safe_receiver == null ? null : parseDecLong(tmp0_safe_receiver);
            if (contentLength == null) {
              this.n8_1 = 3;
              suspendResult = readUntil(this.y3q_1, this.x3q_1, this.z3q_1, this.b3r_1, true, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
            } else {
              var containsUpper = this.b3r_1;
              if (compare(new Long(0, 0), contentLength) <= 0 ? compare(contentLength, containsUpper) <= 0 : false) {
                this.n8_1 = 1;
                suspendResult = copyTo(this.y3q_1, this.z3q_1, contentLength, this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
                }
                continue $sm;
                ...
                var tmp_0 = this;
                throwLimitExceeded(contentLength, this.b3r_1);
              }
            }

            break;
          case 1:
            this.e3r_1 = suspendResult;
            this.n8_1 = 2;
            suspendResult = skipIfFoundReadCount(this.y3q_1, this.x3q_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 2:
            var ARGUMENT = suspendResult;
            this.d3r_1 = add(this.e3r_1, ARGUMENT);
            this.n8_1 = 4;
            continue $sm;
          case 3:
            this.d3r_1 = suspendResult;
            this.n8_1 = 4;
            continue $sm;
          case 4:
            this.c3r_1 = this.d3r_1;
            this.n8_1 = 5;
            suspendResult = this.z3q_1.o21(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 3;
            this.n8_1 = 1;
            suspendResult = skipIfFound(this.n3r_1, this.o3r_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            if (suspendResult) {
              var tmp_0 = this;
              tmp_0.p3r_1 = fromInt(this.o3r_1.e1());
              this.n8_1 = 2;
              continue $sm;
            } else {
              var tmp_1 = this;
              tmp_1.p3r_1 = new Long(0, 0);
              this.n8_1 = 2;
              continue $sm;
            }
  ...
  protoOf(Companion).a3q = function (from) {
    var tmp = AsciiCharTree$Companion$build$lambda;
    return this.d3t(from, tmp, AsciiCharTree$Companion$build$lambda_0);
  };
  protoOf(Companion).d3t = function (from, length, charAt) {
    var tmp$ret$0;
    $l$block_0: {
  ...
  function getImpl($this, index) {
    return bufferForIndex($this, index)[index % ensureNotNull($this.g3o_1).length | 0];
  }
  ...
  protoOf(SubSequenceImpl).a = function () {
    return this.g3t_1 - this.f3t_1 | 0;
  };
  protoOf(SubSequenceImpl).b = function (index) {
    var withOffset = index + this.f3t_1 | 0;
    // Inline function 'kotlin.require' call
    if (!(index >= 0)) {
  ...
  protoOf(SubSequenceImpl).c = function (startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= (this.g3t_1 - this.f3t_1 | 0))) {
      var message_1 = 'end should be less than length (' + this.a() + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_1));
    }
    if (startIndex === endIndex)
      return '';
    return new SubSequenceImpl(this.i3t_1, this.f3t_1 + startIndex | 0, this.f3t_1 + endIndex | 0);
  };
  protoOf(SubSequenceImpl).toString = function () {
    var tmp0_elvis_lhs = this.h3t_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this.i3t_1, this.f3t_1, this.g3t_1));
      this.h3t_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  protoOf(SubSequenceImpl).equals = function (other) {
    ...
    if (!(charSequenceLength(other) === this.a()))
      return false;
    return rangeEqualsImpl(this.i3t_1, this.f3t_1, other, 0, this.a());
  };
  protoOf(SubSequenceImpl).hashCode = function () {
    var tmp0_safe_receiver = this.h3t_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this.i3t_1, this.f3t_1, this.g3t_1) : tmp1_elvis_lhs;
  };
  function bufferForIndex($this, index) {
    ...
    return list.d1(index / ensureNotNull($this.g3o_1).length | 0);
  }
  ...
  function nonFullBuffer($this) {
    return $this.j3o_1 === 0 ? appendNewArray($this) : ensureNotNull($this.g3o_1);
  }
  function appendNewArray($this) {
    var newBuffer = $this.e3o_1.j2c();
    var existing = $this.g3o_1;
    $this.g3o_1 = newBuffer;
    $this.j3o_1 = newBuffer.length;
    $this.i3o_1 = false;
    if (!(existing == null)) {
      var tmp0_elvis_lhs = $this.f3o_1;
      var tmp;
      if (tmp0_elvis_lhs == null) {
        // Inline function 'kotlin.also' call
  ...
  function currentPosition($this) {
    return ensureNotNull($this.g3o_1).length - $this.j3o_1 | 0;
  }
  ...
  protoOf(CharArrayBuilder).b = function (index) {
    ...
    // Inline function 'kotlin.require' call
    if (!(index < this.k3o_1)) {
      var message_0 = 'index ' + index + ' is not in range [0, ' + this.k3o_1 + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_0));
    }
  ...
  protoOf(CharArrayBuilder).c = function (startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= this.k3o_1)) {
      var message_1 = 'endIndex (' + endIndex + ') is greater than length (' + this.k3o_1 + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_1));
    }
  ...
  protoOf(CharArrayBuilder).toString = function () {
    ...
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this, 0, this.k3o_1));
      this.h3o_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  protoOf(CharArrayBuilder).equals = function (other) {
    if (!(!(other == null) ? isCharSequence(other) : false))
      return false;
    if (!(this.k3o_1 === charSequenceLength(other)))
      return false;
    return rangeEqualsImpl(this, 0, other, 0, this.k3o_1);
  };
  protoOf(CharArrayBuilder).hashCode = function () {
    var tmp0_safe_receiver = this.h3o_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this, 0, this.k3o_1) : tmp1_elvis_lhs;
  };
  protoOf(CharArrayBuilder).s = function (value) {
    nonFullBuffer(this)[ensureNotNull(this.g3o_1).length - this.j3o_1 | 0] = value;
    this.h3o_1 = null;
    this.j3o_1 = this.j3o_1 - 1 | 0;
    this.k3o_1 = this.k3o_1 + 1 | 0;
    return this;
  };
  protoOf(CharArrayBuilder).ac = function (value, startIndex, endIndex) {
    ...
    while (current < endIndex) {
      ...
      var offset = buffer.length - this.j3o_1 | 0;
      ...
      this.j3o_1 = this.j3o_1 - bytesToCopy | 0;
    }
    this.h3o_1 = null;
    this.k3o_1 = this.k3o_1 + (endIndex - startIndex | 0) | 0;
    return this;
  };
  ...
  protoOf(CharArrayBuilder).r2y = function () {
    var list = this.f3o_1;
    if (!(list == null)) {
      this.g3o_1 = null;
      var inductionVariable = 0;
      ...
      if (inductionVariable < last)
        do {
          var i = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          this.e3o_1.k2c(list.d1(i));
        }
         while (inductionVariable < last);
    } else {
      var tmp0_safe_receiver = this.g3o_1;
      if (tmp0_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
        this.e3o_1.k2c(tmp0_safe_receiver);
      }
      this.g3o_1 = null;
    }
    this.i3o_1 = true;
  ...
  function DefaultHttpMethods$lambda(it) {
    _init_properties_Chars_kt__d3i39x();
    return it.u2r_1.length;
  }
  function DefaultHttpMethods$lambda_0(m, idx) {
    _init_properties_Chars_kt__d3i39x();
    return new Char(charCodeAt(m.u2r_1, idx));
  }
  ...
  function _init_properties_Chars_kt__d3i39x() {
    if (!properties_initialized_Chars_kt_phjfhp) {
      ...
      var tmp_0 = Companion_getInstance_0().t2r_1;
      var tmp_1 = DefaultHttpMethods$lambda;
      DefaultHttpMethods = tmp.d3t(tmp_0, tmp_1, DefaultHttpMethods$lambda_0);
  ...
  protoOf(MutableRange).toString = function () {
    return 'MutableRange(start=' + this.y3p_1 + ', end=' + this.z3p_1 + ')';
  };
