(function (factory) {
  ...
  var sequence = kotlin_kotlin.$_$.mc;
  ...
  function CIOMultipartDataBase(coroutineContext, channel, contentType, contentLength, formFieldLimit) {
    ...
    this.e3b_1 = coroutineContext;
    this.f3b_1 = null;
    this.g3b_1 = parseMultipart(this, channel, contentType, contentLength, formFieldLimit);
  }
  protoOf(CIOMultipartDataBase).j1d = function () {
    return this.e3b_1;
  };
  ...
  function thresholdReached($this) {
    return $this.i3b_1 >= $this.j3b_1 * 0.75;
  }
  function resize($this) {
    var prevSize = $this.i3b_1;
    var prevData = $this.k3b_1;
    $this.i3b_1 = 0;
    $this.j3b_1 = imul($this.j3b_1, 2) | 128;
    var tmp = $this;
    // Inline function 'kotlin.apply' call
    var this_0 = get_HeadersDataPool().g29();
    this_0.n3b(imul(prevData.m3b(), 2) | 1);
    tmp.k3b_1 = this_0;
    var _iterator__ex2g4s = prevData.o3b().t();
    while (_iterator__ex2g4s.u()) {
      var headerOffset = _iterator__ex2g4s.v();
      $this.q3b(prevData.p3b(headerOffset + 1 | 0), prevData.p3b(headerOffset + 2 | 0), prevData.p3b(headerOffset + 3 | 0), prevData.p3b(headerOffset + 4 | 0));
    }
    get_HeadersDataPool().h29(prevData);
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.require' call
    if (!(prevSize === $this.i3b_1)) {
      var message = 'Failed requirement.';
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
  }
  function headerHasName($this, name, headerOffset) {
    var nameStartIndex = $this.k3b_1.p3b(headerOffset + 1 | 0);
    var nameEndIndex = $this.k3b_1.p3b(headerOffset + 2 | 0);
    return equalsLowerCase($this.h3b_1, nameStartIndex, nameEndIndex, name);
  }
  function HttpHeadersMap(builder) {
    this.h3b_1 = builder;
    this.i3b_1 = 0;
    this.j3b_1 = 0;
    this.k3b_1 = get_HeadersDataPool().g29();
  }
  protoOf(HttpHeadersMap).h2a = function (name) {
    if (this.i3b_1 === 0)
      return null;
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(name);
    var hash = abs(this_0);
    var headerIndex = hash % this.j3b_1 | 0;
    while (!(this.k3b_1.p3b(imul(headerIndex, 6) + 0 | 0) === -1)) {
      if (headerHasName(this, name, imul(headerIndex, 6))) {
        return this.r3b(imul(headerIndex, 6));
      }
      headerIndex = (headerIndex + 1 | 0) % this.j3b_1 | 0;
    }
    return null;
  };
  protoOf(HttpHeadersMap).s3b = function () {
    return this.k3b_1.o3b();
  };
  protoOf(HttpHeadersMap).q3b = function (nameStartIndex, nameEndIndex, valueStartIndex, valueEndIndex) {
    if (thresholdReached(this)) {
      resize(this);
    }
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(this.h3b_1, nameStartIndex, nameEndIndex);
    var hash = abs(this_0);
    var name = this.h3b_1.c(nameStartIndex, nameEndIndex);
    var headerIndex = hash % this.j3b_1 | 0;
    ...
    this.k3b_1.a3c(headerOffset + 0 | 0, hash);
    this.k3b_1.a3c(headerOffset + 1 | 0, nameStartIndex);
    this.k3b_1.a3c(headerOffset + 2 | 0, nameEndIndex);
    this.k3b_1.a3c(headerOffset + 3 | 0, valueStartIndex);
    this.k3b_1.a3c(headerOffset + 4 | 0, valueEndIndex);
    this.k3b_1.a3c(headerOffset + 5 | 0, -1);
    if (!(sameNameHeaderIndex === -1)) {
      this.k3b_1.a3c(imul(sameNameHeaderIndex, 6) + 5 | 0, headerIndex);
    }
    this.i3b_1 = this.i3b_1 + 1 | 0;
  };
  protoOf(HttpHeadersMap).b3c = function (headerOffset) {
    var nameStartIndex = this.k3b_1.p3b(headerOffset + 1 | 0);
    var nameEndIndex = this.k3b_1.p3b(headerOffset + 2 | 0);
    return this.h3b_1.c(nameStartIndex, nameEndIndex);
  };
  protoOf(HttpHeadersMap).r3b = function (headerOffset) {
    var valueStartIndex = this.k3b_1.p3b(headerOffset + 3 | 0);
    var valueEndIndex = this.k3b_1.p3b(headerOffset + 4 | 0);
    return this.h3b_1.c(valueStartIndex, valueEndIndex);
  };
  protoOf(HttpHeadersMap).r2u = function () {
    this.i3b_1 = 0;
    this.j3b_1 = 0;
    get_HeadersDataPool().h29(this.k3b_1);
    this.k3b_1 = get_HeadersDataPool().g29();
  };
  ...
  protoOf(HeadersData$headersStarts$slambda).q3c = function ($this$sequence, $completion) {
    var tmp = this.r3c($this$sequence, $completion);
    tmp.p8_1 = Unit_instance;
    tmp.q8_1 = null;
    return tmp.v8();
  };
  protoOf(HeadersData$headersStarts$slambda).i9 = function (p1, $completion) {
    return this.q3c(p1 instanceof SequenceScope ? p1 : THROW_CCE(), $completion);
  };
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            this.o3c_1 = this.p3c_1.v();
            this.n3c_1 = 0;
            this.n8_1 = 2;
            continue $sm;
          case 2:
            if (!(this.n3c_1 < this.o3c_1.length)) {
              this.n8_1 = 5;
              continue $sm;
            }

            if (!(this.k3c_1.p3b(this.m3c_1 + 0 | 0) === -1)) {
              this.n8_1 = 3;
              suspendResult = this.l3c_1.ag(this.m3c_1, this);
          ...
          case 3:
            ...
            continue $sm;
          case 4:
            this.n3c_1 = this.n3c_1 + 6 | 0;
            this.m3c_1 = this.m3c_1 + 6 | 0;
            this.n8_1 = 2;
            continue $sm;
          case 5:
            this.n8_1 = 1;
  ...
  protoOf(HeadersData$headersStarts$slambda).r3c = function ($this$sequence, completion) {
    var i = new HeadersData$headersStarts$slambda(this.k3c_1, completion);
    i.l3c_1 = $this$sequence;
    return i;
  };
  function HeadersData$headersStarts$slambda_0(this$0, resultContinuation) {
    ...
    var l = function ($this$sequence, $completion) {
      return i.q3c($this$sequence, $completion);
    };
    l.$arity = 1;
    return l;
  }
  function HeadersData() {
    ...
    tmp.l3b_1 = ArrayList_init_$Create$();
  }
  protoOf(HeadersData).m3b = function () {
    return this.l3b_1.e1();
  };
  protoOf(HeadersData).n3b = function (subArraysCount) {
    ...
    if (inductionVariable < subArraysCount)
      do {
        ...
        this.l3b_1.b1(get_IntArrayPool().g29());
      }
       while (inductionVariable < subArraysCount);
  };
  protoOf(HeadersData).p3b = function (index) {
    return this.l3b_1.d1(index / 768 | 0)[index % 768 | 0];
  };
  protoOf(HeadersData).a3c = function (index, value) {
    this.l3b_1.d1(index / 768 | 0)[index % 768 | 0] = value;
  };
  protoOf(HeadersData).o3b = function () {
    return sequence(HeadersData$headersStarts$slambda_0(this, null));
  };
  protoOf(HeadersData).r2u = function () {
    var _iterator__ex2g4s = this.l3b_1.t();
    while (_iterator__ex2g4s.u()) {
      var array = _iterator__ex2g4s.v();
      get_IntArrayPool().h29(array);
    }
    this.l3b_1.y2();
  };
  function dumpTo(_this__u8e3s4, indent, out) {
    _init_properties_HttpHeadersMap_kt__hwatby();
    var _iterator__ex2g4s = _this__u8e3s4.s3b().t();
    while (_iterator__ex2g4s.u()) {
      var offset = _iterator__ex2g4s.v();
      out.c1(indent);
      out.c1(_this__u8e3s4.b3c(offset));
      out.c1(' => ');
      out.c1(_this__u8e3s4.r3b(offset));
      out.c1('\n');
    }
  }
  ...
  protoOf(IntArrayPool$1).z28 = function () {
    var tmp = 0;
  ...
  protoOf(IntArrayPool$1).v3c = function (instance) {
    fill(instance, -1);
    return protoOf(DefaultPool).e29.call(this, instance);
  };
  protoOf(IntArrayPool$1).e29 = function (instance) {
    return this.v3c(isIntArray(instance) ? instance : THROW_CCE());
  };
  function HeadersDataPool$1() {
    DefaultPool.call(this, 1000);
  }
  protoOf(HeadersDataPool$1).z28 = function () {
    return new HeadersData();
  };
  protoOf(HeadersDataPool$1).z3c = function (instance) {
    instance.r2u();
    return protoOf(DefaultPool).e29.call(this, instance);
  };
  protoOf(HeadersDataPool$1).e29 = function (instance) {
    return this.z3c(instance instanceof HeadersData ? instance : THROW_CCE());
  };
  ...
  function parseHeaderName(text, range) {
    _init_properties_HttpParser_kt__gbdom1();
    var index = range.n3d_1;
    var end = range.o3d_1;
    while (index < end) {
      var ch = text.b(index);
      if (ch === _Char___init__impl__6a9atx(58) && !(index === range.n3d_1)) {
        range.n3d_1 = index + 1 | 0;
        return index;
      }
      if (isDelimiter(ch)) {
        parseHeaderNameFailed(text, index, range.n3d_1, ch);
      }
      index = index + 1 | 0;
    }
  ...
  function parseHeaderValue(text, range) {
    ...
    range.n3d_1 = valueStart;
    range.o3d_1 = valueLastIndex + 1 | 0;
  }
  ...
  function noColonFound(text, range) {
    _init_properties_HttpParser_kt__gbdom1();
    var tmp2 = range.n3d_1;
    // Inline function 'kotlin.text.substring' call
    var endIndex = range.o3d_1;
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 7;
            this.l3d_1 = new HttpHeadersMap(this.j3d_1);
            this.o8_1 = 6;
            this.n8_1 = 1;
            continue $sm;
          case 1:
            ...
            this.n8_1 = 2;
            suspendResult = readUTF8LineTo(this.i3d_1, this.j3d_1, 8192, get_httpLineEndings(), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 3:
            this.k3d_1.o3d_1 = this.j3d_1.z3b_1;
            this.m3d_1 = this.k3d_1.o3d_1 - this.k3d_1.n3d_1 | 0;
            if (this.m3d_1 === 0) {
              this.n8_1 = 5;
              continue $sm;
            } else {
          ...
          case 4:
            ...
            var nameStart = this.k3d_1.n3d_1;
            var nameEnd = parseHeaderName(this.j3d_1, this.k3d_1);
            var headerEnd = this.k3d_1.o3d_1;
            parseHeaderValue(this.j3d_1, this.k3d_1);
            var valueStart = this.k3d_1.n3d_1;
            var valueEnd = this.k3d_1.o3d_1;
            this.k3d_1.n3d_1 = headerEnd;
            this.l3d_1.q3b(nameStart, nameEnd, valueStart, valueEnd);
            this.n8_1 = 1;
            continue $sm;
          case 5:
            var host = this.l3d_1.h2a(HttpHeaders_getInstance().m2k_1);
            if (!(host == null)) {
  ...
  function _init_properties_HttpParser_kt__gbdom1() {
    if (!properties_initialized_HttpParser_kt_uedryv) {
      ...
      httpLineEndings = LineEndingMode__plus_impl_ttpz2j(Companion_getInstance().e24_1, Companion_getInstance().d24_1);
      versions = Companion_instance.p3d(listOf(['HTTP/1.0', 'HTTP/1.1']));
    }
  }
  function get_CrLf() {
  ...
  function parseMultipart(_this__u8e3s4, input, contentType, contentLength, maxPartSize) {
    ...
    _init_properties_Multipart_kt__ato98a();
    if (!MultiPart_getInstance().h2i(contentType)) {
  ...
  function parseMultipart$slambda$slambda($firstBoundary, $countedInput, resultContinuation) {
    this.n3f_1 = $firstBoundary;
    this.o3f_1 = $countedInput;
    CoroutineImpl.call(this, resultContinuation);
  }
  protoOf(parseMultipart$slambda$slambda).q3f = function ($this$writer, $completion) {
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 3;
            this.n8_1 = 1;
            suspendResult = parsePreambleImpl(this.n3f_1, this.o3f_1, this.p3f_1.q26_1, new Long(8193, 0), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            this.n8_1 = 2;
            suspendResult = this.p3f_1.q26_1.j1z(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(parseMultipart$slambda$slambda).r3f = function ($this$writer, completion) {
    var i = new parseMultipart$slambda$slambda(this.n3f_1, this.o3f_1, completion);
    i.p3f_1 = $this$writer;
    return i;
  };
  ...
  function parseMultipart$slambda($input, $boundaryPrefixed, $maxPartSize, $totalLength, resultContinuation) {
    this.a3g_1 = $input;
    this.b3g_1 = $boundaryPrefixed;
    this.c3g_1 = $maxPartSize;
    this.d3g_1 = $totalLength;
    CoroutineImpl.call(this, resultContinuation);
  }
  protoOf(parseMultipart$slambda).m3g = function ($this$produce, $completion) {
    var tmp = this.n3g($this$produce, $completion);
    tmp.p8_1 = Unit_instance;
    tmp.q8_1 = null;
    return tmp.v8();
  };
  protoOf(parseMultipart$slambda).i9 = function (p1, $completion) {
    return this.m3g((!(p1 == null) ? isInterface(p1, ProducerScope) : false) ? p1 : THROW_CCE(), $completion);
  };
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 25;
            this.f3g_1 = counted(this.a3g_1);
            this.g3g_1 = this.f3g_1.n28();
            this.k3g_1 = this.b3g_1.q19(get_PrefixString().e1());
            this.n8_1 = 1;
            suspendResult = readRemaining(writer(this.e3g_1, VOID, VOID, parseMultipart$slambda$slambda_0(this.k3g_1, this.f3g_1, null)).o26_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            ...
            if (compare(get_remaining(preambleData), new Long(0, 0)) > 0) {
              this.n8_1 = 2;
              suspendResult = this.e3g_1.v1s(new Preamble(preambleData), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 4:
            if (!this.f3g_1.g1z()) {
              this.n8_1 = 5;
              suspendResult = skipIfFound(this.f3g_1, get_PrefixString(), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 6:
            ...
            this.n8_1 = 7;
            suspendResult = skipIfFound(this.f3g_1, get_CrLf(), this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 7:
            this.n8_1 = 8;
            suspendResult = skipIfFound(this.f3g_1, this.k3g_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 9:
            this.h3g_1 = new ByteChannel();
            this.j3g_1 = CompletableDeferred();
            var part = new MultipartPart(this.j3g_1, this.h3g_1);
            this.n8_1 = 10;
            suspendResult = this.e3g_1.v1s(part, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 10:
            ...
            this.o8_1 = 14;
            this.n8_1 = 11;
            suspendResult = parsePartHeadersImpl(this.f3g_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 11:
            ...
            if (!this.j3g_1.j1k(this.i3g_1)) {
              this.i3g_1.r2u();
              throw CancellationException_init_$Create$('Multipart processing has been cancelled');
            }

            this.n8_1 = 12;
            suspendResult = parsePartBodyImpl(this.b3g_1, this.f3g_1, this.h3g_1, this.i3g_1, this.c3g_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 14:
            ...
            if (tmp_0 instanceof Error) {
              var cause = this.q8_1;
              if (this.j3g_1.k1k(cause)) {
                var tmp0_safe_receiver = this.i3g_1;
                if (tmp0_safe_receiver == null)
                  null;
                else {
                  tmp0_safe_receiver.r2u();
                }
              }
              close(this.h3g_1, cause);
              throw cause;
            } else {
              throw this.q8_1;
            }
          ...
          case 17:
            if (!(this.d3g_1 == null)) {
              var consumedExceptEpilogue = subtract(this.f3g_1.n28(), this.g3g_1);
              var size = subtract(this.d3g_1, consumedExceptEpilogue);
              ...
              if (compare(size, new Long(0, 0)) > 0) {
                this.n8_1 = 21;
                suspendResult = readPacket(this.f3g_1, convertToInt(size), this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
                }
                continue $sm;
              ...
              this.n8_1 = 18;
              suspendResult = readRemaining(this.f3g_1, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 18:
            ...
            if (!epilogueContent.y19()) {
              this.n8_1 = 19;
              suspendResult = this.e3g_1.v1s(new Epilogue(epilogueContent), this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
          ...
          case 21:
            ...
            this.n8_1 = 22;
            suspendResult = this.e3g_1.v1s(ARGUMENT_0, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  protoOf(parseMultipart$slambda).n3g = function ($this$produce, completion) {
    var i = new parseMultipart$slambda(this.a3g_1, this.b3g_1, this.c3g_1, this.d3g_1, completion);
    i.e3g_1 = $this$produce;
    return i;
  };
  function parseMultipart$slambda_0($input, $boundaryPrefixed, $maxPartSize, $totalLength, resultContinuation) {
    ...
    var l = function ($this$produce, $completion) {
      return i.m3g($this$produce, $completion);
    };
    l.$arity = 1;
    return l;
  }
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 3;
            this.d3e_1 = new CharArrayBuilder();
            this.o8_1 = 2;
            this.n8_1 = 1;
            suspendResult = parseHeaders(this.c3e_1, this.d3e_1, VOID, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
    ...
    $sm: do
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 6;
            var tmp0_safe_receiver = this.p3e_1.h2a('Content-Length');
            var contentLength = tmp0_safe_receiver == null ? null : parseDecLong(tmp0_safe_receiver);
            if (contentLength == null) {
              this.n8_1 = 3;
              suspendResult = readUntil(this.n3e_1, this.m3e_1, this.o3e_1, this.q3e_1, true, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
            } else {
              var containsUpper = this.q3e_1;
              if (compare(new Long(0, 0), contentLength) <= 0 ? compare(contentLength, containsUpper) <= 0 : false) {
                this.n8_1 = 1;
                suspendResult = copyTo(this.n3e_1, this.o3e_1, contentLength, this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
                }
                continue $sm;
                ...
                var tmp_0 = this;
                throwLimitExceeded(contentLength, this.q3e_1);
              }
            }
          ...
          case 1:
            ...
            this.n8_1 = 2;
            suspendResult = skipIfFoundReadCount(this.n3e_1, this.m3e_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 2:
            var ARGUMENT = suspendResult;
            this.s3e_1 = add(this.t3e_1, ARGUMENT);
            this.n8_1 = 4;
            continue $sm;
          case 3:
            ...
            continue $sm;
          case 4:
            this.r3e_1 = this.s3e_1;
            this.n8_1 = 5;
            suspendResult = this.o3e_1.x1y(this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            this.o8_1 = 3;
            this.n8_1 = 1;
            suspendResult = skipIfFound(this.c3f_1, this.d3f_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
          ...
          case 1:
            if (suspendResult) {
              var tmp_0 = this;
              tmp_0.e3f_1 = fromInt(this.d3f_1.e1());
              this.n8_1 = 2;
              continue $sm;
            } else {
              var tmp_1 = this;
              tmp_1.e3f_1 = new Long(0, 0);
              this.n8_1 = 2;
              continue $sm;
            }
  ...
  protoOf(Companion).p3d = function (from) {
    var tmp = AsciiCharTree$Companion$build$lambda;
    return this.s3g(from, tmp, AsciiCharTree$Companion$build$lambda_0);
  };
  protoOf(Companion).s3g = function (from, length, charAt) {
    var tmp$ret$0;
    $l$block_0: {
  ...
  function getImpl($this, index) {
    return bufferForIndex($this, index)[index % ensureNotNull($this.v3b_1).length | 0];
  }
  ...
  protoOf(SubSequenceImpl).a = function () {
    return this.v3g_1 - this.u3g_1 | 0;
  };
  protoOf(SubSequenceImpl).b = function (index) {
    var withOffset = index + this.u3g_1 | 0;
    // Inline function 'kotlin.require' call
    if (!(index >= 0)) {
  ...
  protoOf(SubSequenceImpl).c = function (startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= (this.v3g_1 - this.u3g_1 | 0))) {
      var message_1 = 'end should be less than length (' + this.a() + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_1));
    }
    if (startIndex === endIndex)
      return '';
    return new SubSequenceImpl(this.x3g_1, this.u3g_1 + startIndex | 0, this.u3g_1 + endIndex | 0);
  };
  protoOf(SubSequenceImpl).toString = function () {
    ...
    if (tmp0_elvis_lhs == null) {
      ...
      var this_0 = toString(copy(this.x3g_1, this.u3g_1, this.v3g_1));
      this.w3g_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  protoOf(SubSequenceImpl).equals = function (other) {
    ...
    if (!(charSequenceLength(other) === this.a()))
      return false;
    return rangeEqualsImpl(this.x3g_1, this.u3g_1, other, 0, this.a());
  };
  protoOf(SubSequenceImpl).hashCode = function () {
    var tmp0_safe_receiver = this.w3g_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this.x3g_1, this.u3g_1, this.v3g_1) : tmp1_elvis_lhs;
  };
  function bufferForIndex($this, index) {
    ...
    return list.d1(index / ensureNotNull($this.v3b_1).length | 0);
  }
  ...
  function nonFullBuffer($this) {
    return $this.y3b_1 === 0 ? appendNewArray($this) : ensureNotNull($this.v3b_1);
  }
  function appendNewArray($this) {
    var newBuffer = $this.t3b_1.g29();
    var existing = $this.v3b_1;
    $this.v3b_1 = newBuffer;
    $this.y3b_1 = newBuffer.length;
    $this.x3b_1 = false;
    if (!(existing == null)) {
  ...
  function currentPosition($this) {
    return ensureNotNull($this.v3b_1).length - $this.y3b_1 | 0;
  }
  ...
  protoOf(CharArrayBuilder).b = function (index) {
    ...
    // Inline function 'kotlin.require' call
    if (!(index < this.z3b_1)) {
      var message_0 = 'index ' + index + ' is not in range [0, ' + this.z3b_1 + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_0));
    }
  ...
  protoOf(CharArrayBuilder).c = function (startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= this.z3b_1)) {
      var message_1 = 'endIndex (' + endIndex + ') is greater than length (' + this.z3b_1 + ')';
      throw IllegalArgumentException_init_$Create$(toString(message_1));
    }
    return new SubSequenceImpl(this, startIndex, endIndex);
  };
  protoOf(CharArrayBuilder).toString = function () {
    var tmp0_elvis_lhs = this.w3b_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this, 0, this.z3b_1));
      this.w3b_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  protoOf(CharArrayBuilder).equals = function (other) {
    if (!(!(other == null) ? isCharSequence(other) : false))
      return false;
    if (!(this.z3b_1 === charSequenceLength(other)))
      return false;
    return rangeEqualsImpl(this, 0, other, 0, this.z3b_1);
  };
  protoOf(CharArrayBuilder).hashCode = function () {
    var tmp0_safe_receiver = this.w3b_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this, 0, this.z3b_1) : tmp1_elvis_lhs;
  };
  protoOf(CharArrayBuilder).s = function (value) {
    nonFullBuffer(this)[ensureNotNull(this.v3b_1).length - this.y3b_1 | 0] = value;
    this.w3b_1 = null;
    this.y3b_1 = this.y3b_1 - 1 | 0;
    this.z3b_1 = this.z3b_1 + 1 | 0;
    return this;
  };
  protoOf(CharArrayBuilder).xb = function (value, startIndex, endIndex) {
    if (value == null)
      return this;
    var current = startIndex;
    while (current < endIndex) {
      var buffer = nonFullBuffer(this);
      var offset = buffer.length - this.y3b_1 | 0;
      ...
      this.y3b_1 = this.y3b_1 - bytesToCopy | 0;
    }
    this.w3b_1 = null;
    this.z3b_1 = this.z3b_1 + (endIndex - startIndex | 0) | 0;
    return this;
  };
  protoOf(CharArrayBuilder).c1 = function (value) {
    if (value == null)
      return this;
    return this.xb(value, 0, charSequenceLength(value));
  };
  protoOf(CharArrayBuilder).r2u = function () {
    var list = this.u3b_1;
    if (!(list == null)) {
      this.v3b_1 = null;
      var inductionVariable = 0;
      ...
      if (tmp0_safe_receiver == null)
        ...
        // Inline function 'kotlin.let' call
        this.t3b_1.h29(tmp0_safe_receiver);
      }
      this.v3b_1 = null;
    }
    this.x3b_1 = true;
  ...
  protoOf(CharArrayPool$1).g29 = function () {
    return charArray(2048);
  };
  function CharArrayPool$2() {
    DefaultPool.call(this, 4096);
  }
  protoOf(CharArrayPool$2).z28 = function () {
    return charArray(2048);
  };
  ...
  function DefaultHttpMethods$lambda(it) {
    _init_properties_Chars_kt__d3i39x();
    return it.u2n_1.length;
  }
  function DefaultHttpMethods$lambda_0(m, idx) {
    _init_properties_Chars_kt__d3i39x();
    return new Char(charCodeAt(m.u2n_1, idx));
  }
  ...
  function _init_properties_Chars_kt__d3i39x() {
    if (!properties_initialized_Chars_kt_phjfhp) {
      ...
      var tmp_0 = Companion_getInstance_0().t2n_1;
      var tmp_1 = DefaultHttpMethods$lambda;
      DefaultHttpMethods = tmp.s3g(tmp_0, tmp_1, DefaultHttpMethods$lambda_0);
  ...
  protoOf(MutableRange).toString = function () {
    return 'MutableRange(start=' + this.n3d_1 + ', end=' + this.o3d_1 + ')';
  };
