(function (factory) {
  ...
  function Digest_init_$Init$(algorithm, blockSize, digestLength, $this) {
    ...
    tmp.x3e_1 = _Buffer___init__impl__mrnqm7(new Int8Array(blockSize));
    $this.v3e_1 = algorithm;
    $this.w3e_1 = digestLength;
    $this.y3e_1 = 0;
    return $this;
  }
  protoOf(Digest).z3e = function () {
    return this.w3e_1;
  };
  protoOf(Digest).a3f = function () {
    return this.v3e_1;
  };
  protoOf(Digest).b3f = function (input) {
    // Inline function 'org.kotlincrypto.core.digest.internal.commonDigest' call
    var this_0 = this.x3e_1;
    // Inline function 'kotlin.contracts.contract' call
    var p2 = input.length;
    this.c3f(input, 0, p2);
    // Inline function 'org.kotlincrypto.core.digest.internal.commonDigest' call
    var bufPos = this.y3e_1;
    // Inline function 'kotlin.contracts.contract' call
    fill(_Buffer___get_value__impl__xxr8tn(this_0), 0, bufPos);
    var p0 = _Buffer___get_value__impl__xxr8tn(this_0);
    var digest = this.d3f(p0, bufPos);
  ...
  protoOf(Digest).c3f = function (input, offset, len) {
    var tmp0 = this.x3e_1;
    var tmp8 = this.y3e_1;
    $l$block: {
  ...
  protoOf(Digest).equals = function (other) {
    ...
    if (other instanceof Digest) {
      tmp = equals(other.x3e_1, this.x3e_1);
    } else {
      tmp = false;
    }
    return tmp;
