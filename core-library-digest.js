(function (factory) {
  ...
  function Digest_init_$Init$(algorithm, blockSize, digestLength, $this) {
    ...
    tmp.k38_1 = _Buffer___init__impl__mrnqm7(new Int8Array(blockSize));
    $this.i38_1 = algorithm;
    $this.j38_1 = digestLength;
    $this.l38_1 = 0;
    return $this;
  }
  protoOf(Digest).m38 = function () {
    return this.j38_1;
  };
  protoOf(Digest).n38 = function () {
    return this.i38_1;
  };
  protoOf(Digest).o38 = function (input) {
    // Inline function 'org.kotlincrypto.core.digest.internal.commonDigest' call
    var this_0 = this.k38_1;
    // Inline function 'kotlin.contracts.contract' call
    var p2 = input.length;
    this.p38(input, 0, p2);
    // Inline function 'org.kotlincrypto.core.digest.internal.commonDigest' call
    var bufPos = this.l38_1;
    // Inline function 'kotlin.contracts.contract' call
    fill(_Buffer___get_value__impl__xxr8tn(this_0), 0, bufPos);
    var p0 = _Buffer___get_value__impl__xxr8tn(this_0);
    var digest = this.q38(p0, bufPos);
  ...
  protoOf(Digest).p38 = function (input, offset, len) {
    var tmp0 = this.k38_1;
    var tmp8 = this.l38_1;
    $l$block: {
  ...
  protoOf(Digest).equals = function (other) {
    ...
    if (other instanceof Digest) {
      tmp = equals(other.k38_1, this.k38_1);
    } else {
      tmp = false;
    }
    return tmp;
