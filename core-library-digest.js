(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof this['core-library-common'] === 'undefined') {
    ...
    root['core-library-digest'] = factory(typeof this['core-library-digest'] === 'undefined' ? {} : this['core-library-digest'], this['kotlin-kotlin-stdlib'], this['core-library-common']);
  }
}(this, function (_, kotlin_kotlin, kotlin_org_kotlincrypto_core_common) {
  'use strict';
  ...
  setMetadataFor(DigestState, 'DigestState', classMeta);
  setMetadataFor(RealState, 'RealState', classMeta, DigestState);
  setMetadataFor(Companion, 'Companion', objectMeta);
  setMetadataFor(DigestDelegate, 'DigestDelegate', classMeta, VOID, [Copyable, Resettable]);
  setMetadataFor(Digest, 'Digest', classMeta, VOID, [Algorithm, Copyable, Resettable, Updatable]);
  //endregion
  function commonCheckArgs(_this__u8e3s4, offset, len) {
    ...
    if ((offset < 0 ? true : len < 0) ? true : offset > (_this__u8e3s4.length - len | 0))
  ...
  protoOf(Companion).instance_ul3uoo_k$ = function (state, compress, digest, resetDigest) {
    var tmp = (state instanceof RealState ? state : THROW_CCE()).get_algorithm_c8rufa_k$();
    var tmp_0 = state.get_blockSize_mxxr45_k$();
    var tmp_1 = state.get_digestLength_64702b_k$();
    // Inline function 'kotlin.collections.copyOf' call
    // Inline function 'kotlin.js.asDynamic' call
  ...
  protoOf(Companion).instance_9fr4ig_k$ = function (algorithm, blockSize, digestLength, compress, digest, resetDigest) {
  ...
  protoOf(DigestDelegate).get_algorithm_c8rufa_k$ = function () {
    return this.algorithm_1;
  };
  protoOf(DigestDelegate).get_blockSize_mxxr45_k$ = function () {
    return this.blockSize_1;
  };
  protoOf(DigestDelegate).get_digestLength_64702b_k$ = function () {
    return this.digestLength_1;
  };
  protoOf(DigestDelegate).update_cpywm7_k$ = function (input) {
  ...
  protoOf(DigestDelegate).update_6igkux_k$ = function (input, offset, len) {
    var i = offset;
    var remaining = len;
    while (!(this.bufferOffs_1 === 0) ? remaining > 0 : false) {
      var tmp0 = i;
      i = tmp0 + 1 | 0;
      this.update_cpywm7_k$(input[tmp0]);
    ...
    $l$loop: while (true) {
      ...
      var tmp3 = i;
      i = tmp3 + 1 | 0;
      this.update_cpywm7_k$(input[tmp3]);
    }
  };
  protoOf(DigestDelegate).digest_m0ziv0_k$ = function () {
  ...
  protoOf(DigestState).get_algorithm_c8rufa_k$ = function () {
    return this.algorithm_1;
  };
  protoOf(DigestState).get_blockSize_mxxr45_k$ = function () {
    return this.blockSize_1;
  };
  protoOf(DigestState).get_digestLength_64702b_k$ = function () {
    return this.digestLength_1;
  };
  ...
  function Digest_init_$Init$_0(state, $this) {
    Digest.call($this, state.get_algorithm_c8rufa_k$(), state.get_blockSize_mxxr45_k$(), state.get_digestLength_64702b_k$(), state);
    return $this;
  }
  ...
  function Digest(algorithm, blockSize, digestLength, state) {
    ...
    if (!(state == null)) {
      ...
      tmp_0 = tmp_1.instance_ul3uoo_k$(state, tmp_2, tmp_3, Digest$resetDigest$ref(this));
    } else {
      var tmp_4 = Companion_getInstance();
      var tmp_5 = Digest$compress$ref_0(this);
      var tmp_6 = Digest$digest$ref_0(this);
      tmp_0 = tmp_4.instance_9fr4ig_k$(algorithm, blockSize, digestLength, tmp_5, tmp_6, Digest$resetDigest$ref_0(this));
    }
    tmp.delegate_1 = tmp_0;
  }
  protoOf(Digest).algorithm_3q917z_k$ = function () {
    return this.delegate_1.get_algorithm_c8rufa_k$();
  };
  protoOf(Digest).blockSize_efexwu_k$ = function () {
    return this.delegate_1.get_blockSize_mxxr45_k$();
  };
  protoOf(Digest).digestLength_1kmpca_k$ = function () {
    return this.delegate_1.get_digestLength_64702b_k$();
  };
  ...
  protoOf(Digest).update_6igkux_k$ = function (input, offset, len) {
    ...
    if ((input.length - offset | 0) < len)
      throw IllegalArgumentException_init_$Create$('Input too short');
    if ((offset < 0 ? true : len < 0) ? true : offset > (input.length - len | 0))
      throw IndexOutOfBoundsException_init_$Create$();
    this.updateDigest_nt66yl_k$(input, offset, len);
  };
  protoOf(Digest).digest_m0ziv0_k$ = function () {
    return this.delegate_1.digest_m0ziv0_k$();
  };
  ...
  protoOf(Digest).updateDigest_xbmjnf_k$ = function (input) {
    this.delegate_1.update_cpywm7_k$(input);
  };
  protoOf(Digest).updateDigest_nt66yl_k$ = function (input, offset, len) {
    this.delegate_1.update_6igkux_k$(input, offset, len);
  };
