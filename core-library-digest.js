(function (factory) {
  ...
  function Digest_init_$Init$(algorithm, blockSize, digestLength, $this) {
    ...
    tmp.k37_1 = _Buffer___init__impl__mrnqm7(new Int8Array(blockSize));
    $this.i37_1 = algorithm;
    $this.j37_1 = digestLength;
    $this.l37_1 = 0;
    return $this;
  }
  protoOf(Digest).m37 = function () {
    return this.j37_1;
  };
  protoOf(Digest).n37 = function () {
    return this.i37_1;
  };
  protoOf(Digest).o37 = function (input) {
  ...
  protoOf(Digest).p37 = function (input, offset, len) {
    var tmp0 = this.k37_1;
    var tmp8 = this.l37_1;
    $l$block: {
  ...
  protoOf(Digest).equals = function (other) {
    ...
    if (other instanceof Digest) {
      tmp = equals(other.k37_1, this.k37_1);
    } else {
      tmp = false;
    }
    return tmp;
