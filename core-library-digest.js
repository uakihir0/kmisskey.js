(function (factory) {
  ...
  function Digest_init_$Init$(algorithm, blockSize, digestLength, $this) {
    ...
    tmp.q3e_1 = _Buffer___init__impl__mrnqm7(new Int8Array(blockSize));
    $this.o3e_1 = algorithm;
    $this.p3e_1 = digestLength;
    $this.r3e_1 = 0;
    return $this;
  }
  protoOf(Digest).s3e = function () {
    return this.p3e_1;
  };
  protoOf(Digest).t3e = function () {
    return this.o3e_1;
  };
  protoOf(Digest).u3e = function (input) {
  ...
  protoOf(Digest).v3e = function (input, offset, len) {
    var tmp0 = this.q3e_1;
    var tmp8 = this.r3e_1;
    $l$block: {
  ...
  protoOf(Digest).equals = function (other) {
    ...
    if (other instanceof Digest) {
      tmp = equals(other.q3e_1, this.q3e_1);
    } else {
      tmp = false;
    }
    return tmp;
