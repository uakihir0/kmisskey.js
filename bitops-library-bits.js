(function (factory) {
  ...
  protoOf(Final).mf = function () {
    return this.z37_1;
  };
  protoOf(Final).nf = function () {
    return this.a38_1;
  };
  protoOf(Final).b38 = function () {
    if (this.c38_1)
      return this;
    return new Final(this.z37_1 << 3, this.a38_1 << 3 | (this.z37_1 >>> 29 | 0), true);
  };
  function Final_0() {
  }
  protoOf(Bit32).d38 = function () {
    this.w37_1 = this.w37_1 + this.v37_1 | 0;
    if (this.w37_1 === 0) {
      this.x37_1 = this.x37_1 + 1 | 0;
    }
  };
  protoOf(Bit32).e38 = function (additional) {
    var lo = this.w37_1;
    var hi = this.x37_1;
    var lt0 = lo < 0;
    lo = lo + additional | 0;
  ...
  protoOf(Final_1).hashCode = function () {
    ...
    if (this instanceof Final) {
      ...
      result = imul(result, 31) + this.a38_1 | 0;
    } else {
      if (this instanceof Final_0) {
        result = imul(result, 31) + this.h38_1.hashCode() | 0;
        result = imul(result, 31) + this.i38_1.hashCode() | 0;
      }
    }
  ...
  protoOf(Final_1).toString = function () {
    var tmp;
    if (this instanceof Final) {
      tmp = 'Counter.Bit32.Final[lo=' + this.z37_1 + ', hi=' + this.a38_1 + ']';
    } else {
      if (this instanceof Final_0) {
        tmp = 'Counter.Bit64.Final[lo=' + this.h38_1.toString() + ', hi=' + this.i38_1.toString() + ']';
      } else {
  ...
  protoOf(Counter).hashCode = function () {
    return 527 + hashCode(this.j38_1) | 0;
  };
  protoOf(Counter).toString = function () {
    var tmp;
    if (this instanceof Bit32) {
      tmp = 'Bit32[lo=' + this.w37_1 + ', hi=' + this.x37_1 + ', incrementBy=' + this.v37_1 + ']';
    } else {
      if (this instanceof Bit64) {
        tmp = 'Bit64[lo=' + this.m38_1.toString() + ', hi=' + this.n38_1.toString() + ', incrementBy=' + this.l38_1.toString() + ']';
      } else {
        noWhenBranchMatchedException();
      }
    }
