(function (factory) {
  ...
  protoOf(Final).o3f = function () {
    if (this.p3f_1)
      return this;
    return new Final(this.m3f_1 << 3, this.n3f_1 << 3 | (this.m3f_1 >>> 29 | 0), true);
  };
  function Final_0() {
  }
  protoOf(Bit32).q3f = function () {
    this.j3f_1 = this.j3f_1 + this.i3f_1 | 0;
    if (this.j3f_1 === 0) {
      this.k3f_1 = this.k3f_1 + 1 | 0;
    }
  };
  protoOf(Bit32).r3f = function (additional) {
    var lo = this.j3f_1;
    var hi = this.k3f_1;
    var lt0 = lo < 0;
    lo = lo + additional | 0;
  ...
  protoOf(Final_1).hashCode = function () {
    ...
    if (this instanceof Final) {
      result = imul(result, 31) + this.m3f_1 | 0;
      result = imul(result, 31) + this.n3f_1 | 0;
    } else {
      if (this instanceof Final_0) {
        result = imul(result, 31) + this.u3f_1.hashCode() | 0;
        result = imul(result, 31) + this.v3f_1.hashCode() | 0;
      }
    }
    result = imul(result, 31) + getBooleanHashCode(this.p3f_1) | 0;
    return result;
  };
  protoOf(Final_1).toString = function () {
    var tmp;
    if (this instanceof Final) {
      tmp = 'Counter.Bit32.Final[lo=' + this.m3f_1 + ', hi=' + this.n3f_1 + ']';
    } else {
      if (this instanceof Final_0) {
        tmp = 'Counter.Bit64.Final[lo=' + this.u3f_1.toString() + ', hi=' + this.v3f_1.toString() + ']';
      } else {
  ...
  protoOf(Counter).hashCode = function () {
    return 527 + hashCode(this.w3f_1) | 0;
  };
  protoOf(Counter).toString = function () {
    var tmp;
    if (this instanceof Bit32) {
      tmp = 'Bit32[lo=' + this.j3f_1 + ', hi=' + this.k3f_1 + ', incrementBy=' + this.i3f_1 + ']';
    } else {
      if (this instanceof Bit64) {
        tmp = 'Bit64[lo=' + this.z3f_1.toString() + ', hi=' + this.a3g_1.toString() + ', incrementBy=' + this.y3f_1.toString() + ']';
      } else {
        noWhenBranchMatchedException();
      }
    }
