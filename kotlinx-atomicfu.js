(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).b1e = function () {
    return this.a1e_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.a1e_1[index];
  };
  ...
  protoOf(AtomicRef).c1e = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).d1e = function () {
  ...
  protoOf(AtomicBoolean).e1e = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).d1e = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).f1e = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).d1e = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).g1e = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).d1e = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).b1e);
  //endregion
