(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).x1d = function () {
    return this.w1d_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.w1d_1[index];
  };
  ...
  protoOf(AtomicRef).y1d = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).z1d = function () {
  ...
  protoOf(AtomicBoolean).a1e = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).z1d = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).b1e = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).z1d = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).c1e = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).z1d = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).x1d);
  //endregion
