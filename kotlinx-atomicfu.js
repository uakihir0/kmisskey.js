(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).a1d = function () {
    return this.z1c_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.z1c_1[index];
  };
  ...
  protoOf(AtomicRef).b1d = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).c1d = function () {
  ...
  protoOf(AtomicBoolean).d1d = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).c1d = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).e1d = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).c1d = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).f1d = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).c1d = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).a1d);
  //endregion
