(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).x1c = function () {
    return this.w1c_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.w1c_1[index];
  };
  ...
  protoOf(AtomicRef).y1c = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).z1c = function () {
  ...
  protoOf(AtomicBoolean).a1d = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).z1c = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).b1d = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).z1c = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).c1d = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).z1c = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).x1c);
  //endregion
