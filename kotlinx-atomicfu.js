(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).d1c = function () {
    return this.c1c_1.length;
  };
  protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
    return this.c1c_1[index];
  };
  ...
  protoOf(AtomicRef).e1c = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).f1c = function () {
  ...
  protoOf(AtomicBoolean).g1c = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).f1c = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).h1c = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).f1c = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).i1c = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).f1c = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).d1c);
  //endregion
