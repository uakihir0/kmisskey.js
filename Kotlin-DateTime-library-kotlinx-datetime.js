(function (root, factory) {
  ...
  var ArithmeticException = kotlin_kotlin.$_$.lf;
  ...
  var KMutableProperty0 = kotlin_kotlin.$_$.nc;
  ...
  var prependIndent = kotlin_kotlin.$_$.zd;
  ...
  var isDigit = kotlin_kotlin.$_$.md;
  ...
  var append = kotlin_kotlin.$_$.yc;
  var toIntOrNull = kotlin_kotlin.$_$.ue;
  var mutableListOf = kotlin_kotlin.$_$.e8;
  var removeLastOrNull = kotlin_kotlin.$_$.k8;
  var sortWith = kotlin_kotlin.$_$.r8;
  var Comparator = kotlin_kotlin.$_$.pf;
  var compareValues = kotlin_kotlin.$_$.g9;
  ...
  var numberToInt = kotlin_kotlin.$_$.sb;
  ...
  var toSet_0 = kotlin_kotlin.$_$.c9;
  //endregion
  ...
  function MonthNames(names) {
    ...
    var tmp0_iterator = get_indices(this.names_1).iterator_jk1svi_k$();
    while (tmp0_iterator.hasNext_bitz1p_k$()) {
      var element = tmp0_iterator.next_20eer_k$();
      // Inline function 'kotlinx.datetime.format.MonthNames.<anonymous>' call
      // Inline function 'kotlin.require' call
      // Inline function 'kotlin.text.isNotEmpty' call
      var this_0 = this.names_1.get_c1px32_k$(element);
      // Inline function 'kotlin.contracts.contract' call
      ...
      if (inductionVariable < element)
        do {
          ...
          // Inline function 'kotlin.require' call
          // Inline function 'kotlin.contracts.contract' call
          if (!!(this.names_1.get_c1px32_k$(element) === this.names_1.get_c1px32_k$(ix2))) {
            // Inline function 'kotlinx.datetime.format.MonthNames.<anonymous>.<anonymous>' call
            var message_1 = "Month names must be unique, but '" + this.names_1.get_c1px32_k$(element) + "' was repeated";
    ...
    while (tmp0_iterator.hasNext_bitz1p_k$()) {
      ...
      if (inductionVariable < element)
        do {
          ...
          if (!!(this.names_1.get_c1px32_k$(element) === this.names_1.get_c1px32_k$(ix2))) {
            // Inline function 'kotlinx.datetime.format.DayOfWeekNames.<anonymous>.<anonymous>' call
            var message_1 = "Day-of-week names must be unique, but '" + this.names_1.get_c1px32_k$(element) + "' was repeated";
            throw IllegalArgumentException_init_$Create$(toString(message_1));
          }
        }
         while (inductionVariable < element);
  ...
  protoOf(ConstantFormatStructure).parser_ggn3z5_k$ = function () {
    ...
    if (charSequenceLength(this_0) === 0) {
      ...
      var tmp_0;
      if (isDigit(charSequenceGet(this.string_1, 0))) {
        var tmp$ret$4;
        $l$block: {
  ...
  function FractionPartConsumer(minLength, maxLength, setter, name) {
    ...
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!(this.minLength_1 == null || numberRangeToNumber(1, 9).contains_7q95ev_k$(this.minLength_1))) {
  ...
  protoOf(FractionPartConsumer).consume_4ahi6s_k$ = function (storage, input) {
    var tmp;
    if (!(this.minLength_1 == null) && input.length < this.minLength_1) {
      tmp = new TooFewDigits(this.minLength_1);
    } else if (!(this.maxLength_1 == null) && input.length > this.maxLength_1) {
      tmp = new TooManyDigits(this.maxLength_1);
    } else {
      var numerator = toIntOrNull(input);
      tmp = numerator == null ? new TooManyDigits(9) : setWithoutReassigning(this.setter_1, storage, new DecimalFraction(numerator, input.length));
    }
    return tmp;
  };
  ...
  protoOf(ConstantNumberConsumer).consume_4ahi6s_k$ = function (storage, input) {
    var tmp;
    if (input === this.expected_1) {
      tmp = null;
    } else {
  ...
  protoOf(UnsignedIntConsumer).consume_4ahi6s_k$ = function (storage, input) {
    var tmp;
    if (!(this.maxLength_1 == null) && input.length > this.maxLength_1) {
      tmp = new TooManyDigits(this.maxLength_1);
    } else if (!(this.minLength_1 == null) && input.length < this.minLength_1) {
      tmp = new TooFewDigits(this.minLength_1);
    } else {
  ...
  protoOf(ReducedIntConsumer).consume_4ahi6s_k$ = function (storage, input) {
    var result = toIntOrNull(input);
    var tmp;
    if (result == null) {
      tmp = ExpectedInt_getInstance();
    } else {
      var tmp_0;
      if (result >= this.baseMod_1) {
        tmp_0 = this.baseFloor_1 + result | 0;
      } else {
        tmp_0 = (this.baseFloor_1 + this.modulo_1 | 0) + result | 0;
      }
      tmp = setWithoutReassigning(this.setter_1, storage, tmp_0);
    }
    return tmp;
  };
  ...
  protoOf(NumberSpanParserOperation).consume_ew3o91_k$ = function (storage, input, startIndex) {
    ...
    if (inductionVariable <= last)
      do {
        ...
        var error = this.consumers_1.get_c1px32_k$(i).consume_4ahi6s_k$(storage, numberString);
        if (!(error == null)) {
  ...
  function PlainStringParserOperation(string) {
    ...
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.contracts.contract' call
    if (!!isDigit(charSequenceGet(this.string_1, this.string_1.length - 1 | 0))) {
      // Inline function 'kotlinx.datetime.internal.format.parser.PlainStringParserOperation.<anonymous>' call
  ...
  function toLocalDateTime(_this__u8e3s4, offset) {
    ...
    try {
      ...
      var this_0 = LocalDateTime.ofInstant(_this__u8e3s4.get_value_r9d4id_k$(), offset.get_zoneOffset_je8jnv_k$());
      // Inline function 'kotlin.contracts.contract' call
  ...
  function toLocalDateTime_0(_this__u8e3s4, timeZone) {
    ...
    try {
      ...
      // Inline function 'kotlinx.datetime.jsTry' call
      // Inline function 'kotlinx.datetime.toLocalDateTime.<anonymous>' call
      var this_0 = LocalDateTime.ofInstant(_this__u8e3s4.get_value_r9d4id_k$(), timeZone.zoneId_1);
      // Inline function 'kotlin.contracts.contract' call
      tmp = new LocalDateTime_0(this_0);
    } catch ($p) {
      var tmp_0;
  ...
  function toInstant(_this__u8e3s4, timeZone) {
    // Inline function 'kotlin.let' call
    var this_0 = _this__u8e3s4.get_value_r9d4id_k$().atZone(timeZone.zoneId_1).toInstant();
    // Inline function 'kotlin.contracts.contract' call
